...
Функция ДанныеПубликацииЭлектронногоКурса(Знач ЭлектронныйКурс, Знач ФрагментКурса = Неопределено, Знач ДатаИзмененияСуществующихДанных = Неопределено) Экспорт
	...
	Если ДанныеЭлектронногоКурса.Свойство("СтартоваяСтраницаЭлемент") И ЗначениеЗаполнено(ДанныеЭлектронногоКурса.СтартоваяСтраницаЭлемент) Тогда
		...
		Если НЕ ЭлектронноеОбучениеСлужебный.ЭтоПустойHTMLДокумент(ДанныеФорматированногоДокумента.ПредставлениеHTML) Тогда // Пустой слайд не делаем
			...
			ДанныеДокумента.Вставить("data", ЭлектронноеОбучениеСлужебныйКлиентСервер.Base64ИзСтроки(ДанныеФорматированногоДокумента.ПредставлениеHTML));
...
Функция СтруктураТестовыхВопросовДляПросмотра(МассивВопросов, РесурсыКурса)
	...
	Для каждого СтрокаТВ Из ДанныеВопросов.Вопросы Цикл
		...
		ЗаданиеВопроса.Вставить("data", ЭлектронноеОбучениеСлужебныйКлиентСервер.Base64ИзСтроки(ДанныеФорматированногоДокументаЗадания.ПредставлениеHTML));
		...
		Для каждого СтрокаТВВ Из ВариантыВопроса Цикл
			...
			ТекстВарианта.Вставить("data", ЭлектронноеОбучениеСлужебныйКлиентСервер.Base64ИзСтроки(СтрокаТВВ.ТекстВарианта.Получить()));
...
Функция ПутьККаталогуЭлектронныхКурсов(ПутьКОбщемуКаталогу) Экспорт
	...
	Если ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных() Тогда
		...
		ЗначениеРазделителяСеанса = ЭлектронноеОбучениеСлужебныйКлиентСервер.ЧислоВСтроку(
	...
	Возврат ЭлектронноеОбучениеСлужебныйКлиентСервер.ПривестиСлэши(
		ПутьКОбщемуКаталогу
		+ ИзучениеЭлектронныхКурсовСлужебныйКлиентСервер.ИмяКаталогаЭлектронныхКурсов()
