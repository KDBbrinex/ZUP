...
Функция ТаблицаПогашениеЗаймов() Экспорт
	...
	РасчетЗаймов.Колонки.Добавить("НачисленоПроцентов", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	РасчетЗаймов.Колонки.Добавить("РазмерПлатежа", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	РасчетЗаймов.Колонки.Добавить("ПогашениеПроцентов", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
	РасчетЗаймов.Колонки.Добавить("ПогашениеЗайма", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 3)));
