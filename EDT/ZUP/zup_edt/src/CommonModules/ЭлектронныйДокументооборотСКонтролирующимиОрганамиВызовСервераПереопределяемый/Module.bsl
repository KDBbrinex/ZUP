...
Функция ПолучитьДанныеИсполнителя(СсылкаФизЛицо, ОрганизацияСсылка) Экспорт
	...
	Возврат ЗарплатаКадры.ПолучитьДанныеИсполнителя(СсылкаФизЛицо, ОрганизацияСсылка)
...
Функция ПолучитьДанныеОтветственныхЛиц(ОрганизацияСсылка, ПолучитьСоответствие = Ложь) Экспорт
	...
	Возврат ЗарплатаКадры.ПолучитьДанныеОтветственныхЛиц(ОрганизацияСсылка, ПолучитьСоответствие);
...
Функция ПолучитьКодПодчиненностиРеестраСведенийНаВыплатуПособийФСС(Ссылка) Экспорт
	...
	Возврат ЗарплатаКадры.ПолучитьКодПодчиненностиРеестраСведенийНаВыплатуПособийФСС(Ссылка);
...
Функция ГлБухгалтер(Организация) Экспорт
	...
	Возврат ЗарплатаКадры.ГлБухгалтер(Организация)
...
Функция Руководитель(Организация) Экспорт
	...
	Возврат ЗарплатаКадры.Руководитель(Организация)
...
Функция ФизЛицоПоФИО(Фамилия, Имя, Отчество, СНИЛС, Организация) Экспорт
	...
	Возврат ЗарплатаКадры.ФизЛицоПоФИО(Фамилия, Имя, Отчество, СНИЛС, Организация)
