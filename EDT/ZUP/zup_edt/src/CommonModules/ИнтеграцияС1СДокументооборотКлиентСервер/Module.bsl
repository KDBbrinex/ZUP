...
Функция ПолучитьОбзорДокумента(Форма) Экспорт
	...
	ИначеЕсли Форма.Тип = "DMInternalDocument" Тогда
		...
		HTMLТекст = HTMLТекст + "<tr>";
		HTMLТекст = HTMLТекст + "<td colspan=""2"">";
		Если ЗначениеЗаполнено(Форма.Ответственный) Или ЗначениеЗаполнено(Форма.Подразделение) Тогда
			HTMLТекст = HTMLТекст + "<p>";
		КонецЕсли;
		Если ЗначениеЗаполнено(Форма.Ответственный) Тогда
			ДобавитьРеквизитКHTML(HTMLТекст, НСтр("ru = 'Ответственный:'"), Форма.Ответственный);
	...
	ИначеЕсли Форма.Тип = "DMOutgoingDocument" Тогда
		...
		HTMLТекст = HTMLТекст + "<tr>";
		HTMLТекст = HTMLТекст + "<td colspan=""3"">";
		Если ЗначениеЗаполнено(Форма.Подписал) Или ЗначениеЗаполнено(Форма.Подготовил) Тогда
...
//
Процедура ДобавитьЗначениеКHTML(HTMLТекст, Представление, Идентификатор = Неопределено, Тип = Неопределено)
...
Процедура ДобавитьПредставлениеСостояний(HTMLТекст, Форма)
	...
	Последовательность.Вставить("Рассмотрение");
	Последовательность.Вставить("Согласование");
	Последовательность.Вставить("Утверждение");
	Если Форма.Тип = "DMInternalDocument" Тогда
		Последовательность.Вставить("Подписание");
	КонецЕсли;
	Последовательность.Вставить("Исполнение");
	Последовательность.Вставить("Регистрация");
