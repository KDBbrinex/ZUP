...
Функция МакетыВариантовОтчетовПечатныхФорм() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КадровыйУчет.ДистанционнаяРабота") Тогда
		МакетыВариантовОтчетов.Вставить("Отчет.ПечатнаяФормаТ1.Т1КОРП", "ОбщийМакет.ПФ_MXL_Т1");
		МакетыВариантовОтчетов.Вставить("Отчет.ПечатнаяФормаТ5.Т5КОРП", "ОбщийМакет.ПФ_MXL_Т5");
		МакетыВариантовОтчетов.Вставить("Отчет.ПечатнаяФормаТ1а.Т1аКОРП", "Отчет.ПечатнаяФормаТ1а.ПФ_MXL_Т1а");
		МакетыВариантовОтчетов.Вставить("Отчет.ПечатнаяФормаТ5а.Т5аКОРП", "Отчет.ПечатнаяФормаТ5а.ПФ_MXL_Т5а");
	Иначе
