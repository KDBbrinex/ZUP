...
Процедура ПроверитьПоляКадровогоРезерва(Форма) Экспорт
	...
	РекомендуетсяВКадровыйРезерв = ОбщегоНазначенияКлиент.ПредопределенныйЭлемент("Справочник.РешенияАттестационныхКомиссий.РекомендуетсяВКадровыйРезерв");
	...
	Если НЕ ТекущиеДанные.РешениеКомиссии = РекомендуетсяВКадровыйРезерв Тогда
		ТекущиеДанные.ПозицияРезерва = ОбщегоНазначенияКлиент.ПредопределенныйЭлемент("Справочник.КадровыйРезерв.ПустаяСсылка");
		ТекущиеДанные.ВидРезерва = ОбщегоНазначенияКлиент.ПредопределенныйЭлемент("Справочник.ВидыКадровогоРезерва.ПустаяСсылка");
	КонецЕсли;
