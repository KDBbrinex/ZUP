...
//  ДополнительныеПараметры		 - Структура - параметры, передаваемые обработчику оповещения о закрытии формы добавления.
//
...
//  ОповещениеОЗакрытии				 - ОписаниеОповещения	 - процедура, которую надо вызвать на клиенте по завершении подбора.
//  СтрокаСкрываемыхРеквизитов		 - Строка				 - строка реквизитов формы, которые необходимо скрыть.
//
Процедура ОткрытьФормуПодбораХарактеристик(Форма, ДобавлятьЗначенияХарактеристик = Истина, ОповещениеОЗакрытии = Неопределено, СтрокаСкрываемыхРеквизитов = "") Экспорт
	
	ПараметрыОповещения = Новый Структура;
	
	ПараметрыОповещения.Вставить("ДобавлятьЗначенияХарактеристик", ДобавлятьЗначенияХарактеристик);
...
//  Отказ					 - Булево		 - признак отказа от стандартной обработки.
//  ОповещениеОЗакрытии		 - ОписаниеОповещения	 - процедура, которую надо вызвать на клиенте по завершении подбора.
//  ДополнительныеПараметры	 - Структура			 - значения заполнения для новой строки характеристик.
//
Процедура ОткрытьФормуДобавленияХарактеристик(Форма, Копирование, Отказ = Неопределено, ОповещениеОЗакрытии = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт 
...
Процедура ДействияСотрудниковПередУдалением(Форма, ИмяПроцедуры = "", ИмяРеквизитаТаблицыДействий = "Объект.ДействияСотрудников") Экспорт 
	...
	УдалитьХарактеристикиИЗначенияВТаблицах(Форма, УдаляемыеСтроки, Форма.Характеристики, Форма.ЗначенияХарактеристики, ИмяПроцедуры);
...
Процедура ШтатноеРасписаниеХарактеристикиПередНачаломДобавления(Форма, Копирование, Отказ) Экспорт
	ОткрытьФормуДобавленияХарактеристик(Форма, Копирование, Отказ, Новый ОписаниеОповещения("Подключаемый_ДобавитьХарактеристикиПерсоналаНаКлиенте", Форма));
КонецПроцедуры
...
Процедура ПодобратьХарактеристики(Форма) Экспорт
	ОткрытьФормуПодбораХарактеристик(Форма,, Новый ОписаниеОповещения("Подключаемый_ДобавитьХарактеристикиПерсоналаНаКлиенте", Форма));
КонецПроцедуры
...
//
Функция ДобавитьДействияВТабличнуюЧасть(Форма, ТаблицаДействий, Результат)
...
//	УдаляемыеСтроки		 	- Массив - удаляемые строки характеристик.
...
//	ИмяПроцедуры			- Строка - имя экспортной процедуры формы, которую следует вызвать после удаления характеристик.
//
Процедура УдалитьХарактеристикиИЗначенияВТаблицах(Форма, УдаляемыеСтроки, ТаблицаХарактеристик, ТаблицаЗначений, ИмяПроцедуры = "")
