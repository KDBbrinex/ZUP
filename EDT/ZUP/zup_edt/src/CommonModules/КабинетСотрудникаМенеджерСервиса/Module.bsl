...
Процедура АктивироватьТестовыйТариф() Экспорт
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(ИмяГруппыСобытийЖР(), УровеньЖурналаРегистрации.Ошибка,,,Комментарий);
		КонецЕсли;
	Иначе
