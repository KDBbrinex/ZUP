...
Процедура РасчетПоказателей_РСВ_2020(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц)
	...
	Если ОписаниеТаблиц.Свойство("ВсегоЗастрахованных") Или ОписаниеТаблиц.Свойство("Подраздел3Физлица2020") Или ОписаниеТаблиц.Свойство("ДоходыФСС2020") Тогда
		...
		|ГДЕ
		|	НЕ ФизЛица.ЯвляетсяПрокурором
		|	И НЕ ФизЛица.ЯвляетсяВоеннослужащим
		...
		|		ИЛИ НестрахуемыеДоходыФизлиц.ОбщаяСумма <> НестрахуемыеДоходыФизлиц.НестрахуемыеДоходы КАК ВключатьВРаздел3,
		|	НестрахуемыеДоходыФизлиц.ФизическоеЛицо ЕСТЬ NULL
		|		ИЛИ НестрахуемыеДоходыФизлиц.ОбщаяСумма = 0
		|		ИЛИ НестрахуемыеДоходыФизлиц.ОбщаяСумма <> НестрахуемыеДоходыФизлиц.НестрахуемыеДоходы - НестрахуемыеДоходыФизлиц.ДоходыСтудентов КАК ВключатьВРаздел1,
	...
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ВсегоЗастрахованных") Или ОписаниеТаблиц.Свойство("ВсеТарифы2020") 
		...
		|			КОГДА СведенияОДоходах.ВидДохода В (&НестрахуемыеПоОПСДоходыСтудентов)
		|				ТОГДА СведенияОДоходах.СкидкаПФР
		|			ИНАЧЕ 0
	...
	Если ОписаниеТаблиц.Свойство("ВсегоЗастрахованных") Тогда 
		...
		// АПК:494-выкл Использование вложенного запроса оправдано
		...
		|	И ВидыТарифовИзУчетнойПолитики.ВидТарифаСтраховыхВзносов <> ЗНАЧЕНИЕ(Справочник.ВидыТарифовСтраховыхВзносов.ДляСубъектовМалогоПредпринимательства)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВсеТарифы.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов,
		...
		|	МАКСИМУМ(ЕСТЬNULL(ЗастрахованныеНаФССЗаВсеМесяцы.ВсегоФизлиц, 0)) КАК П00012М101001,
		|	МАКСИМУМ(ВЫБОР
		...
		|			Доходы.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов
		|		ИЗ
		|			ВТЗастрахованныеЛицаОрганизации КАК Доходы) КАК ВсеТарифы
		|		ПО (ИСТИНА)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТЗастрахованныеНаОПСЗаВсеМесяцы КАК ЗастрахованныеНаОПСЗаВсеМесяцы
		|		ПО (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаОПСЗаВсеМесяцы.ВидТарифаСтраховыхВзносов)
		...
		|			И (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаОПСЗаОтдельныеМесяцы.ВидТарифаСтраховыхВзносов)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТЗастрахованныеНаОМСЗаВсеМесяцы КАК ЗастрахованныеНаОМСЗаВсеМесяцы
		|		ПО (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаОМСЗаВсеМесяцы.ВидТарифаСтраховыхВзносов)
		...
		|			И (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаОМСЗаОтдельныеМесяцы.ВидТарифаСтраховыхВзносов)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТЗастрахованныеНаФССЗаВсеМесяцы КАК ЗастрахованныеНаФССЗаВсеМесяцы
		|		ПО (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаФССЗаВсеМесяцы.ВидТарифаСтраховыхВзносов)
		...
		|			И (ВсеТарифы.ВидТарифаСтраховыхВзносов = ЗастрахованныеНаФССЗаОтдельныеМесяцы.ВидТарифаСтраховыхВзносов)
		|
		|СГРУППИРОВАТЬ ПО
		|	ВсеТарифы.ВидТарифаСтраховыхВзносов";
	...
	Если ОписаниеТаблиц.Свойство("Иностранцы") Тогда
		...
		Если Не ОписаниеТаблиц.Свойство("ДоходыФСС2020") И Не ОписаниеТаблиц.Свойство("ВсегоЗастрахованных") И Не ОписаниеТаблиц.Свойство("Подраздел3Физлица2020") Тогда
			Запрос.Текст =
			"ВЫБРАТЬ
			|	СведенияОДоходах.ФизическоеЛицо КАК ФизическоеЛицо,
			|	СведенияОДоходах.Период КАК Период,
	...
	Если ОписаниеТаблиц.Свойство("Подраздел3Физлица2020") Или ОписаниеТаблиц.Свойство("Подраздел321Доходы2020") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2020") Тогда
		...
		|	ЕСТЬNULL(ФИОФизлиц.ДокументВид.КодМВД, """") КАК П000310010001,
