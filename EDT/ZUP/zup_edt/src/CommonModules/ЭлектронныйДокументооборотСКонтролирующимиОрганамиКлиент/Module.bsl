...
Процедура ПодтверждениеПрочтенияСообщенияСЭДОФССПослеПолученияКонтекста(Результат, ДополнительныеПараметры) Экспорт
	
	ОповещениеОбратногоВызова = ДополнительныеПараметры.ОповещениеОбратногоВызова;
	Организация = ДополнительныеПараметры.Организация;
	ИдентификаторСообщения = ДополнительныеПараметры.ИдентификаторСообщения;
	...
	КонтекстЭДОКлиент.ПодтверждениеПрочтенияСообщенияСЭДОФСС(ОповещениеОбратногоВызова,
		Организация,
