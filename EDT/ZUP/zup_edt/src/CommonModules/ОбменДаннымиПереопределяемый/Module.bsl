...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	//++Татаринов Е.А. 21.05.2019. Обмен с Документооборотом
	МетаданныеПланаОбмена = Метаданные.ПланыОбмена.Найти("кдОбменЗУПДОК");
	Если МетаданныеПланаОбмена <> Неопределено Тогда
		ПланыОбменаПодсистемы.Добавить(МетаданныеПланаОбмена);
	КонецЕсли;
	//--Татаринов Е.А. 21.05.2019. Обмен с Документооборотом
	
	//{[+](фрагмент ДОБАВЛЕН), Нигматуллин Искандер Динарович 26.04.2020 9:26:30
	МетаданныеПланаОбмена = Метаданные.ПланыОбмена.Найти("ИнтеграцияЗУП_УТ");
	Если МетаданныеПланаОбмена <> Неопределено Тогда
		ПланыОбменаПодсистемы.Добавить(МетаданныеПланаОбмена);
	КонецЕсли;
	//}Нигматуллин Искандер Динарович 26.04.2020 9:26:30
КонецПроцедуры
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	СинхронизацияДанныхЗарплатаКадры.РегистрацияИзмененийНачальнойВыгрузкиДанных(Получатель, СтандартнаяОбработка, Отбор);
...
Процедура ПриНастройкеПодчиненногоУзлаРИБ() Экспорт
	СинхронизацияДанныхЗарплатаКадрыСервер.ПриНастройкеПодчиненногоУзлаРИБ();
КонецПроцедуры
...
Процедура ПриПолученииДоступныхВерсийФормата(ВерсииФормата) Экспорт
	...
	КонфигурацииЗарплатаКадрыРасширенный.ПриПолученииДоступныхВерсийФормата(ВерсииФормата);
