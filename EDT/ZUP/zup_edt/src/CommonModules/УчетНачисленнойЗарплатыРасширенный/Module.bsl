...
Функция ВидыДоходовИсполнительногоПроизводстваНачислений() Экспорт
	...
	ВидыДоходовНачислений = УчетНачисленнойЗарплатыБазовый.ВидыДоходовИсполнительногоПроизводстваНачислений();
	
	ОбщегоНазначенияКлиентСервер.ДополнитьСоответствие(
		ВидыДоходовНачислений,
		Справочники.ВидыВыплатБывшимСотрудникам.ВидыДоходовИсполнительногоПроизводства(),
		Истина);
		
	ОбщегоНазначенияКлиентСервер.ДополнитьСоответствие(
		ВидыДоходовНачислений,
		Справочники.ВидыПрочихДоходовФизическихЛиц.ВидыДоходовИсполнительногоПроизводства(),
		Истина);
...
Функция ЗапросВТНачисленныеДоходы(ИмяВТНачисленныеДоходы) Экспорт
	...
	|				И (НачисленияУдержанияПоКонтрагентамАкционерам.НачислениеУдержание = ЗНАЧЕНИЕ(Перечисление.ВидыОсобыхНачисленийИУдержаний.КомпенсацияЗаЗадержкуЗарплаты)
