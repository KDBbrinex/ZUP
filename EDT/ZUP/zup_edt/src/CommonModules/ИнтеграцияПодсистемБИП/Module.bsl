...
Процедура ПриОпределенииПодписокНаСобытияБСП(Подписки) Экспорт
	...
	// Печать
	Подписки.ПриОпределенииОбъектовСКомандамиПечати = Истина;
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ИнтеграцияСПлатежнымиСистемами") Тогда
		МодульИнтеграцияСПлатежнымиСистемами = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияСПлатежнымиСистемами");
		МодульИнтеграцияСПлатежнымиСистемами.ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений);
	КонецЕсли;
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ИнтеграцияСПлатежнымиСистемами") Тогда
		МодульИнтеграцияСПлатежнымиСистемами = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияСПлатежнымиСистемами");
		МодульИнтеграцияСПлатежнымиСистемами.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	КонецЕсли;
...
// См. ИнтеграцияСПлатежнымиСистемамиПереопределяемый.ПриОпределенииЗавершенияНастройкиИнтеграции.
//
Процедура ПриОпределенииЗавершенияНастройкиИнтеграции(НастройкаИнтеграции, Выполнена) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриОпределенииЗавершенияНастройкиИнтеграции Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриОпределенииЗавершенияНастройкиИнтеграции(
			НастройкаИнтеграции,
			Выполнена);
	КонецЕсли;
...
Функция СобытияБИП() Экспорт
	...
	События.Вставить("ПриОпределенииЗавершенияНастройкиИнтеграции", Ложь);
