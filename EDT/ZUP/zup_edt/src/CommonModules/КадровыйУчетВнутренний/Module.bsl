...
Процедура НастроитьВариантыОтчетаУнифицированнойФормыТ2(Настройки, НастройкиОтчета) Экспорт
	...
	КадровыйУчетРасширенный.НастроитьВариантыОтчетаУнифицированнойФормыТ2(Настройки, НастройкиОтчета); 	
...
Процедура НастроитьВариантыОтчетаПоСотрудникам(Настройки, НастройкиОтчета) Экспорт;
	...
	КадровыйУчетРасширенный.НастроитьВариантыОтчетаПоСотрудникам(Настройки, НастройкиОтчета);	
...
Функция ЗапросВТТарифныеСтавкиСотрудников(ТолькоРазрешенные, ИмяВТТарифныеСтавкиСотрудников, ИмяВременнойТаблицыОтборовСотрудников, ПоляОтбораСотрудников, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ЗапросВТТарифныеСтавкиСотрудников(ТолькоРазрешенные, ИмяВТТарифныеСтавкиСотрудников, ИмяВременнойТаблицыОтборовСотрудников, ПоляОтбораСотрудников, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень);
...
Функция ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень);
...
Функция ЗапросВТСведенияОДатахСмертиСотрудников(ТолькоРазрешенные, ОписательВременнойТаблицыОтборов) Экспорт
	...
	Возврат КадровыйУчетРасширенный.ЗапросВТСведенияОДатахСмертиСотрудников(ТолькоРазрешенные, ОписательВременнойТаблицыОтборов);
...
//												СправочникСсылка.ОснованияУвольненияСГосударственнойСлужбы
//												СправочникСсылка.ОснованияУвольненияСМуниципальнойСлужбы
//
...
Процедура ДобавитьТекстЗапросаВТСведенияКадроваяИсторияСотрудников(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных) Экспорт
	...
	КадровыйУчетРасширенный.ДобавитьТекстЗапросаВТСведенияКадроваяИсторияСотрудников(Запрос, ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных);
...
Процедура ЗаполнитьПоляПредставленийКадровыхДанныхФизическихЛиц(ДополнительныеПоляПредставлений, ПутьКПолямЛичныхДанных) Экспорт
	...
	КадровыйУчетРасширенный.ЗаполнитьПоляПредставленийКадровыхДанныхФизическихЛиц(ДополнительныеПоляПредставлений, ПутьКПолямЛичныхДанных);
...
Процедура ЗаполнитьПоляПредставленийКадровыхДанныхСотрудников(ДополнительныеПоляПредставлений, ПутьКПолямСотрудника, ПутьКПолямЛичныхДанных) Экспорт
	...
	КадровыйУчетРасширенный.ЗаполнитьПоляПредставленийКадровыхДанныхСотрудников(ДополнительныеПоляПредставлений, ПутьКПолямСотрудника, ПутьКПолямЛичныхДанных);
...
Процедура ОпределитьПроверкиВеденияУчета(ГруппыПроверок, Проверки) Экспорт
	...
	КадровыйУчетРасширенный.ОпределитьПроверкиВеденияУчета(ГруппыПроверок, Проверки);
...
Процедура УстановитьЗапросНабораДанныхПечатнойФормыСправкиОСреднемЗаработке(ОбъектОтчета) Экспорт
	...
	КадровыйУчетРасширенный.УстановитьЗапросНабораДанныхПечатнойФормыСправкиОСреднемЗаработке(ОбъектОтчета);
	
КонецПроцедуры

Функция ДанныеГрафиковРаботыДляСправкиОСреднемЗаработке() Экспорт
	
	Возврат КадровыйУчетРасширенный.ДанныеГрафиковРаботыДляСправкиОСреднемЗаработке();
	
КонецФункции

Процедура ОбновитьДанныеДляПодбораДоговорниковГПХ(ОбновляемыеСотрудники) Экспорт

	КадровыйУчетРасширенный.ОбновитьДанныеДляПодбораДоговорниковГПХ(ОбновляемыеСотрудники);

КонецПроцедуры

Функция ОснованияУвольненияВСвязиСоСмертьюСотрудника() Экспорт
	
	Возврат КадровыйУчетРасширенный.ОснованияУвольненияВСвязиСоСмертьюСотрудника();
	
КонецФункции

Функция ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные) Экспорт
	
	Возврат КадровыйУчетРасширенный.ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные);
	
КонецФункции

Процедура ЗаполнитьГоловныхСотрудниковВКадровойИстории(ПараметрыОбновления) Экспорт
	
	КадровыйУчетРасширенный.ЗаполнитьГоловныхСотрудниковВКадровойИстории(ПараметрыОбновления);
...
Процедура ПриОпределенииОбъектовСРедактируемымиРеквизитами(Объекты) Экспорт
	...
	КадровыйУчетРасширенный.ПриОпределенииОбъектовСРедактируемымиРеквизитами(Объекты);
