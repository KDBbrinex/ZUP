...
Процедура НастроитьПолеВидДоходаДляВыплатыЗарплаты(Форма, ИмяЭлемента = "ВидДоходаИсполнительногоПроизводства") Экспорт
	...
	НастроитьСписокВыбораПоляВидДохода(Форма, ИмяЭлемента,
		ПредопределенноеЗначение("Перечисление.ВидыДоходовИсполнительногоПроизводства.ЗарплатаВознаграждения"),
		ПредопределенноеЗначение("Перечисление.ВидыДоходовИсполнительногоПроизводства.КомпенсацииНеоблагаемые"),
		ПредопределенноеЗначение("Перечисление.ВидыДоходовИсполнительногоПроизводства.КомпенсацииОблагаемые"),
		ПредопределенноеЗначение("Перечисление.ВидыДоходовИсполнительногоПроизводства.ДоходыБезОграниченияВзысканий"));
...
// АПК:142-выкл Необязательные параметры эмулируют vararg (переменное количество параметров одного типа)

Процедура НастроитьСписокВыбораПоляВидДохода(Форма, ИмяЭлемента, 
	Значение1 = Неопределено, Значение2 = Неопределено, Значение3 = Неопределено, Значение4 = Неопределено)
	...
	ДобавитьЭлементСпискаВыбораПоляВидДохода(ПолеВидДохода, Значение1);
	ДобавитьЭлементСпискаВыбораПоляВидДохода(ПолеВидДохода, Значение2);
	ДобавитьЭлементСпискаВыбораПоляВидДохода(ПолеВидДохода, Значение3);
	ДобавитьЭлементСпискаВыбораПоляВидДохода(ПолеВидДохода, Значение4);
	
КонецПроцедуры

// АПК:142-вкл

Процедура ДобавитьЭлементСпискаВыбораПоляВидДохода(ПолеВидДохода, Значение)
