...
//  СообщенияСДаты  - Дата - дата, начиная с которой будет возвращен список сообщений.
//  СообщенияПоДату - Дата - дата, по которую будет возвращен список сообщений.
//
...
// Отправляет подтверждение о прочтении сообщения на сервер СЭДО ФСС.
//
// Параметры:
//  ОповещениеОбратногоВызова       - ОписаниеОповещения - описание процедуры, принимающей результат:
//    Результат  - Структура:
...
//      * ИдентификаторЗапроса - Строка - идентификатор отправленного запроса.
//  Организация             - СправочникСсылка.Организации - организация страхователь.
//  ИдентификаторСообщения  - Строка, УникальныйИдентификатор - идентификатор сообщения, на которое будет отправлено подтверждение.
//
Процедура ОтправитьПодтверждениеОПрочтенииСообщенияСЭДО(ОповещениеОбратногоВызова,
		Организация,
		ИдентификаторСообщения) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПодтверждениеПрочтенияСообщенияСЭДОФССПослеПолученияКонтекста",
		ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиент,
		ДополнительныеПараметры);
	ДокументооборотСКОКлиент.ПолучитьКонтекстЭДО(ОписаниеОповещения);
