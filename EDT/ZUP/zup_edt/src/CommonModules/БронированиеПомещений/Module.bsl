...
//   Описание - см. параметры возвращаемые функцией ПолучитьНастройкуОтбораБроней().
// 
// Возвращаемое значение:
...
Функция РекомендацииПомещений(Бронь) Экспорт
	...
	ОтображаемыеТерритории = ПолучитьПерсональнуюНастройку("ОтображаемыеТерритории");
	...
	|	ТерриторииИПомещения.ДоступнаСхема КАК ДоступнаСхема
	|ИЗ
	...
	|	И ТерриторииИПомещения.ДоступноБронирование
	...
	|ИЗ
	|	Справочник.ТерриторииИПомещения КАК ТерриторииИПомещения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ТерриторииИПомещения КАК ТерриторииИПомещенияРодители
...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	УправлениеСвойствамиБЗК.ЗарегистрироватьНаборСвойств(Наборы, "d42dbef1-9802-11e9-80cd-4cedfb43b11a", Метаданные.Документы.Бронь);
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.Бронь, Истина);
