...
//   * ПодробноеПредставлениеОшибки - Строка - подробная информация об исключении, если Статус = "Ошибка".
// 
Функция ЗапускЗаданияПоОтправкеДокументовВБанк(Знач МассивСообщенийОбмена, Знач ИдентификаторыСессий) Экспорт
...
Функция ПараметрыОбменаПоНомеруСчета(Знач БанковскийСчет) Экспорт
	...
	НастройкаОбмена = ОбменСБанками.НастройкаОбмена(РеквизитыСчета.Организация, РеквизитыСчета.Банк);
...
Процедура ПолучитьЗначенияРеквизитовНастройкиОбмена(Знач НастройкаОбмена, ЗапрашиваемыеРеквизиты) Экспорт
	...
	РеквизитыНастройкиОбмена = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(НастройкаОбмена,
		...
		|ДополнительнаяОбработка, ОтправлятьДокументыБезПодписиSMS");
...
Функция МожноОтклонитьЭтотЭД(СообщениеОбмена) Экспорт
	...
	Если ОбменСБанкамиСлужебный.ВидыПлатежныхДокументов().Найти(РеквизитыСообщения.ВидЭД) <> Неопределено
...
//
Процедура СохранитьСессиюНаСервереСбербанк(КлючСессии, ИдентификаторСессии, ФродПараметры, Логин) Экспорт
...
Процедура СформироватьЗапросЗонд(
	...
	НастройкиОбмена = ОбменСБанкамиСлужебный.ОпределитьНастройкиОбменаЭДПоИсточнику(
		НастройкаОбмена, Истина, МассивОтпечатковСертификатов, , Ложь, Перечисления.ВидыЭДОбменСБанками.ЗапросЗонд);
...
Функция БазоваяАутентификация(Знач АдресСервера, Знач ИдентификаторОрганизации, Знач ДанныеАутентификации, Знач ВерсияAPI, Знач НастройкаОбмена = Неопределено) Экспорт
	...
	Результат = ОбменСБанкамиСлужебный.ОтправитьPOSTЗапрос(
		АдресСервера, "Logon", Заголовки, Неопределено, , 15, НастройкаОбмена);
...
Функция ЗапросыВыписок(
	...
	НастройкиОбмена = ОбменСБанкамиСлужебный.ОпределитьНастройкиОбменаЭДПоИсточнику(
		НастройкаОбмена, Истина, МассивОтпечатковСертификатов, , , Перечисления.ВидыЭДОбменСБанками.ЗапросВыписки);
...
Процедура СохранитьВыпискуСбербанка(НастройкаОбмена, ВыпискаXDTO, МассивВыписок, СоздаватьОперацииВыписки)
	...
	СтруктураРазбораФайла = ОбменСБанкамиСлужебный.СформироватьДеревоРазбора(
		Перечисления.ВидыЭДОбменСБанками.ВыпискаБанка, ДвоичныеДанныеФайлаОтвета);
	ОбменСБанкамиСлужебный.ОпределитьИсполненныеПлатежныеПоручения(НастройкаОбмена, СтруктураРазбораФайла);
	ДатаКонца = ЭлектронноеВзаимодействие.ЗначениеРеквизитаСтрокиДереваРазбора(
		СтруктураРазбораФайла.ДеревоРазбора, СтруктураРазбораФайла.СтрокаОбъекта, "ДатаКонца");
	ОбменСБанкамиСлужебный.СохранитьДатуПоследнейОперации(НастройкаОбмена, ДатаКонца);
