...
Функция ПолучитьОтчетыАлко() Экспорт 
	...
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение16");
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение17");
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение18");
	// АлкоОтчеты с 2019 года. Виноградные.	
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение27");
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение28");
	ОтчетыАлко.Добавить("РегламентированныйОтчетАлкоПриложение29");
	Возврат ОтчетыАлко;
КонецФункции
