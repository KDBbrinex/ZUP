...
//  Подразделения - Ссылка или массив ссылок на подразделения, по которым нужно получить список узлов-получателей
//
Процедура ОграничитьРегистрациюОбъектаОтборомПоПодразделениям(ИмяПланаОбмена, Отказ, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Объект, Подразделения) Экспорт
	...
	ПолучателиОбъекта = МодульСинхронизацияДанных.ПолучателиОбъекта(ИмяПланаОбмена, Объект.Метаданные().ПолноеИмя());
	МодульСинхронизацияДанных.ИзменитьТекстЗапросаПоЗначениямМассива(
		ПолучателиОбъекта,
		ТекстЗапроса,
		ПараметрыЗапроса,
		"ПланОбменаОсновнаяТаблица.Ссылка В(&СвойствоОбъекта_ПолучателиОбъекта)",
...
//  Подразделения - Ссылка или массив ссылок на подразделения, по которым нужно получить список узлов-получателей
//
Процедура ДополнитьОграничениеРегистрацииОбъектаОтборомПоПодразделениям(ИмяПланаОбмена, Отказ, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Объект, Подразделения) Экспорт
...
Процедура ДополнитьОграничениеРегистрацииОбъектаОтборомПоСотруднику(ИмяПланаОбмена, Отказ, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Объект, Сотрудник) Экспорт
...
//
Процедура ДополнитьОграничениеРегистрацииОбъектаОтборомПоФизическимЛицам(ИмяПланаОбмена, Отказ, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Объект, ФизическоеЛицо) Экспорт
