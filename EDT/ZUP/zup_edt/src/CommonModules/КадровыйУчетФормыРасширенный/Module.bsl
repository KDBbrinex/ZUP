...
Процедура ЗапуститьОтложеннуюОбработкуДанных(ДокументОбъект, РеквизитСотрудник) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ПослеЗаписиФормыКадровогоДокументаНаСервере(ДокументОбъект, СотрудникиМассив);
	КонецЕсли;
