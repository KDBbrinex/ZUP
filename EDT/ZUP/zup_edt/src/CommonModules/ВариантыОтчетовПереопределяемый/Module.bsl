...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	ЗарплатаКадрыОтчеты.ПриОпределенииНастроек(Настройки);
...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.ВыплатыПеречисления, НСтр("ru = 'Отчеты по выплатам'"));
	Разделы.Добавить(Метаданные.Подсистемы.НалогиИВзносы, НСтр("ru = 'Отчеты по налогам и взносам'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// ЗарплатаКадрыПриложения.ЗарплатаКадрыКомандныйИнтерфейс
	ЗарплатаКадрыКомандныйИнтерфейс.НастроитьВариантыОтчетов(Настройки);
	// Конец ИнтернетПоддержкаПользователей.ЗарплатаКадрыКомандныйИнтерфейс
