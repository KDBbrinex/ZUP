...
Процедура РассчитатьПакетСотрудников(ОписаниеДокумента, Организация, МесяцНачисления, СписокЗаданий, ВыполняемыеЗадания, ДополнительныеПараметры)
	...
	Сотрудники.Вставить("Сотрудники", ОбщегоНазначения.СкопироватьРекурсивно(ДополнительныеПараметры.Сотрудники));
	Сотрудники.Вставить("СотрудникиДополнительныйДоход", ОбщегоНазначения.СкопироватьРекурсивно(ДополнительныеПараметры.СотрудникиДополнительныйДоход));
	Сотрудники.Вставить("СотрудникиПериодДействияПерерасчет", ОбщегоНазначения.СкопироватьРекурсивно(ДополнительныеПараметры.СотрудникиПериодДействияПерерасчет));
