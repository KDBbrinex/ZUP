...
Функция ВсеСсылкиСправочника(ИмяСправочника) Экспорт
	...
	СоставПодсистемыРазработки = ЭлектронноеОбучениеСлужебный.СоставПодсистемыРазработки();
	
	Для каждого ОбъектМетаданныхПодсистемы Из СоставПодсистемыРазработки Цикл
