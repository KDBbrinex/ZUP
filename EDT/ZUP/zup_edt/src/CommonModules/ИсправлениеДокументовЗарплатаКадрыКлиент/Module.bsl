...
Процедура ДополнитьПоИсправляемомуДокументу(Основание, Форма, ИмяПериодРегистрации = "ПериодРегистрации", Ссылка)
...
Процедура ОповеститьОбИсправленииДокумента(Документ, Источник, РежимЗаписи, РежимИсправления = "РасчетЗарплаты", ПолеПериодРегистрации = "ПериодРегистрации") Экспорт
