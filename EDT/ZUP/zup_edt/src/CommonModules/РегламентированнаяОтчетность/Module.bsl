...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ДоверенностиНалогоплательщика");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ДокументыРеализацииПолномочийНалоговыхОрганов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.МакетыПенсионныхДел");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ЗаявлениеОНазначенииПенсии");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОписиВходящихДокументовИзНалоговыхОрганов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОписиИсходящихДокументовВНалоговыеОрганы");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиБанкРоссии");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиМинобороны");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиРПН");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиФСРАР");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиФСС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ОтправкиФТС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.ПерепискаСКонтролирующимиОрганами");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.РегистрацииВНалоговомОргане");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Справочник.СканированныеДокументыДляПередачиВЭлектронномВиде");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗапросНаВыпискуИзЕГРЮЛ_ЕГРИП");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗапросНаИнформационноеОбслуживаниеНалогоплательщика");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗапросНаИнформационноеОбслуживаниеСтрахователя");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗаявлениеАбонентаСпецоператораСвязи");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ЗаявленияПоЭлДокументооборотуСПФР");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ПоясненияКДекларацииПоНДС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.РегламентированныйОтчет");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.УведомлениеОПолучателеДокументов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.УведомлениеОСпецрежимахНалогообложения");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"Документ.ТранспортноеСообщение");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.АрхивДанныхРегламентированнойОтчетности");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ВложенияНеформализованныхДокументов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ДокументыПоТребованиюФНС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналНовыхСобытий");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналОтправокВКонтролирующиеОрганы");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналОтчетовСтатусы");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиИнтеграцииСоСпринтером");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаБанкРоссии");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаМинобороны");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаРПН");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаФСРАР");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаФСС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОбменаФТС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НумераторПачекПФР");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ОтветыНаЗапросыВыпискиИзЕГРЮЛ_ЕГРИП");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ОтветыНаЗапросыИОН");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ОтветыНаЗапросыИОС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
	...
	// Алко отчеты с 2019 года. Виноградные.
	...
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СобытияКалендаряБухгалтера");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СтатусыОтправки");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СчетчикВыгрузокОтчетностиВБанк");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СчетчикиВыгрузок");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ФайлыДокументовРеализацииПолномочийНалоговыхОрганов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ХранилищеЭлектронныхПредставленийРегламентированныхОтчетов");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ФайлыСведенийСпецоператоры");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ФайлыСведенийРОКИ");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СвойстваТранспортныхСообщений");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СодержимоеТранспортныхКонтейнеров");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ТранспортныеКонтейнеры");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ПользователиУчетныхЗаписейДокументооборота");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.СостояниеПодключенияКЭДОсПФР");
	
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.НастройкиОтправкиОтчетностиВБанк");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналПередачиОтчетностиВБанк");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналПереданнойОтчетностиВБанк");
	
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ВходящиеСообщенияСЭДОФСС");
	ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
		"РегистрСведений.ЖурналЗапросовКСерверамФСС");
	
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ЛьготныеКредиты2020") Тогда
		ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки,
			"Документ.ЗаявкиНаЛьготныйКредит");	
	КонецЕсли;
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ДоверенностиНалогоплательщика");
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ДокументыРеализацииПолномочийНалоговыхОрганов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.МакетыПенсионныхДел");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ЗаявлениеОНазначенииПенсии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗаявленияПоЭлДокументооборотуСПФР");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОписиВходящихДокументовИзНалоговыхОрганов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОписиИсходящихДокументовВНалоговыеОрганы");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиБанкРоссии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиМинобороны");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиРПН");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиФСРАР");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ОтправкиФТС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ПерепискаСКонтролирующимиОрганами");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.РегистрацииВНалоговомОргане");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.СканированныеДокументыДляПередачиВЭлектронномВиде");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Справочник.ЭлектронныеПредставленияРегламентированныхОтчетов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ВыгрузкаРегламентированныхОтчетов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗапросНаВыпискуИзЕГРЮЛ_ЕГРИП");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗапросНаИнформационноеОбслуживаниеНалогоплательщика");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗапросНаИнформационноеОбслуживаниеСтрахователя");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗаявлениеАбонентаСпецоператораСвязи");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ПоясненияКДекларацииПоНДС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.РегламентированныйОтчет");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.УведомлениеОПолучателеДокументов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.УведомлениеОСпецрежимахНалогообложения");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.АрхивДанныхРегламентированнойОтчетности");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ВложенияНеформализованныхДокументов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ДокументыПоТребованиюФНС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ЖурналНовыхСобытий");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ЖурналОтправокВКонтролирующиеОрганы");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ЖурналОтчетовСтатусы");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиИнтеграцииСоСпринтером");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаБанкРоссии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаМинобороны");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаРПН");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаФСРАР");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ВходящиеСообщенияСЭДОФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ЖурналЗапросовКСерверамФСС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НастройкиОбменаФТС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.НумераторПачекПФР");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ОтветыНаЗапросыВыпискиИзЕГРЮЛ_ЕГРИП");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ОтветыНаЗапросыИОН");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.ОтветыНаЗапросыИОС");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоЖурнал");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоЛицензии");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил11Раздел1");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил11Раздел2");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил12Раздел1");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил12Раздел2");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил13Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил14Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил15Поставщики");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил15Производство");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил16Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил17Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил18Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил27Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил28Декларация");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил29Поставщики");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СведенияРеглОтчетАлкоПрил29Производство");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СобытияКалендаряБухгалтера");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СтатусыОтправки");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СчетчикВыгрузокОтчетностиВБанк");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("РегистрСведений.СчетчикиВыгрузок");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени(
		"РегистрСведений.ФайлыДокументовРеализацииПолномочийНалоговыхОрганов");
	Если НЕ ОбъектМетаданных = Неопределено Тогда
	...
	ДобавитьОбъектМетаданныхВВидыОграниченийПравПоОрганизации(Описание,
		"РегистрСведений.НастройкиОтправкиОтчетностиВБанк");
	ДобавитьОбъектМетаданныхВВидыОграниченийПравПоОрганизации(Описание,
		"РегистрСведений.ЖурналПередачиОтчетностиВБанк");
	ДобавитьОбъектМетаданныхВВидыОграниченийПравПоОрганизации(Описание,
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ЛьготныеКредиты2020") Тогда
		ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени("Документ.ЗаявкиНаЛьготныйКредит");
		Если НЕ ОбъектМетаданных = Неопределено Тогда
...
//
Функция ПоказателиОценкиРискаВыезднойНалоговойПроверки(Организация,
													   ДатаНачала,
													   ДатаОкончания,
													   ИмяРегламентированногоОтчета = "") Экспорт
	...
	Для Каждого СтрокаОтчета Из ТаблицаОтчетов Цикл
		...
		Если НЕ ЗначениеЗаполнено(СокрЛП(ИмяРегламентированногоОтчета))
		 ИЛИ ВРег(СокрЛП(СтрокаОтчета.ИсточникОтчета)) = ВРег(СокрЛП(ИмяРегламентированногоОтчета)) Тогда
...
Функция ТаблицаСозданныхВидовОтчетов(Организации = Неопределено) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ РАЗРЕШЕННЫЕ
	                      ...
	                      |////////////////////////////////////////////////////////////////////////////////
	                      |ВЫБРАТЬ
	                      |	ТаблицаЖурналОтчетовСтатусы.ТипСсылки КАК ТипСсылки,
	                      |	ТаблицаЖурналОтчетовСтатусы.Наименование КАК Наименование,
	                      |	ТаблицаЖурналОтчетовСтатусы.ИсточникОтчета КАК ИсточникОтчета
	                      |ИЗ
	...
	ЗагруженныеОтчеты = Новый Соответствие;
	...
	Для Инд = 1 По КоличествоСтрок Цикл
		...
		Если МетаОтчет <> Неопределено Тогда
			...
			Если СтрокаТаблицы.ПолноеИмя = "Справочник.ЭлектронныеПредставленияРегламентированныхОтчетов" Тогда
				ЗагруженныеОтчеты.Вставить(СтрокаТаблицы.Наименование, СтрокаТаблицы);
			ИначеЕсли СтрокаТаблицы.ПолноеИмя = "Справочник.МакетыПенсионныхДел"
				ИЛИ СтрокаТаблицы.ПолноеИмя = "Справочник.ЗаявлениеОНазначенииПенсии" Тогда
				СтрокаТаблицы.Наименование = Строка(СтрокаТаблицы.ТипСсылки);
			КонецЕсли;
		Иначе
			ТаблицаСозданных.Удалить(СтрокаТаблицы);
		КонецЕсли;
	...
	Для Каждого ЭлементЗагруженныйОтчет Из ЗагруженныеОтчеты Цикл
		Инд = ТаблицаСозданных.Индекс(ЭлементЗагруженныйОтчет.Значение);
		
		Если Инд >= 0 И Инд < ТаблицаСозданных.Количество() - 1 Тогда
			СледующаяСтрокаТаблицы = ТаблицаСозданных[Инд + 1];
			Если СледующаяСтрокаТаблицы.Наименование = ЭлементЗагруженныйОтчет.Ключ
			   И СледующаяСтрокаТаблицы.ПолноеИмя = "Документ.РегламентированныйОтчет" Тогда
				
				ТаблицаСозданных.Удалить(ЭлементЗагруженныйОтчет.Значение);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
Функция ЕстьФайлыПрисоединенныеКОбъекту(ВладелецФайлов) Экспорт
	...
	Если ТипЗнч(ВладелецФайлов) = Тип("ДокументСсылка.УведомлениеОСпецрежимахНалогообложения") Тогда
		Попытка
			...
			|	И УведомлениеОСпецрежимахНалогообложенияПрисоединенныеФайлы.Служебный = ЛОЖЬ";
	...
	ИмяРегистраСведенийНФ = "НаличиеФайлов";
	
	Если Метаданные.РегистрыСведений.Найти(ИмяРегистраСведенийНФ) = Неопределено Тогда
		Возврат Ложь;
	КонецЕсли;
	
	ОтборНФ = Новый Структура("ОбъектСФайлами", ВладелецФайлов);
	
	ВыборкаНФ = РегистрыСведений[ИмяРегистраСведенийНФ].Выбрать(ОтборНФ);
	
	Если ВыборкаНФ.Следующий() Тогда
		Если ВыборкаНФ.ОбъектСФайлами <> Неопределено Тогда // обход ошибки платформы
			Возврат ВыборкаНФ.ЕстьФайлы;
		КонецЕсли;
	КонецЕсли;
...
Процедура СохранитьСтатусОтправкиРеглОтчета(Форма) Экспорт
	...
	ЭтоОтчетМинобороны = Форма.СтруктураРеквизитовФормы.мСохраненныйДок.ИсточникОтчета = "РегламентированныйОтчетИсполнениеКонтрактовГОЗ";
	Если ЭтоОтчетМинобороны Тогда
		КонтроллирующийОрган = ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.Минобороны");
	Иначе
		КонтроллирующийОрган = Неопределено;
	КонецЕсли;
	
	Если ВыборкаЖОС.Следующий() Тогда
		
		Если РегламентированнаяОтчетностьКлиентСервер.ОбъектНеОтправлялсяЧерез1СОтчетность(
			ВыборкаЖОС.СостояниеСдачиОтчетности) ИЛИ
			ЭтоОтчетМинобороны Тогда
			
			СтатусыОбъектов
				= РегламентированнаяОтчетностьКлиентСервер.СтатусыОбъектовРеглОтчетностиПриРучномВводе(Форма, КонтроллирующийОрган);
			
			ТекСтатус = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = '%1'"), Форма.Элементы.НаименованиеЭтапа.Заголовок);
			
			Если ЭтоОтчетМинобороны И ТекСтатус = "Передано в Минобороны" Тогда
				ТекСтатус = "Передано";
			КонецЕсли;
			
			Если СтатусыОбъектов.Найти(ТекСтатус) <> Неопределено ИЛИ ЭтоОтчетМинобороны Тогда
...
Функция СохраненныйСтатусОтправкиРеглОтчета(РеглОтчет) Экспорт
	...
	|	И ЖурналОтчетовСтатусы.Ссылка = &РеглОтчет";
	
	Запрос.УстановитьПараметр("Организация", РеглОтчет.Организация);
	Запрос.УстановитьПараметр("РеглОтчет", РеглОтчет);
...
Функция СохраненныйСтатусОтправкиУведомления(Уведомление) Экспорт
	...
	Запрос.УстановитьПараметр("Организация", Уведомление.Организация);
...
Функция АдресВФормате9Запятых(Запись) Экспорт
	...
	Если СтрЧислоСтрок(Запись.ЗначенияПолей) = 1
	   И СтрЧислоВхождений(Запись.ЗначенияПолей, "КонтактнаяИнформация") = 2 Тогда
		...
		СтруктураАдресаЗаписи = РаботаСАдресами.СведенияОбАдресе(Запись.ЗначенияПолей);
		...
		АдресБезКодаСтраны
			= СокрЛП(СтруктураАдресаЗаписи.Индекс)
			+ ","
			+ СокрЛП(СокрЛП(СтруктураАдресаЗаписи.Регион)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.РегионСокращение))
			+ ","
			+ СокрЛП(СокрЛП(СтруктураАдресаЗаписи.Район)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.РайонСокращение))
			+ ","
			+ СокрЛП(СокрЛП(СтруктураАдресаЗаписи.Город)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.ГородСокращение))
			+ ","
			+ СокрЛП(СокрЛП(СтруктураАдресаЗаписи.НаселенныйПункт)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.НаселенныйПунктСокращение)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.Территория)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.ТерриторияСокращение))
			+ ","
			+ СокрЛП(СокрЛП(СтруктураАдресаЗаписи.Улица)
			+ " "
			+ СокрЛП(СтруктураАдресаЗаписи.УлицаСокращение))
			+ ","
			+ СокрЛП(?(СтруктураАдресаЗаписи.Свойство("Здание")
				 	И СтруктураАдресаЗаписи.Здание.Свойство("Номер"),
				 	СтруктураАдресаЗаписи.Здание.Номер, ""))
			+ ","
			+ СокрЛП(ПредставлениеКорпуса)
			+ ","
			+ СокрЛП(ПредставлениеПомещения);
		...
		АдресБезКодаСтраны
			...
			+ ?(СтруктураАдресаЗаписи.Свойство("Здание")
		  	...
		  	И НЕ СокрЛП(СтруктураАдресаЗаписи.Здание.ТипЗдания) = "",
		  	НРег(СокрЛП(СтруктураАдресаЗаписи.Здание.ТипЗдания)), "")
			+ ","
			+ ?(СтруктураАдресаЗаписи.Свойство("Корпуса")
		  	...
		  	И НЕ СокрЛП(СтруктураАдресаЗаписи.Корпуса[0].ТипКорпуса) = "",
		  	НРег(СокрЛП(СтруктураАдресаЗаписи.Корпуса[0].ТипКорпуса)), "")
			+ ","
			+ ?(СтруктураАдресаЗаписи.Свойство("Помещения")
		  	...
		  	И НЕ СокрЛП(СтруктураАдресаЗаписи.Помещения[0].ТипПомещения) = "",
		  	НРег(СокрЛП(СтруктураАдресаЗаписи.Помещения[0].ТипПомещения)), "");
	...
	Иначе
		...
		СтруктураАдресаЗаписи = РаботаСАдресами.ПредыдущаяСтруктураКонтактнойИнформацииXML(Запись.ЗначенияПолей);
		ЗаполнитьЗначенияСвойств(СтруктураАдреса, СтруктураАдресаЗаписи);
		
		АдресБезКодаСтраны
			= СокрЛП(СтруктураАдреса.Индекс)
			+ ","
			+ СокрЛП(СтруктураАдреса.Регион)
			+ ","
			+ СокрЛП(СтруктураАдреса.Район)
			+ ","
			+ СокрЛП(СтруктураАдреса.Город)
			+ ","
			+ СокрЛП(СтруктураАдреса.НаселенныйПункт)
			+ ","
			+ СокрЛП(СтруктураАдреса.Улица)
			+ ","
			+ СокрЛП(СтруктураАдреса.Дом)
			+ ","
			+ СокрЛП(СтруктураАдреса.Корпус)
			+ ","
			+ СокрЛП(СтруктураАдреса.Квартира);
		
		Если СтруктураАдреса.Свойство("ТипДома")
		   И СтруктураАдреса.Свойство("ТипКорпуса")
		   И СтруктураАдреса.Свойство("ТипКвартиры") Тогда
			
			АдресБезКодаСтраны
				= АдресБезКодаСтраны
				+ ","
				+ ?(СокрЛП(СтруктураАдреса.Дом) = "", "", НРег(СокрЛП(СтруктураАдреса.ТипДома)))
				+ ","
...
Функция ЭтоПлательщикЕНВД(Организация, НачалоПериода, КонецПериода) Экспорт
	...
	Возврат РегламентированнаяОтчетностьПереопределяемый.ПлательщикЕНВД(Организация, КонецПериода, НачалоПериода);
...
Функция СвойстваРегламентированногоОтчета(Ссылка) Экспорт
	...
	ВидКонтролирующегоОргана = ВидКонтролирующегоОргана(Ссылка.ИсточникОтчета);
	
	ОрганизацияОтчета = Ссылка.Организация;

	ОтражаетсяВЖурналеОтчетов = Истина;
	...
	ИначеЕсли ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФНС Тогда
		...
		Если Ссылка.ИсточникОтчета = "РегламентированныйОтчетСоответствиеУсловийТруда" Тогда
			
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.Роструд;
			КодКонтролирующегоОргана = "";

		ИначеЕсли Ссылка.ИсточникОтчета = "РасшифровкиБухгалтерскойОтчетности"
		      ИЛИ Ссылка.ИсточникОтчета = "БухгалтерскаяОтчетностьВБанк" Тогда
			ОтражаетсяВЖурналеОтчетов = Ложь;
	...
	ИначеЕсли ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФСГС Тогда
		...
		Попытка
			...
			Если ИсточникОтчета = "РегламентированныйОтчетСтатистикаФорма1ДМ"
				Или ИсточникОтчета = "РегламентированныйОтчетСтатистикаФорма2ДМДавальческоеСырье"
				Или ИсточникОтчета = "РегламентированныйОтчетСтатистикаФорма2ДМ"
				Или ИсточникОтчета = "РегламентированныйОтчетСтатистикаФорма2ДМприл"
				Или ИсточникОтчета = "РегламентированныйОтчетСтатистикаФорма4ДМ" Тогда
				
				КодКонтролирующегоОргана	= "/ Гохран";
			Иначе
				Признак = Ложь;
	...
	ПараметрыОтчета.Вставить("СтатусОтправки",           "В работе");
	...
	ПараметрыОтчета.Вставить("ОтражаетсяВЖурналеОтчетов", ОтражаетсяВЖурналеОтчетов);
...
#Область ИнтерфейсВзаимодействияСКонфигурациямиПотребителями
...
Функция ПолучитьСсылкуНаРеглОтчет(ИсточникОтчета, Организация, ДатаОкончания, КорректирующийОтчет = Ложь, РегистрацияВНалоговомОргане = Неопределено, ФормаОтчета = "") Экспорт
	...
	Если ЗначениеЗаполнено(ФормаОтчета) Тогда
	...
	РезультатЗапроса.Сортировать("Дата Убыв, Вид Убыв, Ссылка Убыв", Новый СравнениеЗначений);
...
Функция ПрименяетсяУСН(Организация, Период) Экспорт
	...
	Возврат СистемаНалогообложения = "Упрощенная";
...
// Диспетчер запуска основной процедуры заполнения регламентированного отчета в фоне.
//
// Параметры:
//   ПараметрыОтчета - Структура - параметры вызова основной функции заполнения отчета:
//     * ИДОтчета - Строка     - идентификтор отчета;
//     * ИДРедакцииОтчета      - Строка - идентификатор формы отчета;
//     * ПараметрыОтчета       - Структура - параметры заполнения отчета;
//     * Контейнер - Структура - показатели отчета по разделам;
//   НеиспользуемыйАдресХранилища - Строка - параметр необходим для совместимости с БСП.
//
Процедура ЗаполнитьОтчетВФоне(ПараметрыОтчета, НеиспользуемыйАдресХранилища) Экспорт
	
	РегламентированнаяОтчетностьПереопределяемый.ЗаполнитьОтчет(
		ПараметрыОтчета.ИДОтчета, ПараметрыОтчета.ИДРедакцииОтчета,
		ПараметрыОтчета.ПараметрыОтчета, ПараметрыОтчета.Контейнер);
	
КонецПроцедуры

Процедура УдалитьСтарыеПечатныеБланкиРегламентированныхОтчетов() Экспорт
	...
	|ГДЕ
	|	ПечатныеБланкиРегламентированныхОтчетов.ДатаЗаписи < &ДатаЗаписи";
	
	Запрос.Текст = ТекстЗапроса;
	
	Запрос.УстановитьПараметр("ДатаЗаписи", ДобавитьМесяц(ТекущаяДатаСеанса(), -1));
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			ЗаписьРегистраСведений.РегламентированныйОтчет = Выборка.РегламентированныйОтчет;
			ЗаписьРегистраСведений.УникальныйИдентификатор = Выборка.УникальныйИдентификатор;
...
// Возвращает сведения об адресе в виде отдельных частей адреса и различных кодов в формате ФИАС.
//
// Параметры:
//   Адрес - Строка - адрес во внутреннем формате JSON.
//   ДополнительныеПараметры - Структура (необязательный параметр):
//        * ВерсияАдреса     - Число - внутренняя версия адреса (необязательное свойство):
...
//        * ИдентификаторАдресногоОбъекта - УникальныйИдентификатор - идентификационный код дома (строения) адресного
//                                          объекта (например, для "Москва г., Дмитровское ш., д.9" - это идентификатор
//                                          дома), а в случае, если идентификационный код дома (строения) адресного
//                                          объекта не задан - идентификационный код последнего адресного объекта
//                                          в иерархии адреса (например, для "Москва г., Дмитровское ш., д.9" - это
//                                          идентификатор улицы).
//        * Индекс                        - Строка - почтовый индекс.
//        * КодРегиона                    - Строка - код региона Российской Федерации.
//        * РегионСокращение              - Строка - сокращение региона.
//        * МуниципальныйРайонВид         - Строка - код ("1" - муниципальный район; "2" - городской округ;
...
//        * МуниципальныйРайонСокращение  - Строка - сокращение муниципального района.
//        * ПоселениеВид                  - Строка - код ("1" - городское поселение; "2" - сельское поселение;
//                                          "3" - межселенная территория в составе муниципального района;
//                                          "4" - внутригородской район городского округа).
//        * Поселение                     - Строка - текстовое представление поселения.
//        * ПоселениеСокращение           - Строка - сокращение поселения.
//        * НаселенныйПунктВид            - Строка - полное наименование сокращения населенного пункта.
...
//        * ТерриторияТип                 - Строка - полное наименование сокращения территории.
//        * Территория                    - Строка - текстовое представление территории.
//        * ТерриторияСокращение          - Строка - сокращение территории.
//        * УлицаТип                      - Строка - полное наименование сокращения улицы.
//        * Улица                         - Строка - текстовое представление улицы.
//        * УлицаСокращение               - Строка - сокращение улицы.
//        * Здания                        - Массив - содержит структуры (поля структуры: ЗданиеТип, ЗданиеНомер)
//                                          с перечнем зданий, сооружений, объектов незавершенного строительства.
//        * ПомещениеВЗданииТип           - Строка - тип помещения внутри здания, сооружения, машино-места.
//        * ПомещениеВЗданииНомер         - Строка - номер помещения внутри здания, сооружения, машино-места.
//        * ПомещениеВКвартиреТип         - Строка - тип помещения в пределах квартиры.
//        * ПомещениеВКвартиреНомер       - Строка - номер помещения в пределах квартиры.
//
Функция АдресВФорматеФИАС(Адрес, ДополнительныеПараметры = Неопределено) Экспорт
	
	ВерсияАдреса = 1;
	Если ТипЗнч(ДополнительныеПараметры) = Тип("Структура") И ДополнительныеПараметры.Свойство("ВерсияАдреса") Тогда
		ВерсияАдреса = ДополнительныеПараметры.ВерсияАдреса;
	КонецЕсли;
	
	ВозвращаемыйАдрес = Новый Структура;
	
	// Получение реквизитов адреса с сокращениями.
	//
	ДопПараметры = Новый Структура("КодыАдреса", Истина);
	
	СтруктураАдресаЗаписи = РаботаСАдресами.СведенияОбАдресе(Адрес, ДопПараметры);
	...
	ЗначениеСвойства = "";
	Если СтруктураАдресаЗаписи.Свойство("КодМуниципальногоРайона", ЗначениеСвойства) Тогда
		ВозможныеКодыМуниципальногоРайона = СтрРазделить("1,2,3,4", ",", Ложь);
		Если ВозможныеКодыМуниципальногоРайона.Найти(ЗначениеСвойства) = Неопределено Тогда
			ЗначениеСвойства = "";
		КонецЕсли;
	Иначе
		ЗначениеСвойства = "";
		Сокращение = НРег(СокрЛП(ВозвращаемыйАдрес.МуниципальныйРайонСокращение));
		Если Сокращение = "м.р-н" Тогда
			ЗначениеСвойства = "1";
		ИначеЕсли Сокращение = "г.о." Тогда
			ЗначениеСвойства = "2";
		ИначеЕсли Сокращение = "вн.тер." ИЛИ Сокращение = "вн.тер. г." Тогда
			ЗначениеСвойства = "3";
		ИначеЕсли Сокращение = "мун. окр." Тогда
			ЗначениеСвойства = "4";
		КонецЕсли;
	КонецЕсли;
	Если ВерсияАдреса = 1 И ЗначениеСвойства = "4" Тогда
		ЗначениеСвойства = "1";
	КонецЕсли;
	ВозвращаемыйАдрес.Вставить("МуниципальныйРайонВид", ЗначениеСвойства);
	
	ЗначениеСвойства = "";
	Если СтруктураАдресаЗаписи.Свойство("КодПоселения", ЗначениеСвойства) Тогда
		ВозможныеКодыПоселения = СтрРазделить("1,2,3,4", ",", Ложь);
		Если ВозможныеКодыПоселения.Найти(ЗначениеСвойства) = Неопределено Тогда
			ЗначениеСвойства = "";
		КонецЕсли;
	Иначе
		ЗначениеСвойства = "";
		Сокращение = НРег(СокрЛП(ВозвращаемыйАдрес.ПоселениеСокращение));
		Если Сокращение = "г. п." Тогда
			ЗначениеСвойства = "1";
		ИначеЕсли Сокращение = "с.п." Тогда
			ЗначениеСвойства = "2";
		ИначеЕсли Сокращение = "меж.тер." Тогда
			ЗначениеСвойства = "3";
		ИначеЕсли Сокращение = "вн.р-н" Тогда
			ЗначениеСвойства = "4";
		КонецЕсли;
	КонецЕсли;
	ВозвращаемыйАдрес.Вставить("ПоселениеВид", ЗначениеСвойства);
	
	Здания = Новый Массив;
	Здание = Неопределено;
	Если СтруктураАдресаЗаписи.Свойство("Здание", Здание) И ТипЗнч(Здание) = Тип("Структура") Тогда
		ЗданиеТип = Неопределено;
		Здание.Свойство("ТипЗдания", ЗданиеТип);
		ЗданиеНомер = Неопределено;
		Здание.Свойство("Номер", ЗданиеНомер);
	...
	Если СтруктураАдресаЗаписи.Свойство("Корпуса", Корпуса) И ТипЗнч(Корпуса) = Тип("Массив") Тогда
		Для Каждого Корпус Из Корпуса Цикл
			Если ТипЗнч(Корпус) = Тип("Структура") Тогда
				КорпусТип = Неопределено;
				Корпус.Свойство("ТипКорпуса", КорпусТип);
				КорпусНомер = Неопределено;
				Корпус.Свойство("Номер", КорпусНомер);
	...
	Если СтруктураАдресаЗаписи.Свойство("Помещения", Помещения) Тогда
		Для Каждого Помещение Из Помещения Цикл
			ПомещениеТип   = Неопределено;
			ПомещениеНомер = Неопределено;
			Если Помещение.Свойство("ТипПомещения", ПомещениеТип) И Помещение.Свойство("Номер", ПомещениеНомер) Тогда
				Если ПомещениеВКвартиреТип = "" И ПомещениеВКвартиреНомер = "" И ЗначениеЗаполнено(ПомещениеНомер)
					И НРег(ПомещениеТип) = "комната" Тогда
					ПомещениеВКвартиреТип = "Комната";
					ПомещениеВКвартиреНомер = ПомещениеНомер;
				ИначеЕсли ПомещениеВЗданииТип = "" И ПомещениеВЗданииНомер = "" И ЗначениеЗаполнено(ПомещениеНомер)
					И ЗначениеЗаполнено(ПомещениеТип) И НРег(ПомещениеТип) <> "комната" Тогда
					ПомещениеВЗданииТип = ПомещениеТип;
					ПомещениеВЗданииНомер = ПомещениеНомер;
				КонецЕсли;
			КонецЕсли;
			Если ПомещениеВЗданииТип <> "" И ПомещениеВЗданииНомер <> ""
				И ПомещениеВКвартиреТип <> "" И ПомещениеВКвартиреНомер <> "" Тогда
				Прервать;
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
	...
	// Получение полных наименований сокращений.
	//
	ДопПараметры = Новый Структура("КодыАдреса,ПолноеНаименованиеСокращений", Истина, Истина);
	
	СтруктураАдресаЗаписи = РаботаСАдресами.СведенияОбАдресе(Адрес, ДопПараметры);
	
	ВозвращаемыйАдрес.Вставить("НаселенныйПунктВид", ?(СтруктураАдресаЗаписи.Свойство("НаселенныйПунктСокращение"),
	СтруктураАдресаЗаписи["НаселенныйПунктСокращение"], ""));
	
	ВозвращаемыйАдрес.Вставить("ТерриторияТип", ?(СтруктураАдресаЗаписи.Свойство("ТерриторияСокращение"),
	СтруктураАдресаЗаписи["ТерриторияСокращение"], ""));
	
	ВозвращаемыйАдрес.Вставить("УлицаТип", ?(СтруктураАдресаЗаписи.Свойство("УлицаСокращение"),
	СтруктураАдресаЗаписи["УлицаСокращение"], ""));
	
	Возврат ВозвращаемыйАдрес;
	
КонецФункции

Процедура ЗаполнитьАдресВФорматеФИАСНаСтраницеРеглОтчета(СтраницаРаздела, ПараметрыЗаполнения) Экспорт
	...
	СтруктураАдреса = АдресВФорматеФИАС(ПараметрыЗаполнения.Адрес, ДополнительныеПараметры);
	...
	Для Каждого Элем Из СоответствиеПоказателейСтраницыРеквизитамАдреса Цикл
		...
		ИначеЕсли СтраницаРаздела.ДанныеМногострочныхЧастей.Свойство(Элем.Ключ)
			...
			//
			ДеревоМногострочнойЧасти = СтраницаРаздела.ДанныеМногострочныхЧастей[Элем.Ключ];
			ДеревоМногострочнойЧасти.Строки.Очистить();
			...
			Для Каждого РеквизитАдреса Из МножественныйРеквизитАдреса Цикл
				СтрокаМногострочнойЧасти = ДеревоМногострочнойЧасти.Строки.Добавить();
				СтрокаМногострочнойЧасти.Данные = Новый Структура;
				СтрокаМногострочнойЧасти.ДанныеМногострочныхЧастей = Новый Структура;
				Для Каждого ЭлемСоответствия Из СоответствиеМногострочнойЧастиМножественномуРеквизитуАдреса Цикл
					СтрокаМногострочнойЧасти.Данные.Вставить(ЭлемСоответствия.Ключ, РеквизитАдреса[ЭлемСоответствия.Значение]);
				КонецЦикла;
			КонецЦикла;
			
			Если ДеревоМногострочнойЧасти.Строки.Количество() = 0 Тогда
				СтрокаМногострочнойЧасти = ДеревоМногострочнойЧасти.Строки.Добавить();
				СтрокаМногострочнойЧасти.Данные = Новый Структура;
				СтрокаМногострочнойЧасти.ДанныеМногострочныхЧастей = Новый Структура;
				Для Каждого ЭлемСоответствия Из СоответствиеМногострочнойЧастиМножественномуРеквизитуАдреса Цикл
					СтрокаМногострочнойЧасти.Данные.Вставить(ЭлемСоответствия.Ключ, "");
				КонецЦикла;
			КонецЕсли;
...
// Возвращает признак учета отложенного налога балансовым методом
...
//
// Возвращаемое значение:
//   Истина - Учет ведется балансовым методом.
//   Ложь   - Учет балансовым методом не ведется.
//
Функция УчетОтложенногоНалогаБалансовымМетодом(Организация, Период) Экспорт
	
	УчетБалансовымМетодом = Ложь;
	
	РегламентированнаяОтчетностьПереопределяемый.ОпределитьУчетОтложенногоНалогаБалансовымМетодом(
		УчетБалансовымМетодом, Организация, Период);
	
	Возврат УчетБалансовымМетодом;
...
Процедура Автозаполнение_РеестрПоНДС_Приложение1(ПереданныеПараметры, НеиспользуемыйАдресХранилища) Экспорт
	
	РегламентированнаяОтчетностьПереопределяемый.ЗаполнитьОтчет(ПереданныеПараметры.ИДОтчета,
	ПереданныеПараметры.ИДРедакцииОтчета, ПереданныеПараметры.ПараметрыОтчета, ПереданныеПараметры.Контейнер);
	
	ДеревоДанныхРеестр = ПереданныеПараметры.Контейнер.Реестр;
	
	СтруктураРеквизитовФормы = ПереданныеПараметры.ПараметрыОтчета.СтруктураРеквизитовФормы;
	...
	ИсходныйМакет = РегламентированнаяОтчетность.РеглОтчеты(
	ПереданныеПараметры.ИДОтчета).ПолучитьМакет(ПереданныеПараметры.ИДРедакцииОтчета + "_" + ИмяРаздела);
	...
	Для Инд = 0 По ДеревоДанныхРеестр.Строки.Количество() - 1 Цикл
		...
		Если ЗначениеЗаполнено(КодОперации) И НумераторыПоКодамОпер.Свойство("_" + КодОперации) Тогда
	...
	Для Каждого Стр Из СуммыПоКодамОперПостранично Цикл
		...
		Если СтруктураРеквизитовФормы.ФлажокОтклАвтоРасчет Тогда
			ИтоговыеСуммыПоКодамОпераций.Добавить(Новый Структура("КодОперации,НалБазаИтого", Стр.Код, 0));
			ИтогоСуммаПоКодуОпер = 0;
		Иначе
			ИтоговыеСуммыПоКодамОпераций.Добавить(Новый Структура("КодОперации,НалБазаИтого", Стр.Код, Стр.Сумма));
	...
	ПоместитьВоВременноеХранилище(ДеревоДанныхРеестр, СтруктураРеквизитовФормы.АдресВоВрХранилищеДеревоДанныхРеестр);
	
	ПоместитьВоВременноеХранилище(
	СтруктураРеквизитовФормы, ПереданныеПараметры.ПараметрыОтчета.АдресВоВременномХранилище);
	
КонецПроцедуры

Процедура Автозаполнение_РеестрПоНДС_Приложение5(ПереданныеПараметры, НеиспользуемыйАдресХранилища) Экспорт
...
//     * ИмяСтраницы - Строка - идентификатор отчета
//     * Представление - Строка - название отчета
//     * ПоказатьСтраницу - Число - признак включения отчета в состав отчетности:
//       ** 0 - отчет исключается из состава отчетности
//       ** 1 - отчет включается в состав отчетности
//
Процедура ИзменитьСоставОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, РазделыОтчета) Экспорт
	
	ПризнакиВключения = ПризнакиВключения(РазделыОтчета);
	
	РегламентированнаяОтчетностьПереопределяемый.ИзменитьСоставОтчета(
		ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, ПризнакиВключения);
	
	ИзменитьПризнакиВключения(РазделыОтчета, ПризнакиВключения);
...
Процедура УстановитьФорматВыгрузкиСтатистическойОтчетностиВЭлектронномВиде(Организация, Формат) Экспорт 
	Попытка
		Если ПравоДоступа("Изменение", Метаданные.Константы.НастройкиФорматаВыгрузкиОтчетовСтатистики) Тогда
			Константы.НастройкиФорматаВыгрузкиОтчетовСтатистики.СоздатьМенеджерЗначения().УстановитьФорматВыгрузки(Организация, Формат);
		КонецЕсли;
	Исключение
	КонецПопытки;
КонецПроцедуры
...
Функция ФорматВыгрузкиСтатистическойОтчетностиВЭлектронномВиде(Организация) Экспорт
	...
	Попытка
		Если ПравоДоступа("Изменение", Метаданные.Константы.НастройкиФорматаВыгрузкиОтчетовСтатистики) Тогда
			НомерФормата = Константы.НастройкиФорматаВыгрузкиОтчетовСтатистики.СоздатьМенеджерЗначения().ПолучитьФорматВыгрузки(Организация);
		КонецЕсли;
	Исключение
	КонецПопытки;
	...
	ПустоеПодразделение = Ложь;
	СпрПодразделенияОрганизаций = РегламентированнаяОтчетностьПереопределяемый.ИмяСправочникаОбособленныхПодразделений();
	Если ЗначениеЗаполнено(СпрПодразделенияОрганизаций) И Организация = Справочники[СпрПодразделенияОрганизаций].ПустаяСсылка() Тогда
		ПустоеПодразделение = Истина;
	КонецЕсли;
	
	Если Не (ТипЗнч(СтруктураФорматовВыгрузки) = Тип("Структура"))
		Или Организация = Справочники.Организации.ПустаяСсылка()
		Или ПустоеПодразделение Тогда
		Возврат Неопределено;
	КонецЕсли;
	...
	Для НомерФормата = 1 По 2 Цикл
		...
		Если МассивОрганизаций.Найти(Организация) <> Неопределено Тогда
			УстановитьФорматВыгрузкиСтатистическойОтчетностиВЭлектронномВиде(Организация, НомерФормата);
...
Функция АтрибутыВФорматеВыгрузки(Параметры) Экспорт
	...
	Если ПризнакИспользования Тогда
		Попытка
			ДанныеОтчета = Параметры["Документ"].ДанныеОтчета.Получить();
			Если ДанныеОтчета.Свойство("ОбособленноеПодразделение") Тогда
	...
	Если ФорматВыгрузкиСтатистическойОтчетностиВЭлектронномВиде(Организация) = 2 Тогда // "новый" формат выгрузки
...
Процедура СформироватьСтруктуруЦветовРаскраски(Форма) Экспорт 
	...
	Форма.мСтруктураЦветовРаскраски.Вставить("_7", ЦветЗаполняетсяАвтоБезКорректир);
...
Функция СформироватьСтруктуруОбязательныхРеквизитовСтатистическогоОтчета(Организация = Неопределено) Экспорт 
	...
	СтруктураРеквизитовФормы.Вставить("ИспользуетсяНастройкаПодписантов", Ложь);
	СтруктураРеквизитовФормы.Вставить("Адрес_JSON", "");
	Если ЗначениеЗаполнено(Организация) Тогда
		КИ = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъекта(Организация, Справочники.ВидыКонтактнойИнформации.ПочтовыйАдресОрганизации, ТекущаяДатаСеанса(), Ложь);
		Если ТипЗнч(КИ) = Тип("ТаблицаЗначений")
			И КИ.Количество() = 1
			И КИ.Колонки.Найти("Значение") <> Неопределено Тогда
			
			СтруктураРеквизитовФормы["Адрес_JSON"] = КИ[0].Значение;
		КонецЕсли;
	КонецЕсли;
	...
	РегламентированнаяОтчетностьПереопределяемый.ИспользоватьКонтекстнуюНастройкуПодписантовСтатистики(СтруктураРеквизитовФормы.ИспользуетсяНастройкаПодписантов);
	
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаТабличногоДокумента", "");
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаАтрибутовВыгрузки", "");
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаСхемыВыгрузки", "");
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаШаблона", "");
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаСписков", "");
	СтруктураРеквизитовФормы.Вставить("ИмяМакетаСоставаПоказателей", "");
...
Процедура УстановитьЗначениеИФорматВПоле(ТекТабличноеПоле, ИмяПоказателя, ЗначениеПоказателя) Экспорт 
	...
	Иначе
		...
		Если Область <> Неопределено Тогда
			...
			Иначе
				Область.Текст = Строка(ЗначениеПоказателя);
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗаписатьРегламентированныйОтчетВРегистрЖурналОтчетовСтатусы(Ссылка)
	...
	Если ПараметрыОтчета.ОтражаетсяВЖурналеОтчетов Тогда
...
Функция ВидКонтролирующегоОргана(ИмяОтчета) Экспорт
	...
	Иначе
		...
		Если СтрНайти(ИмяОтчета, "СтатистикаФормаУчетаПеремещенияТоваровТС") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФТС;
		ИначеЕсли СтрНайти(ИмяОтчета, "Форма2ТПВоздух") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.РПН;
		ИначеЕсли СтрНайти(ИмяОтчета, "Статистика") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФСГС;
		ИначеЕсли СтрНайти(ИмяОтчета, "Алко") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФСРАР;
		ИначеЕсли СтрНайти(ИмяОтчета, "ОкрСреда") > 0
		ИЛИ СтрНайти(ИмяОтчета, "ОтходыСубъектовМСП") > 0 
		ИЛИ СтрНайти(ИмяОтчета, "Форма2ТПОтходы") > 0 
		ИЛИ СтрНайти(ИмяОтчета, "РасчетЭкологическийСбор") > 0 
		ИЛИ СтрНайти(ИмяОтчета, "ДекларацияПлатаНВОС") > 0 
		ИЛИ СтрНайти(ИмяОтчета, "Форма2ТПРекультивация") > 0 
		ИЛИ СтрНайти(ИмяОтчета, "ДекларацияОВоздействииНаОкружающуюСреду") > 0 
		Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.РПН;
		ИначеЕсли СтрНайти(ИмяОтчета, "ОперацииСДенежнымиСредствамиНФО") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.БанкРоссии;
		ИначеЕсли СтрНайти(ИмяОтчета, "ИсполнениеКонтрактовГОЗ") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.Минобороны;
		ИначеЕсли СтрНайти(ИмяОтчета, "4ФСС") > 0 Тогда
			ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.ФСС;
		ИначеЕсли СтрНайти(ИмяОтчета, "РВ3") > 0 ИЛИ СтрНайти(ИмяОтчета, "РСВ") > 0 Тогда
...
Функция ОпределитьСвойстваОбъектовДляОтображенияВФормеОтчетность(Ссылки) Экспорт
	...
	ТаблицаСвойств.Колонки.Добавить("ВариантОтчета", 			Новый ОписаниеТипов("Строка,Число"));
...
Процедура ОпределениеСвойстваОбъектаДляОтображенииВФормеОтчетность(Ссылка, ЗначенияЗаполнения)
	...
	Если СвойстваСсылки <> Неопределено Тогда
		...
		Если ТипЗнч(СвойстваСсылки.ВариантОтчета) = Тип("Число") Тогда
			ЗначенияЗаполнения.ПредставлениеВида = ?(СвойстваСсылки.ВариантОтчета = 0, "П", "К/" + СвойстваСсылки.ВариантОтчета);
		Иначе
			ЗначенияЗаполнения.ПредставлениеВида = Строка(СвойстваСсылки.ВариантОтчета);
		КонецЕсли;
...
Функция КодОрганаФССИзДанныхОтчета(ХранилищеДанныхОтчета)
	...
	Если ЗначениеЗаполнено(ДанныеОтчета) Тогда
		...
		ИначеЕсли ДанныеОтчета.ПоказателиОтчета.Свойство("ПолеТабличногоДокументаПриложение1") Тогда
			
			ТитульныйЛист = ДанныеОтчета.ПоказателиОтчета.ПолеТабличногоДокументаПриложение1;
...
Процедура ЗаписьОбъектовРегламентированнойОтчетности(Источник, Отказ) Экспорт
	...
	ИначеЕсли ТипЗнч(Ссылка) = Тип("СправочникСсылка.ЗаявлениеОНазначенииПенсии") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьЗаявлениеОНазначенииПенсииВРегистрЖурналОтчетовСтатусы(Ссылка);
	ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.ЗаявленияПоЭлДокументооборотуСПФР") Тогда
		ЭлектронныйДокументооборотСКонтролирующимиОрганами.ЗаписатьЗаявленияВПФРВРегистрЖурналОтправокВКонтролирующиеОрганы(Ссылка);
...
Процедура ВыполнитьДействияПередУдалениемПрисоединенногоФайла(Источник, Отказ) Экспорт
	...
	МассивФайловВладельца = ПолучитьВсеПодчиненныеФайлы(ВладелецФайлов);
...
Процедура РегламентированныйОтчетОтправляетсяВКонтролирующиеОрганы(ДокСсылка, ОбъектОтправляется) Экспорт
	...
	РеглОтчетыНеОтправляютсяВКонтролирующиеОрганы = РегламентированнаяОтчетностьПовтИсп.ОтчетыНеОтправляемыеВКонтролирующиеОрганы();
...
Функция КоличествоОбъектовНеЗаписанныхВРегистр(ПараметрыПроцедуры) Экспорт
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(ПараметрыПроцедуры.УникальныйИдентификаторФормы);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru = 'Проверка полноты данных журнала регламентированной отчетности'");
...
Функция ДобавлениеОбъектовОтсутствующихВРегистре(ПараметрыПроцедуры) Экспорт
	...
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(ПараметрыПроцедуры.УникальныйИдентификаторФормы);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Заполнение данных журнала регламентированной отчетности'");
	ПараметрыВыполнения.ОжидатьЗавершение = 0;
	ПараметрыВыполнения.ЗапуститьВФоне = Истина;
...
Функция ПолучитьМассивФормСтатистикиТолькоДляОрганизации()
	Возврат РегламентированнаяОтчетностьПовтИсп.ПолучитьМассивФормСтатистикиТолькоДляОрганизации();
КонецФункции

Функция ПолучитьМассивФормСтатистикиТолькоДляИП()
	Возврат РегламентированнаяОтчетностьПовтИсп.ПолучитьМассивФормСтатистикиТолькоДляИП();
КонецФункции
...
Процедура УстановитьОтборВФормеВыбораОтчета(Форма) Экспорт
	...
	ИмяОтчета = Сред(СтрЗаменить(ИмяОтчета, "ВнешнийОтчет.", "Отчет."), СтрДлина("Отчет.") + 1);
...
Процедура ВставитьПоказательВТаблицуОценкиРисков(ТаблицаПоказателей, ОписаниеОтчета)
	...
	ИначеЕсли ОписаниеОтчета.ИсточникОтчета = "РегламентированныйОтчетАкцизыНефтяноеСырье" Тогда
		ВставитьПоказатели_АкцизыНефтяноеСырье(ТаблицаПоказателей, ОписаниеОтчета);
...
Процедура ВставитьПоказатели_Имущество(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв4" Тогда
		...
		Иначе
			...
			Для Каждого СтрокаМнЧ Из ДанныеМногострочнойЧастиРаздела1.Строки Цикл
				ЗначениеПоказателя = ЗначениеПоказателя + ПоказательОтчета(СтрокаМнЧ.Данные, "П000010002103");
			КонецЦикла;
		КонецЕсли;
...
Процедура ВставитьПоказатели_ЗемельныйНалог(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2018Кв3"
		...
		Иначе
			...
			= СведенияОтчета.ДанныеМногоуровневыхРазделов["Раздел1"].Строки[0].ДанныеМногострочныхЧастей["П0000100"];
			Для Каждого СтрокаМнЧ Из ДанныеМногострочнойЧастиРаздела1.Строки Цикл
				ЗначениеПоказателя = ЗначениеПоказателя + СтрокаМнЧ.Данные.П000010002103;
			КонецЦикла;
		КонецЕсли;
	ИначеЕсли ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2014Кв4"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2013Кв4"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2011Кв1" Тогда
		Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов.Раздел1 Цикл
			ДанныеЛиста = Лист.Данные;
			Для Инд = 1 По 2 Цикл
				Постфикс = "_" + ЧислоВСтрокуЧГ0(Инд);
...
Процедура ВставитьПоказатели_НДПИ(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв1"
...
Процедура ВставитьПоказатели_ВодныеБиоресурсы(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв4" Тогда
...
Процедура ВставитьПоказатели_Прибыль(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв4" Тогда
		...
		Иначе
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя + ПоказательОтчета(ДанныеЛиста, "П000020006003");
			КонецЦикла;
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя
				+ ПоказательОтчета(ДанныеЛиста, "П000020019003") + ПоказательОтчета(ДанныеЛиста, "П000020020003");
			КонецЦикла;
			...
			Для Каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				...
				Для Каждого СтрокаПодчМнЧ Из ДеревоПодчМнЧ.Строки Цикл
					ЗначениеПоказателя = ЗначениеПоказателя + ПоказательОтчета(СтрокаПодчМнЧ.Данные, "П00013М204003");
				КонецЦикла;
			КонецЦикла;
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя + ПоказательОтчета(ДанныеЛиста, "П000020003003");
			КонецЦикла;
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя + ПоказательОтчета(ДанныеЛиста, "П000020001003");
			КонецЦикла;
...
Процедура ВставитьПоказатели_БухОтчетность(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв1" Тогда
...
Процедура ВставитьПоказатели_НДС(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв1"
		...
		ЗначениеПоказателя = ПоказательОтчета(Раздел3, "П000300011805");
...
Процедура ВставитьПоказатели_3НДФЛ(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019кв1"
		Или ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2020кв1" Тогда
		
		СуммаНДФЛКУплатеКлюч = "П000100001040";
		ОбщаяСуммаДоходаКлюч = "П000500001050";
		СуммаФактическиПроизведенныхРасходовКлюч = "П000500001040";
		
		ИмяРазделаСДоходамиИП = "Приложение3";
		
	ИначеЕсли ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2015кв1"
	 ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2016кв1"
	 ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017кв1"
	 ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2018кв1" Тогда
		
		СуммаНДФЛКУплатеКлюч = "П000100001040";
		ОбщаяСуммаДоходаКлюч = "П000500001110";
		СуммаФактическиПроизведенныхРасходовКлюч = "П000500001040";
		
		ИмяРазделаСДоходамиИП = "ЛистВ";
		
	Иначе
		
		СуммаНДФЛКУплатеКлюч = "П000010011003";
	...
	Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов.Раздел1 Цикл
		...
		ДанныеЛиста = Лист.Данные;
		ЗначениеПоказателя = ЗначениеПоказателя
		                   + ПоказательОтчета(ДанныеЛиста, СуммаНДФЛКУплатеКлюч);
	...
	Для Каждого Лист Из СведенияОтчета.ДанныеМногостраничныхРазделов[ИмяРазделаСДоходамиИП] Цикл
		
		ДанныеЛиста = Лист.Данные;
		СуммаДоходовИП = СуммаДоходовИП + ПоказательОтчета(ДанныеЛиста, ОбщаяСуммаДоходаКлюч);
		СуммаРасходовИП = СуммаРасходовИП + ПоказательОтчета(ДанныеЛиста, СуммаФактическиПроизведенныхРасходовКлюч);
...
Процедура ВставитьПоказатели_4ФСС(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв3"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв1" Тогда
		
		Таблица1 = СведенияОтчета.ПоказателиОтчета.ПолеТабличногоДокументаТаблица1;
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2017Кв3"
		...
		ЗначениеПоказателя = ПоказательОтчета(Таблица1, "П000010000103");
		
	ИначеЕсли ОписаниеОтчета.ВыбраннаяФорма <> "ФормаОтчета2010Кв4" Тогда
...
Процедура ВставитьПоказатели_АкцизыНефтяноеСырье(ТаблицаПоказателей, ОписаниеОтчета)
...
Процедура ВставитьПоказатели_АкцизыТабак(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2018Кв3" Тогда
...
Процедура ЗапомнитьИменаСправочниковОбособленныхПодразделений(Форма) Экспорт 
	...
	Форма.ИмяСправочникаОбособленныхПодразделений        = РегламентированнаяОтчетностьПереопределяемый.ИмяСправочникаОбособленныхПодразделений(ИмяОтчета);
	Форма.ИмяРеквизитаПризнакаОбособленногоПодразделения = РегламентированнаяОтчетностьПереопределяемый.ИмяРеквизитаПризнакаОбособленногоПодразделения(ИмяОтчета);
КонецПроцедуры
...
Функция ПолучитьВсеПодчиненныеФайлы(ВладелецФайла)
	...
	ИмяСправочника = "Файлы";
		
	Если Метаданные.Справочники.Найти(ИмяСправочника) = Неопределено
	 ИЛИ Метаданные.Справочники[ИмяСправочника].Реквизиты.Найти("ВладелецФайла") = Неопределено Тогда
...
Процедура ВставитьОбъектМетаданныхПриЕгоНаличииВСпискиСОграничениемДоступа(Списки, ПолноеИмяОбъектаМетаданных)
	
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени(ПолноеИмяОбъектаМетаданных);
	
	Если НЕ ОбъектМетаданных = Неопределено Тогда
		Списки.Вставить(ОбъектМетаданных, Истина);
	КонецЕсли;
	
КонецПроцедуры

Процедура ДобавитьОбъектМетаданныхВВидыОграниченийПравПоОрганизации(ОписаниеОграничений, ПолноеИмяОбъектаМетаданных)
	
	ОбъектМетаданных = Метаданные.НайтиПоПолномуИмени(ПолноеИмяОбъектаМетаданных);
	
	Если НЕ ОбъектМетаданных = Неопределено Тогда
		ОписаниеОграничений = ОписаниеОграничений
			+ Символы.ПС + ПолноеИмяОбъектаМетаданных + ".Чтение.Организации"
			+ Символы.ПС + ПолноеИмяОбъектаМетаданных + ".Изменение.Организации";
	КонецЕсли;
...
Функция ПолучитьЗначениеПоУмолчанию(Настройка, Пользователь = Неопределено) Экспорт
	...
	ИначеЕсли ВРег(Настройка) = ВРег("ОсновноеПодразделениеОрганизации") Тогда
		...
		Если ЗначениеЗаполнено(СпрПодразделенияОрганизаций) Тогда
			ПустоеЗначение = Справочники[СпрПодразделенияОрганизаций].ПустаяСсылка();
		Иначе
			Возврат Неопределено;
		КонецЕсли;
...
Функция ФормаРеглОтчета(Наим, ВыбраннаяФорма = Неопределено, Владелец = Неопределено, КлючУникальности = Неопределено) Экспорт
	...
	Если Наим = "БухгалтерскаяОтчетностьВБанк"
	 Или Наим = "РасшифровкиБухгалтерскойОтчетности" Тогда
		Возврат Отчеты[Наим];
	КонецЕсли;
...
Функция ВывестиСведенияОбОтправителе30(Текст, Организация = Неопределено, Знач ОргНазв = Неопределено, Знач ОргТелефон = Неопределено, Знач ОргБухгалтер = Неопределено, ВыгрузкаДекларацииПоАлкоголю = Ложь) Экспорт
	...
	Иначе
		...
		// Отправитель - ФЛ.
		ФИООтпрФЛ = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(
			Организация, ТекущаяДатаСеанса(), "ФИО").ФИО;
				
		Если ПустаяСтрока(ФИООтпрФЛ) Тогда
			
			Сообщение = Новый СообщениеПользователю;
			
			Сообщение.Текст = НСтр("ru='Невозможно определить ФИО индивидуального предпринимателя! Выгрузка прервана!'");
	...
	Для Каждого СтраницаРаздела Из КартаСтраницРаздела Цикл
		...
		Для Каждого ПечатныйЛист Из ПечатныеЛисты Цикл
			...
			Если СписокПечатаемыхЛистов.Количество() > 0
			   ...
			   СтруктураПараметровЛиста.Свойство("НомерСтраницы", НомерСтраницы);
			   			   			   
			   УникальныйИдентификатор = Новый УникальныйИдентификатор;
			   
			   НаборЗаписей = РегистрыСведений.ПечатныеБланкиРегламентированныхОтчетов.СоздатьНаборЗаписей();
			   			   			   
			   НаборЗаписей.Отбор.РегламентированныйОтчет.Установить(СписокПечатаемыхЛистов[0].Значение);
			   НаборЗаписей.Отбор.УникальныйИдентификатор.Установить(УникальныйИдентификатор);
			   
			   ЗаписьРегистраСведений = НаборЗаписей.Добавить();
			   
			   ЗаписьРегистраСведений.РегламентированныйОтчет = СписокПечатаемыхЛистов[0].Значение;
			   ЗаписьРегистраСведений.УникальныйИдентификатор = УникальныйИдентификатор;
			   			    			
			   ЗаписьРегистраСведений.ПечатныйБланк = Новый ХранилищеЗначения(ПечатныйЛист.Значение);
			   ЗаписьРегистраСведений.ИмяСтраницы = ИмяЛиста + ". Стр. " +
			   		(НомерСтраницы - 1 - (КартаСтраницРаздела.Количество() - НомЛиста));
			   ЗаписьРегистраСведений.НомерСтраницы =
			   		НомерСтраницы - 1 - (КартаСтраницРаздела.Количество() - НомЛиста);
			   
			   ЗаписьРегистраСведений.ДатаЗаписи = ТекущаяДатаСеанса();
			   			   
			   НаборЗаписей.Записать();
			   			   				   
			   СписокПечатаемыхЛистов.Добавить(УникальныйИдентификатор);
			
		   Иначе
			   
			   СписокПечатаемыхЛистов.Добавить(ПечатныйЛист.Значение, ИмяЛиста);
...
//
Функция ИПИспользуетТрудНаемныхРаботников(Организация,
	...
	РегламентированнаяОтчетностьПереопределяемый.ПолучитьПризнакИспользованияИПТрудаНаемныхРаботников(
		Организация, ИПИспользуетТрудНаемныхРаботников, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета);
...
Процедура ОтключитьВнешнийМодульДокументооборотаСФНС() Экспорт
	...
	Если ОбменДаннымиПовтИсп.АвтономнаяРаботаПоддерживается() И ОбщегоНазначения.ЭтоАвтономноеРабочееМесто() Тогда
		ПланОбменаАвтономнойРаботы = ОбменДаннымиПовтИсп.ПланОбменаАвтономнойРаботы();
		Если Метаданные.ПланыОбмена[ПланОбменаАвтономнойРаботы].Состав.Содержит(
...
Процедура ПроверитьКонтрольныеСоотношенияДлительнаяОперация(ПараметрыПроцедуры, АдресРезультата) Экспорт
	...
	ОбъектОтчета = РегламентированнаяОтчетностьВызовСервера.ОбъектОтчета(ПараметрыПроцедуры.ИмяФормы);
	...
	Результат = ОбъектОтчета.ПроверитьКонтрольныеСоотношенияДлительнаяОперация(ПараметрыПроцедуры);
...
Функция ПолучитьДокументМДКС(ТекущийДокумент, ИсточникОтчета, ОтчетныйПериод = Неопределено, НарастающийИтог = Ложь) Экспорт 
	...
	Если ТекущийДокумент.ИсточникОтчета = "РегламентированныйОтчетРасчетПоСтраховымВзносам"
		И ИсточникОтчета = "РегламентированныйОтчет6НДФЛ" Тогда
		Если НЕ Выборка.Количество() = 1 Тогда
			// КС РСВ 2.2 не должно срабатывать для организаций с обособленными
			// подразделениями не выделенными на отдельный баланс
			Возврат Неопределено;
		КонецЕсли;
	КонецЕсли;
...
Функция ВозможноВосстановитьДанныеРеглОтчетаСозданногоВОбычномПриложении(ОбъектРегОтчет, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СокрЛП(ОбъектРегОтчет.НаименованиеОтчета) = "Доходы, выплаченные иностранным организациям" Тогда
		...
		Если СокрЛП(ОбъектРегОтчет.ВыбраннаяФорма) = "ФормаОтчета2020Кв1"
		 ИЛИ СокрЛП(ОбъектРегОтчет.ВыбраннаяФорма) = "ФормаОтчета2016Кв1" Тогда
...
//
// Параметры:
//  Организация - СправочникСсылка.Организации - организация, дату регистрации которой требуется вернуть.
//
// Возвращаемое значение:
//  Дата - дата регистрации организации (пустое значение типа "Дата", если дату регистрации определить не удалось).
//
Функция ДатаРегистрацииОрганизации(Организация) Экспорт
	
	Сведения = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Организация, , "ДатаРегистрации");
	
	Если ЗначениеЗаполнено(Сведения) И Сведения.Свойство("ДатаРегистрации")
		И ТипЗнч(Сведения["ДатаРегистрации"]) = Тип("Дата") Тогда
		Возврат Сведения["ДатаРегистрации"];
	Иначе
...
// Возвращает общую часть гиперссылки на монитор изменений законодательства
//
// Параметры:
...
//   Строка
//
Функция ОбщаяЧастьСсылкиНаИзмененияЗаконодательства(ИсточникОтчета) Экспорт
	
	Перем УИДКонфигурации;
	
	Запрос = Новый Запрос;
	Запрос.Параметры.Вставить("ИсточникОтчета", ИсточникОтчета);
	Запрос.Текст =
		"ВЫБРАТЬ
		|	РегламентированныеОтчеты.УИДОтчета КАК УИДОтчета
		|ИЗ
		|	Справочник.РегламентированныеОтчеты КАК РегламентированныеОтчеты
		|ГДЕ
		|	РегламентированныеОтчеты.ИсточникОтчета = &ИсточникОтчета";
	...
	Если Выборка.Следующий() Тогда
		...
		ОбщаяЧастьСсылкиНаИзмененияЗаконодательства = СтрШаблон(
			"https://v8.1c.ru/lawmonitor/?reg-report-form=%1&only-report=Y&user-configuration=%2",
			Выборка.УИДОтчета, УИДКонфигурации);
	Иначе
		ОбщаяЧастьСсылкиНаИзмененияЗаконодательства = "";
	КонецЕсли;
	
	Возврат ОбщаяЧастьСсылкиНаИзмененияЗаконодательства;
	
КонецФункции

Функция ПредставлениеСсылкиИзмененияЗаконодательства() Экспорт
	
	Возврат НСтр("ru = 'Изменения законодательства'");
	
КонецФункции

Функция АдресВXML(КонтактнаяИнформация, ВидАдреса) Экспорт
...
// Возращает код тарифа или размер тарифа страховых взносов в процентах по коду категории и отчетному году.
//
// Параметры:
...
//
// Возвращаемое значение:
//  Строка, Число, Неопределено - код тарифа("Строка"), размер тарифа ("Число"),"Неопределено" - в случаях,
//                                если: соответствие коду категории не найдено, ошибка, функционал не определен.
//
Функция КодИлиРазмерТарифаПоКодуКатегории(КодКатегории, ОтчетныйГод, ВернутьРазмерТарифа = Ложь) Экспорт
	
	КодИлиРазмерТарифа = Неопределено;
	
	Попытка
		
		РегламентированнаяОтчетностьПереопределяемый.ПолучитьКодИлиРазмерТарифаПоКодуКатегории(
			КодКатегории, ОтчетныйГод, КодИлиРазмерТарифа, ВернутьРазмерТарифа);
		
	Исключение
		
		ЗаписьЖурналаРегистрации(
			?(ВернутьРазмерТарифа,
				НСтр("ru = 'Получение размера тарифа СВ в процентах по коду категории'"),
				НСтр("ru = 'Получение кода тарифа СВ по коду категории'")),
			УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		
	КонецПопытки;
	
	Возврат КодИлиРазмерТарифа;
	
КонецФункции

// Возращает размер дополнительного тарифа страховых взносов в процентах по его коду и отчетному году.
//
// Параметры:
//  КодТарифа - Строка - код из приложения № 5 (с 21-го по 27-й) - Приказ ФНС России от 10.10.2016 N ММВ-7-11/551@
//                       "Об утверждении формы расчета по страховым взносам, порядка его заполнения,
//                       а также формата представления расчета по страховым взносам в электронной форме".
//  ОтчетныйГод - Число - четырехзначное число, соответствующее отчетному году.
//
// Возвращаемое значение:
//  Число, Неопределено - размер тарифа ("Число"),"Неопределено" - в случае, если соответствие коду тарифа не найдено.
//
Функция РазмерДополнительногоТарифаПоКоду(КодТарифа, ОтчетныйГод) Экспорт
	
	Если ОтчетныйГод < 2017 Тогда
		Возврат 0;
	КонецЕсли;
	
	СоответствиеЗначенияТарифаИКода = Новый Соответствие;
	СоответствиеЗначенияТарифаИКода.Вставить("21", 9.00);
	СоответствиеЗначенияТарифаИКода.Вставить("22", 6.00);
	СоответствиеЗначенияТарифаИКода.Вставить("23", 8.00);
	СоответствиеЗначенияТарифаИКода.Вставить("24", 7.00);
	СоответствиеЗначенияТарифаИКода.Вставить("25", 6.00);
	СоответствиеЗначенияТарифаИКода.Вставить("26", 4.00);
	СоответствиеЗначенияТарифаИКода.Вставить("27", 2.00);
	
	Возврат СоответствиеЗначенияТарифаИКода[КодТарифа];
	
КонецФункции

Процедура УдалитьСигнатуруBOM(ФайлВыгрузки) Экспорт
	
	Если ТипЗнч(ФайлВыгрузки) <> Тип("ДвоичныеДанные") Тогда
		Возврат;
	КонецЕсли;
	
	ТекстВыгрузки64 = Base64Строка(ФайлВыгрузки);
	Если Лев(ТекстВыгрузки64, 4) = "77u/" Тогда
		ТекстВыгрузки64 = Сред(ТекстВыгрузки64, 5);
		ФайлВыгрузки = Base64Значение(ТекстВыгрузки64);
	КонецЕсли;
	
КонецПроцедуры

Функция ПризнакиВключения(РазделыОтчета)
	
	Признаки = Новый ДеревоЗначений;
	Признаки.Колонки.Добавить("Идентификатор", Новый ОписаниеТипов("Строка"));
	Признаки.Колонки.Добавить("Название", Новый ОписаниеТипов("Строка"));
	Признаки.Колонки.Добавить("ВключенВОтчет", Новый ОписаниеТипов("Булево"));
	
	ДобавитьПризнакиВключенияРазделов(РазделыОтчета, Признаки);
	
	Возврат Признаки;
	
КонецФункции

Процедура ДобавитьПризнакиВключенияРазделов(РазделыОтчета, Признаки)
	
	Для Каждого ОписаниеРаздела Из РазделыОтчета.Строки Цикл
		СтрокаПризнака = Признаки.Строки.Добавить();
		СтрокаПризнака.Идентификатор = ОписаниеРаздела.ИмяСтраницы;
		СтрокаПризнака.Название = ОписаниеРаздела.Представление;
		СтрокаПризнака.ВключенВОтчет = (ОписаниеРаздела.ПоказатьСтраницу = 1);
		
		Если ОписаниеРаздела.Строки.Количество() <> 0 Тогда
			ДобавитьПризнакиВключенияРазделов(ОписаниеРаздела, СтрокаПризнака);
		КонецЕсли;
...
Процедура ИзменитьПризнакиВключения(РазделыОтчета, ПризнакиВключения)
	
	Для Каждого СтрокаПризнака Из ПризнакиВключения.Строки Цикл
		ОписаниеРаздела = РазделыОтчета.Строки.Найти(СтрокаПризнака.Идентификатор, "ИмяСтраницы");
		Если ОписаниеРаздела <> Неопределено Тогда
			ОписаниеРаздела.ПоказатьСтраницу = ?(СтрокаПризнака.ВключенВОтчет, 1, 0);
			
			Если СтрокаПризнака.Строки.Количество() <> 0 Тогда
				ИзменитьПризнакиВключения(ОписаниеРаздела, СтрокаПризнака)
			КонецЕсли;
...
#Область ПолучениеАктуальногоФорматаИзСервисаРосстата

Функция ПолучитьТекущуюТаблицуФорматов() Экспорт 
	Попытка
		ТекущиеНастройки = ХранилищеСистемныхНастроек.Загрузить("РегистрСведений.ШаблоныЭВФОтчетовСтатистики", "ПоследниеРезультаты");
		
		Если ТипЗнч(ТекущиеНастройки) = Тип("Структура") 
			И ТекущиеНастройки.Свойство("Таблица")
			И ТипЗнч(ТекущиеНастройки.Таблица) = Тип("ТаблицаЗначений") 
			И ТекущиеНастройки.Свойство("ДатаВремя")
			И ТипЗнч(ТекущиеНастройки.ДатаВремя) = Тип("Дата") Тогда
			
			Дельта = ТекущаяДатаСеанса() - ТекущиеНастройки.ДатаВремя;
			
			Если (Дельта < 1800) И (Дельта > 0) Тогда
				Возврат ТекущиеНастройки.Таблица;
			КонецЕсли;
		КонецЕсли;
		...
		Таблица = ШаблоныЭВФОтчетовСтатистики.СписокШаблоновСервисаВебСбора(СвойстваМодуля, Истина);
		Возврат Таблица;
	Исключение
		Возврат Неопределено;
	КонецПопытки;
...
Процедура ОбновитьШаблоныЧерезВебСервисНаСервере(Контекст, ИмяМакета) Экспорт
	Попытка
		Если СтрНачинаетсяС(Контекст.ИмяФормы, "Внешний") Тогда
			Возврат;
		КонецЕсли;
		
		ПараметрыЗапуска = ДлительныеОперации.ПараметрыВыполненияВФоне(Контекст.УникальныйИдентификатор);
		ПараметрыЗапуска.НаименованиеФоновогоЗадания = НСтр("ru = 'Получение актуальной версии макета через веб-сервис Росстата'");
		ПараметрыЗапуска.ДополнительныйРезультат = Ложь;
		ПараметрыЗапуска.ОжидатьЗавершение = 0;
		
		ПараметрыВыполнения = Новый Структура("АттрибутыВыгрузки", РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов(Контекст.ИмяФормы, ИмяМакета));
		Результат = ДлительныеОперации.ВыполнитьВФоне("РегламентированнаяОтчетность.ОбновитьШаблоныЧерезВебСервисНаСервереВФоне", ПараметрыВыполнения, ПараметрыЗапуска);
	Исключение
	КонецПопытки;
КонецПроцедуры
...
Процедура ОбновитьШаблоныЧерезВебСервисНаСервереВФоне(ПараметрыКоманды, АдресРезультата = Неопределено) Экспорт
	Попытка
		ШаблоныЭВФОтчетовСтатистики = ОбщегоНазначения.ОбщийМодуль("РегистрыСведений.ШаблоныЭВФОтчетовСтатистики");
		АттрибутыВыгрузки = ПараметрыКоманды.АттрибутыВыгрузки;
		ОКУД = "";
		КодШаблона = "";
		ВерсияШаблона = "";
		АттрибутыВыгрузки.Свойство("OKUD", ОКУД);
		АттрибутыВыгрузки.Свойство("code", КодШаблона);
		АттрибутыВыгрузки.Свойство("version", ВерсияШаблона);
		Если Не ЗначениеЗаполнено(КодШаблона) Или Не ЗначениеЗаполнено(ОКУД) Или Не ЗначениеЗаполнено(ВерсияШаблона) Тогда
			Возврат;
		КонецЕсли;
		
		КодШаблонаБезКодаФормы = Лев(КодШаблона, СтрДлина(КодШаблона) - 6) + Прав(КодШаблона, 3);
		
		ТаблицаФорматов = ПолучитьТекущуюТаблицуФорматов();
		ОтобранныеСтроки = ТаблицаФорматов.НайтиСтроки(Новый Структура("ОКУД", ОКУД));
		
		КодыШаблонов = Новый Массив;
		ТФК = ТаблицаФорматов.СкопироватьКолонки();
		Для Каждого СтрокаТаблицыФорматов Из ОтобранныеСтроки Цикл
			ДлинаКодаОтобранногоШаблона = СтрДлина(СтрокаТаблицыФорматов.Код);
			Если ДлинаКодаОтобранногоШаблона = СтрДлина(КодШаблона) И КодШаблонаБезКодаФормы = 
				Лев(СтрокаТаблицыФорматов.Код, ДлинаКодаОтобранногоШаблона - 6) + Прав(СтрокаТаблицыФорматов.Код, 3)
				И ДатаВерсии(СтрокаТаблицыФорматов.Версия) > ДатаВерсии(ВерсияШаблона) Тогда
				
				КодыШаблонов.Добавить(СтрокаТаблицыФорматов.Код);
				ЗаполнитьЗначенияСвойств(ТФК.Добавить(), СтрокаТаблицыФорматов);
			КонецЕсли;
		КонецЦикла;
		...
		Запрос.Текст = "ВЫБРАТЬ
			...
			|	И ШаблоныЭВФОтчетовСтатистики.КодШаблона В (&КодыШаблонов)
			|УПОРЯДОЧИТЬ ПО
			|	РазностьДат ВОЗР";
		Запрос.УстановитьПараметр("ОКУД", ОКУД);
		Запрос.УстановитьПараметр("КодыШаблонов", КодыШаблонов);
		Запрос.УстановитьПараметр("ТекущаяДата", ТекущаяДатаСеанса());
		
		Таблица = Запрос.Выполнить().Выгрузить();
		Если Таблица.Количество() > 0 И Таблица[0].РазностьДат < 3600 И Таблица[0].РазностьДат > -3600 Тогда
			Возврат;
		КонецЕсли;
		
		АдресВременногоХранилища = ПоместитьВоВременноеХранилище(Неопределено);
		ШаблоныЭВФОтчетовСтатистики.ЗагрузитьШаблоныЧерезСервисВебСбора(Новый Структура("СвойстваШаблонов, ТихийРежим", ТФК, Истина), АдресВременногоХранилища, "");
		ШаблоныЭВФОтчетовСтатистики.ЗагрузитьШаблоны(АдресВременногоХранилища, 0, Истина);
	Исключение
	КонецПопытки;
КонецПроцедуры
...
Процедура ОбновитьШаблоныСпискомЧерезВебСервисНаСервереВФоне(ПараметрыКоманды, АдресРезультата = Неопределено) Экспорт
	...
	Попытка
		...
		СписокШаблонов = ПараметрыКоманды.СписокШаблонов;
		Если НЕ ЗначениеЗаполнено(СписокШаблонов)Тогда
			Возврат;
		КонецЕсли;
		...
		ТаблицаОтобранных = ТаблицаФорматов.СкопироватьКолонки();
		Для Каждого СтрокаТаблицыФорматов Из ТаблицаФорматов Цикл
			Если НЕ СтрНачинаетсяС(СокрЛ(СтрокаТаблицыФорматов.ИмяФормы), "(")
				  И СписокШаблонов.НайтиПоЗначению(СтрокаТаблицыФорматов.ОКУД) <> Неопределено Тогда
				ЗаполнитьЗначенияСвойств(ТаблицаОтобранных.Добавить(), СтрокаТаблицыФорматов);
			КонецЕсли;
		КонецЦикла;
		
		ТаблицаОтобранных.Сортировать("ОКУД Возр, Код Убыв, ДатаОбновления Убыв");
		
		КоличествоСтрокВТаблице = ТаблицаОтобранных.Количество();
		Для НомСтроки = 1 По КоличествоСтрокВТаблице Цикл
			Инд = КоличествоСтрокВТаблице - НомСтроки;
			СтрокаТаблицы = ТаблицаОтобранных[Инд];
			Если Инд > 0 Тогда
				Если (СтрокаТаблицы.Код  = ТаблицаОтобранных[Инд - 1].Код
				    И СтрокаТаблицы.ОКУД = ТаблицаОтобранных[Инд - 1].ОКУД)
					ИЛИ НЕ СтрНачинаетсяС(СтрокаТаблицы.Код,
						?(Лев(СтрокаТаблицы.ОКУД, 1) = "0", Сред(СтрокаТаблицы.ОКУД, 2), СтрокаТаблицы.ОКУД)) Тогда
					ТаблицаОтобранных.Удалить(СтрокаТаблицы);
				КонецЕсли;
			КонецЕсли;
		КонецЦикла;
		
		Если НЕ ЗначениеЗаполнено(ТаблицаОтобранных)Тогда
			Возврат;
		КонецЕсли;
		
		АдресВременногоХранилища = ПоместитьВоВременноеХранилище(Неопределено);
		ШаблоныЭВФОтчетовСтатистики.ЗагрузитьШаблоныЧерезСервисВебСбора(
			Новый Структура("СвойстваШаблонов, ТихийРежим", ТаблицаОтобранных, Истина), АдресВременногоХранилища, "");
		ШаблоныЭВФОтчетовСтатистики.ЗагрузитьШаблоны(АдресВременногоХранилища, 0, Истина);
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Получение списка XML-шаблонов через веб-сервис Росстата'"),
...
Процедура ИзменитьВерсиюФорматаСПроверкойСовместимостиШаблонов(Форма, ИмяМакетаАттрибутов, ИмяМакетаШаблона, ПараметрыВыгрузки) Экспорт
	Попытка
		Если СтрНачинаетсяС(Форма.ИмяФормы, "Внешний") Тогда
			Возврат;
		КонецЕсли;
		
		ДопАтрибуты = РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов(Форма.ИмяФормы, ИмяМакетаАттрибутов);
		...
		ИмяПоследнейФормыОчета = РегламентированнаяОтчетностьВызовСервера.ИмяФормыРеглОтчетаДействующейВОтчетномПериоде(
			РегламентированнаяОтчетностьВызовСервера.ИсточникОтчета(Форма.ИмяФормы), ДобавитьМесяц(ТекущаяДатаСеанса(), 24));
		
		ЭтоПоследняяРеализацияОтчета = СтрЗаканчиваетсяНа(Форма.ИмяФормы, ИмяПоследнейФормыОчета);
		...
		Запрос.Текст = "ВЫБРАТЬ
			...
			|	ШаблоныЭВФОтчетовСтатистики.Шифр КАК Шифр,
		...
		ОбъектОтчетаСтатистики = РегламентированнаяОтчетностьВызовСервера.ОбъектОтчета(Форма.ИмяФормы);
		...
		Пока Выборка.Следующий() Цикл
			...
			Если НЕ УниверсальныйОтчетСтатистики.СравнитьСтруктурыШаблонов(Выборка.Шаблон,
				ОбъектОтчетаСтатистики.ПолучитьМакет(ИмяМакетаШаблона)) Тогда
				Продолжить;
			КонецЕсли;
			
			Если НЕ ПроверкаФорматаПоПериодуПрименения(ПараметрыВыгрузки, Выборка.Версия) Тогда
				Продолжить;
			КонецЕсли;
			
			НовыйКодФормы = Формат(Число("0" + КодФормыШаблонаВыб), "ЧН=; ЧГ=");
		...
		ПараметрыВыгрузки.ВерсияШаблона = Выборка.Версия;
		ПараметрыВыгрузки.Вставить("ПроизведенаЗаменаФормата", Истина);
		ПараметрыВыгрузки.Вставить("ПроизведенаЗаменаФормата_ОКУД", ДопАтрибуты.OKUD);
		
		Если ЭтоПоследняяРеализацияОтчета Тогда
			ПараметрыВыгрузки.Вставить("КодШаблона", Выборка.КодШаблона);
			ПараметрыВыгрузки.Вставить("КодФормы",   НовыйКодФормы);
			ПараметрыВыгрузки.Вставить("ШифрФормы",  Выборка.Шифр);
			ИмяФайлаВыгрузки = "";
			Если ПараметрыВыгрузки.Свойство("ИмяФайла", ИмяФайлаВыгрузки) И ЗначениеЗаполнено(ИмяФайлаВыгрузки) Тогда
				ПараметрыВыгрузки["ИмяФайла"] = ИмяФайлаВыгрузкиСНовымКодомФормы(ИмяФайлаВыгрузки, НовыйКодФормы);
			КонецЕсли;
			ПараметрыВыгрузки.Вставить("ПроизведенаЗаменаФормата_КодШаблона", Выборка.КодШаблона);
			ПараметрыВыгрузки.Вставить("ПроизведенаЗаменаФормата_КодФормы", НовыйКодФормы);
			ПараметрыВыгрузки.Вставить("ПроизведенаЗаменаФормата_ШифрФормы", Выборка.Шифр);
		КонецЕсли;
		
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Версия формата выгрузки была изменена на '") + Выборка.Версия);
		Комментарий = НСтр("ru='Для отчета '") + Форма.ИмяФормы + НСтр("ru=' версия формата выгрузки была изменена с '") + ДопАтрибуты.version + НСтр("ru=' на '") + Выборка.Версия;
		ЗаписьЖурналаРегистрации("ЗаменаФорматаРосстатаПоИнформацииСервиса", УровеньЖурналаРегистрации.Информация, , , Комментарий);
	Исключение
	КонецПопытки;
КонецПроцедуры
...
Функция ПроверкаФорматаПоПериодуПрименения(ПараметрыДляПроверки, ВерсияШаблона) Экспорт
	...
	СохраненныйДокумент = Неопределено;
	
	Если ПараметрыДляПроверки.Свойство("Ссылка",   СохраненныйДокумент)
	 ИЛИ ПараметрыДляПроверки.Свойство("Документ", СохраненныйДокумент) Тогда
		Если ТипЗнч(СохраненныйДокумент) <> Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
	...
	ИсточникОтчета = ВРег(СохраненныйДокумент.ИсточникОтчета);
	ВыбраннаяФорма = ВРег(СохраненныйДокумент.ВыбраннаяФорма);
	
	ДатаКонцаПериодаОтчета = КонецДня(СохраненныйДокумент.ДатаОкончания);
	
	СведенияОФормате = Новый Структура("Код,ДатаПриказа,НомерПриказа,ИмяОбъекта", ВерсияШаблона, '00010101', "", "");
	...
	СведенияПоБлокировке = ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.ПроверкаФорматаПоПериодуПримененияСервер(
			ПараметрыДляПроверки, ДатаКонцаПериодаОтчета, ВыбраннаяФорма, ИсточникОтчета, СведенияОФормате);
	
	Возврат СведенияПоБлокировке.РезультатПроверки;
	
КонецФункции

Функция ИмяФайлаВыгрузкиСНовымКодомФормы(ИмяФайлаВыгрузки, НовыйКодФормы)
	
	НовоеИмяФайлаВыгрузки = ИмяФайлаВыгрузки;
	
	ЧастиИмениФайла = СтрРазделить(ИмяФайлаВыгрузки, "_");
	Если ЧастиИмениФайла.ВГраница() > 0 Тогда
		Если СтрДлина(ЧастиИмениФайла[1]) = 3 Тогда
			ЧастиИмениФайла[1] = Прав("000" + НовыйКодФормы, 3);
		Иначе
			ЧастиИмениФайла[1] = НовыйКодФормы;
		КонецЕсли;
		
		НовоеИмяФайлаВыгрузки = СтрСоединить(ЧастиИмениФайла, "_");
	КонецЕсли;
	
	Возврат НовоеИмяФайлаВыгрузки;
...
Процедура УправлениеДоступностьюРеквизитов(Форма, БлокируемыеЭлементы, ТолькоПросмотр) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ПроцессыОбработкиДокументов") Тогда
		...
		Если НЕ Форма.Элементы.Найти("ФормаЗаполнитьДаннымиУведомленияКИК") = Неопределено Тогда
			БлокируемыеЭлементы.Добавить("ФормаЗаполнитьДаннымиУведомленияКИК");
		КонецЕсли;
