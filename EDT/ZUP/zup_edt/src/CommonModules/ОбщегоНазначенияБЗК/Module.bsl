...
Функция ДобавитьОтборУсловногоОформления(ОформлениеКД, Поле, ВидСравнения, Значение = Неопределено) Экспорт
	Если ТипЗнч(ОформлениеКД) = Тип("ЭлементУсловногоОформленияКомпоновкиДанных") Тогда
		ЭлементОтбораКД = ОформлениеКД.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	Иначе
		ЭлементОтбораКД = ОформлениеКД.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	КонецЕсли;
