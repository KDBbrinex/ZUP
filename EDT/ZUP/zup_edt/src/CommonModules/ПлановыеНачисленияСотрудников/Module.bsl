...
Процедура СоздатьВТИзмененияИсточниковВторичныхДанныхПоДатам(МенеджерВременныхТаблиц)
	...
	|	ПлановыеНачисления.ДатаНачалаПредыдущейЗаписи,
...
Функция ВыборкаНачисленийНаДатыИзмененияИсточниковВторичныхДанных(МенеджерВременныхТаблиц)
	...
	|	ИзмененияИсточниковВторичныхДанныхПоДатам.ДатаНачалаВозвратнойЗаписи,
	...
	|	ИзмененияИсточниковВторичныхДанныхПоДатам.НеобходимПерерасчетИзменившихсяНачислений,
