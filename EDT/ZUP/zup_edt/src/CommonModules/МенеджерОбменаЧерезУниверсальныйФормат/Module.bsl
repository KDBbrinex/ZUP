// Конвертация БЗКР 3.1 от 18.09.2020 13:18:45
...
Процедура ПередКонвертацией(КомпонентыОбмена) Экспорт
	...
	Если КомпонентыОбмена.ЭтоОбменЧерезПланОбмена Тогда
		ЗаполнитьЗначенияСвойств(КомпонентыОбмена.ПараметрыКонвертации, КомпонентыОбмена.УзелКорреспондента,"ВариантНастройки,ДанныеДляФормированияПроводокОтправлятьСводно");
	КонецЕсли;
...
//  СтруктураПараметров - Структура - структура, содержащая передаваемые параметры.
...
Процедура ВедомостьНаВыплатуЗарплаты_ПриОтправкеДанных(ДанныеИБ, ДанныеXDTO, КомпонентыОбмена, СтекВыгрузки)
	...
	Если ПередаватьВзысканныеСуммы Тогда
