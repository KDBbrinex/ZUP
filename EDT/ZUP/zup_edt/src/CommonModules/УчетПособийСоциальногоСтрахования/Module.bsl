...
Процедура ПослеЗагрузкиУведомленийОНовыхСообщенияхСЭДО(Организация, Уведомления, ОбработанныеУведомления) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы.ПособияСоциальногоСтрахования") Тогда
		...
		МодульУчетПособийСоциальногоСтрахованияРасширенный.ПослеЗагрузкиУведомленийОНовыхСообщенияхСЭДО(Организация, Уведомления, ОбработанныеУведомления);
	КонецЕсли;
	// АПК:278-вкл
...
Процедура ПослеРасшифровкиСообщенияСЭДО(Организация, Сообщение, Результат) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы.ПособияСоциальногоСтрахования") Тогда
		МодульУчетПособийСоциальногоСтрахованияРасширенный = ОбщегоНазначения.ОбщийМодуль("УчетПособийСоциальногоСтрахованияРасширенный");
		МодульУчетПособийСоциальногоСтрахованияРасширенный.ПослеРасшифровкиСообщенияСЭДО(Организация, Сообщение, Результат);
	КонецЕсли;
	// АПК:278-вкл
...
Процедура ПриЗаписиДокументаБольничныйЛист(БольничныйОбъект, Отказ) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыРасширеннаяПодсистемы.ПособияСоциальногоСтрахования") Тогда
		МодульУчетПособийСоциальногоСтрахованияРасширенный = ОбщегоНазначения.ОбщийМодуль("УчетПособийСоциальногоСтрахованияРасширенный");
		МодульУчетПособийСоциальногоСтрахованияРасширенный.ПриЗаписиДокументаБольничныйЛист(БольничныйОбъект, Отказ);
	КонецЕсли;
	// АПК:278-вкл
