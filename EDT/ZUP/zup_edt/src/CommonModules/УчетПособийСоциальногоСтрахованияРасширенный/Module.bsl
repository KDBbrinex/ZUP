...
Процедура ОбновитьФорму(Форма, ПараметрыОбновленияФормы = Неопределено) Экспорт
	...
	СЭДОФСС.ОбновитьНапоминаниеОбОтключенииПодписокНаЭЛН(Форма, ПараметрыОбновленияФормы, ПараметрыПособий);
...
Процедура ПриРегистрацииОбработчиковОбновления(Обработчики) Экспорт
	Возврат; // См. ЗарегистрироватьОбработчикиОбновления.
КонецПроцедуры
...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	СЭДОФСС.ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений);
...
Процедура ПослеРасчетаНачисленийПоДаннымНабора(ТаблицаНабора, Организация, ПериодРегистрации, СтрокиПоИдентификатору, СвойстваНачислений, НастройкиПособий) Экспорт
	...
	Для Каждого Элемент Из СтрокиПоИдентификатору Цикл
		...
		Если КатегорииПособийЗаСчетФСС.Найти(СвойстваТекущегоНачисления.КатегорияНачисленияИлиНеоплаченногоВремени) = Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ПослеЗагрузкиУведомленийОНовыхСообщенияхСЭДО(Организация, Уведомления, ОбработанныеУведомления) Экспорт
	...
	СЭДОФСС.ПослеЗагрузкиУведомленийОНовыхСообщенияхСЭДО(Организация, Уведомления, ОбработанныеУведомления);
...
Процедура ПослеРасшифровкиСообщенияСЭДО(Организация, Сообщение, Результат) Экспорт
	...
	СЭДОФСС.ПослеРасшифровкиСообщенияСЭДО(Организация, Сообщение, Результат);
...
Функция ПериодыДнейБолезниУходаЗаДетьми(ФизическоеЛицо, ГоловнаяОрганизация, Начало, Окончание, ПоНаименованиямПериодов = Ложь)
	...
	Запрос.Текст =
		...
		|	&ФизическоеЛицо,
		|	&ГоловнаяОрганизация,
		|	&НаименованиеПериодаОтпускаПоУходу,
		|	99,
		|	ДатыДней.Дата
		|ИЗ
