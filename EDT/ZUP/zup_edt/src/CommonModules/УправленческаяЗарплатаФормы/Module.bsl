...
Процедура КадровыйПереводЗаполнитьСоставДействующихНачисленийСотрудника(ИсключаемыйРегистратор, ТаблицаСотрудников, Форма, ДатаНачала, ДатаОкончания) Экспорт
	...
	ОписаниеТаблицыВидовРасчета = УправленческаяЗарплатаКлиентСервер.КадровыйПереводОписаниеТаблицыУправленческихНачислений();
	ТаблицаСотрудников.ЗаполнитьЗначения(ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.Организации.УправленческаяОрганизация"), "Организация");
...
Процедура ДокументДанныеДляРасчетаЗарплатыПриНастройкеЭлементовФормы(Форма, ЭлементОрганизация) Экспорт
	Если ЭлементОрганизация.Вид <> ВидПоляФормы.ПолеВвода Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПередЗаполнениемЗначенийПоказателейНачислений(ОписаниеТаблицы, ТаблицаРасчета) Экспорт
	
	Если ОписаниеТаблицы.ИмяТаблицы <> УправленческаяЗарплатаКлиентСервер.ОписаниеТаблицыУправленческихНачислений().ИмяТаблицы Тогда
		Возврат;
	КонецЕсли;
	
	УправленческаяОрганизация = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.Организации.УправленческаяОрганизация");
	ТаблицаРасчета.ЗаполнитьЗначения(УправленческаяОрганизация, "Организация");
