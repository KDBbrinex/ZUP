...
Процедура ПриИзмененииДоначисленияДоУправленческогоУчета(Форма)
	...
	// Пересчитываем ФОТ
	ЗарплатаКадрыРасширенныйКлиент.ПодключитьОбработчикОжиданияАвтоматическогоРасчета(Форма, Истина, "РассчитатьФОТНаКлиенте", "РассчитатьУправленческие");
...
Процедура ВыполнитьРасчетФОТ(Форма)
	...
	ЗарплатаКадрыРасширенныйКлиент.ПодключитьОбработчикОжиданияАвтоматическогоРасчета(Форма, Истина, "РассчитатьФОТНаКлиенте");
...
Процедура ПриИзмененииСотрудникаСтрокиНачисленияЗарплаты(Элемент, Форма) Экспорт
	
	ОписаниеТаблицы = УправленческаяЗарплатаКлиентСервер.ОписаниеТаблицыУправленческихНачислений();
	Форма.ПриИзмененииСотрудника(Элемент, ОписаниеТаблицы);
