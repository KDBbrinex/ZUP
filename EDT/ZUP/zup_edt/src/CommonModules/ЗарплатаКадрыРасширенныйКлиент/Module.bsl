...
Процедура ПодключитьОбработчикОжиданияАвтоматическогоРасчета(Форма, РегистрацияНачисленийДоступна, ИмяОбработчикаОжидания, ИмяКнопкиРассчитать = "Рассчитать", ИмяОбработчикаОжиданияОчисткиДокумента = "") Экспорт
