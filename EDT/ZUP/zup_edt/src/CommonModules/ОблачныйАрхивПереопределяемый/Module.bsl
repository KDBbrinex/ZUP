...
// Метод вызывается из модуля управляемого приложения,
...
// Метод переопределяет время следующего обновления в регистре сведений "ВсеОбновленияОблачногоАрхива".
//
// Параметры:
...
// Метод вызывается при первом запуске библиотеки БИП.
...
// Метод вызывается при обновлении библиотеки БИП на любую новую версию.
// Обработчики из библиотеки для общих данных и для области данных уже были вызваны.
// Метод - для всех областей данных.
