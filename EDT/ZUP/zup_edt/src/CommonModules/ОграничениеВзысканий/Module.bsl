...
Функция РезультатОграниченияВзысканийДокумента(Начисления, Удержания, НДФЛ) Экспорт 
	...
	РезультатВзысканий = РезультатОграниченияВзысканий(Запрос.МенеджерВременныхТаблиц);
