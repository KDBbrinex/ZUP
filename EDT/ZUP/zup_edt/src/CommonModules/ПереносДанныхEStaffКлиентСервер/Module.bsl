...
Функция ОписаниеВакансии()
	...
	ПереносДанныхEStaffКлиентСерверПереопределяемый.ПриОпределенииИменСвойствВакансии(ОписаниеОбъекта.ИменаСвойств);
...
Функция ОписаниеКандидата()
	...
	ПереносДанныхEStaffКлиентСерверПереопределяемый.ПриОпределенииИменСвойствКандидата(ОписаниеОбъекта.ИменаСвойств);

	Возврат ОписаниеОбъекта;
	
КонецФункции

Функция ОписаниеСтраныМира()
