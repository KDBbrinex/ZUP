...
Процедура УстановитьЗначениеСвязаннойПозицииРезерва(Форма) Экспорт
	...
	Если СписокПозицийШР.Количество() = 0 Тогда
		Форма.КадровыйРезервСвязаннаяПозицияРезерва = ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.КадровыйРезерв.ПустаяСсылка");
	Иначе
...
Процедура СоздатьРеквизитыКадровогоРезерваВФормеШтатногоРасписания(Форма)
	...
	Если МассивИменРеквизитовФормы.Найти("КадровыйРезервСвязаннаяПозицияРезерва") <> Неопределено Тогда
		МассивУдаляемыхРеквизитов.Добавить("КадровыйРезервСвязаннаяПозицияРезерва");
	КонецЕсли;
	Если МассивИменРеквизитовФормы.Найти("КадровыйРезервИнфоНадписьГруппРезерва") <> Неопределено Тогда
		МассивУдаляемыхРеквизитов.Добавить("КадровыйРезервИнфоНадписьГруппРезерва");
	КонецЕсли;
	Если МассивИменРеквизитовФормы.Найти("КадровыйРезервПозицииШР") <> Неопределено Тогда
		МассивУдаляемыхРеквизитов.Добавить("КадровыйРезервПозицииШР");
	КонецЕсли;
	ЗарплатаКадры.ИзменитьРеквизитыФормы(Форма, Новый Массив, МассивИменРеквизитовФормы, МассивУдаляемыхРеквизитов);
