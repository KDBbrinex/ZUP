...
Процедура ПрограммыСтрахованияРедактировать(Форма, ТекущиеДанные, ИмяТаблицы, ИмяПоля, ОповещениеЗавершения = Неопределено) Экспорт
	...
	Иначе
		ДатаПрикрепления = Форма.Объект.ДатаНачалаСтрахования;
	КонецЕсли;
	Если ТекущиеДанные.Свойство("ДатаОткрепления") Тогда
		ДатаОткрепления = ТекущиеДанные.ДатаОткрепления;
	Иначе
		ДатаОткрепления = Форма.Объект.ДатаОкончанияСтрахования;
	КонецЕсли;
	Для Каждого СтрокаТаблицы Из НайденныеСтроки Цикл
		...
		Если ДатаПрикрепления < СтрокаТаблицы.ДатаНачала И СтрокаТаблицы.ДатаНачала < Форма.Объект.ДатаОкончанияСтрахования Тогда
			ДатаПрикрепления = СтрокаТаблицы.ДатаНачала;
		КонецЕсли;
		Если ДатаОткрепления > СтрокаТаблицы.ДатаОкончания И СтрокаТаблицы.ДатаОкончания > Форма.Объект.ДатаНачалаСтрахования Тогда
			ДатаОткрепления = СтрокаТаблицы.ДатаОкончания;
		КонецЕсли;
	КонецЦикла;
...
Процедура РасширенияПрограммСтрахованияРедактировать(Форма, ТекущиеДанные, ИмяТаблицы, ИмяПоля, ОповещениеЗавершения = Неопределено) Экспорт
