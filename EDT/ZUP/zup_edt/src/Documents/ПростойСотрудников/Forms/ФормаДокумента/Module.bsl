...
Процедура ПорядокВыплатыПриИзмененииНаСервере()
	...
	Если ЭтоМежрасчетнаяВыплата(Объект.ПорядокВыплаты)
		Или ОбязательныйРасчетНДФЛ Тогда
...
Процедура Подключаемый_ОбновитьКоманды()
	...
	Источник.Вставить("ПериодРегистрации",      Объект.ПериодРегистрации);
	Источник.Вставить("НомерСтраницыВариантов", НомерСтраницыВариантов);
...
Процедура ПриПолученииДанныхНаСервере()
	...
	ОбязательныйРасчетНДФЛ = УчетНДФЛРасширенный.ДоходыВУчетеНДФЛРегистрируютсяПоДатеВыплаты(Объект.Начисление);
...
Процедура УстановитьОтметкуНезаполненногоПланируемойДатыВыплаты()
	...
	АвтоОтметкаНезаполненного = ДатаВыплатыОбязательнаКЗаполнению(Объект.ПорядокВыплаты, ПроверяемыеНачисления);
