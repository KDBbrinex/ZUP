...
//     * Ссылка - ДокументСсылка.СведенияОЗастрахованныхЛицахСЗВ_М, Неопределено - ссылка на созданный документ.
...
Функция НовыйДокумент(Организация, ОтчетныйПериод, Проводить = Истина) Экспорт 
	...
	ДокументОбъект = Документы.СведенияОЗастрахованныхЛицахСЗВ_М.СоздатьДокумент();
	ДокументСсылка = Документы.СведенияОЗастрахованныхЛицахСЗВ_М.ПолучитьСсылку();
	ДокументОбъект.УстановитьСсылкуНового(ДокументСсылка);
	
	ДокументОбъект.Дата = ТекущаяДатаСеанса();
	ДокументОбъект.Организация = Организация;
	ДокументОбъект.ОтчетныйПериод = НачалоМесяца(ОтчетныйПериод);
	ДокументОбъект.ОкончаниеОтчетногоПериода = КонецМесяца(ОтчетныйПериод);
	ДокументОбъект.ТипФормы = Перечисления.ТипыСведенийСЗВ_М.Исходная;
	...
	ДанныеДляЗаполнения = ДанныеДляЗаполнения(ДокументОбъект);	
...
Функция СформироватьПечатнуюФормуСЗВ_М(МассивОбъектов, ОбъектыПечати)
	...
	Возврат ПерсонифицированныйУчет.ПечатнаяФормаСЗВМПоДаннымДокументов(ОбъектыПечати, ВыборкаПоШапкеДокумента, ВыборкаПоРаботникиОрганизации);
