...
Функция ОписаниеСоставаОбъекта() Экспорт
	...
	МетаданныеДокумента = Метаданные.Документы.ФактПоказателяЭффективностиСотрудников;
...
Функция ПолучитьДанныеДляПроведения(Ссылка)Экспорт
	...
	Запрос.Текст = 
		...
		|	ФактПоказателяЭффективностиСотрудниковСотрудники.Ссылка.Горизонт КАК Горизонт,
		|	ФактПоказателяЭффективностиСотрудниковСотрудники.Позиция КАК Позиция,
