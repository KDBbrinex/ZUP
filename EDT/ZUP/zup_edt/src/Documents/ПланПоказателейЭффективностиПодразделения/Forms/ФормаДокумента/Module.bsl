...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_ПланПоказателейЭффективностиПодразделения");
...
Процедура ЗаполнитьТаблицуПоказателей()
	...
	ПлановыеПоказателиПодразделения = ПоказателиПодразделения.Скопировать(Новый Структура("ТребуетсяВводПлана", Истина));
	
	КлючевыеПоказателиЭффективностиФормы.ЗаполнитьСоответствиеПоказателей(ЭтаФорма, ПлановыеПоказателиПодразделения);
