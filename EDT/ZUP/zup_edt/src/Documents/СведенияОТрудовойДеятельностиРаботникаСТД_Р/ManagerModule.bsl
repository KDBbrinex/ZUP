...
Функция ЗапросВТДанныеМероприятий(ИмяВТДанныеМероприятий = "ВТДанныеМероприятий") Экспорт
	...
	Запрос.Текст =
		...
		|	ЕСТЬNULL(МероприятияТрудовойДеятельности.НаименованиеВторогоДокументаОснования, МероприятияТрудовойДеятельностиПрочие.НаименованиеВторогоДокументаОснования) КАК НаименованиеВторогоДокументаОснования,
		|	ЕСТЬNULL(МероприятияТрудовойДеятельности.ДатаВторогоДокументаОснования, МероприятияТрудовойДеятельностиПрочие.ДатаВторогоДокументаОснования) КАК ДатаВторогоДокументаОснования,
		|	ЕСТЬNULL(МероприятияТрудовойДеятельности.СерияВторогоДокументаОснования, МероприятияТрудовойДеятельностиПрочие.СерияВторогоДокументаОснования) КАК СерияВторогоДокументаОснования,
		|	ЕСТЬNULL(МероприятияТрудовойДеятельности.НомерВторогоДокументаОснования, МероприятияТрудовойДеятельностиПрочие.НомерВторогоДокументаОснования) КАК НомерВторогоДокументаОснования,
