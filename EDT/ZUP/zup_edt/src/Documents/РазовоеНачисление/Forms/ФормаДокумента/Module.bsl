...
Процедура УстановитьВидимостьРеквизитовНДФЛ(Форма)
	...
	ВидимостьРеквизитовНДФЛ = УчетНДФЛРасширенный.МежрасчетныйДокументИсчисляетНДФЛ(Форма.Объект.Организация, ОтложитьРасчетНалогаДоРасчетаЗарплатыВКонцеМесяца, Форма.Объект.ПорядокВыплаты, Форма.ОбязательныйРасчетНДФЛ);
...
Процедура УстановитьВидимостьКВыплате(Форма)
	...
	Форма.Элементы.НачисленияКВыплате.Видимость = Форма.Объект.РассчитыватьУдержания 
		Или УчетНДФЛРасширенный.МежрасчетныйДокументИсчисляетНДФЛ(Форма.Объект.Организация, ОтложитьРасчетНалогаДоРасчетаЗарплатыВКонцеМесяца, Форма.Объект.ПорядокВыплаты, Форма.ОбязательныйРасчетНДФЛ);
