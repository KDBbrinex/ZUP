...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ОтпускПоУходуЗаРебенком" Тогда
		ОбновитьДанныеФормы();
	КонецЕсли;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	Оповестить("Запись_РешениеОбОтпускеПоУходуЗаРебенком", ПараметрыЗаписи, Объект.Ссылка);
КонецПроцедуры
...
&НаКлиенте
Процедура ЗаполнитьМероприятия(Команда = Неопределено)
...
Процедура ЗаполнитьМероприятияНаСервере()
	...
	ПараметрыЗаполнения = Документы.РешениеОбОтпускеПоУходуЗаРебенком.ПараметрыЗаполненияМероприятий(Объект);
