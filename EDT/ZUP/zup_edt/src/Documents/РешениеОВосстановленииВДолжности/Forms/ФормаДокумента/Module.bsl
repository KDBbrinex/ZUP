...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ЗначенияДляЗаполнения = Новый Структура("Организация, Ответственный, ДатаСобытия", 
			"Объект.Организация", "Объект.Ответственный", "Объект.ДатаВосстановления");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ВосстановлениеВДолжности" Тогда
		ОбновитьДанныеФормы();
	КонецЕсли;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	Оповестить("Запись_РешениеОВосстановленииВДолжности", ПараметрыЗаписи, Объект.Ссылка);
КонецПроцедуры
...
Процедура ЗаполнитьМероприятияНаСервере()
	...
	ПараметрыЗаполнения = Документы.РешениеОВосстановленииВДолжности.ПараметрыЗаполненияМероприятий(Объект);
...
Функция ПараметрыПолученияСвойствНазначаемогоМероприятия()
	...
	ПараметрыПолучения.ДатаСобытия = Объект.ДатаВосстановления;
