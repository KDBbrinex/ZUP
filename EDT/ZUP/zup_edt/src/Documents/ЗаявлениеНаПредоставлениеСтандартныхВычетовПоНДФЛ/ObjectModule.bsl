...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ДатаЗапрета = Документы.ЗаявлениеНаПредоставлениеСтандартныхВычетовПоНДФЛ.ДатаЗапрета(Дата, Месяц);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Запрос = УчетНДФЛДокументы.КонфликтующиеРегистраторыВычетов(Ссылка, Месяц, Сотрудник, МассивВычетов);
