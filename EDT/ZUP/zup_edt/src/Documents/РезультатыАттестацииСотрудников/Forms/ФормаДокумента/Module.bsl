...
Процедура ПриПолученииДанныхНаСервере()
	...
	ЗарплатаКадрыРасширенный.МногофункциональныеДокументыДобавитьЭлементыФормы(ЭтотОбъект, НСтр("ru='Документом изменены ежемесячные начисления'"), "РасчетчикГруппа", "ИзменитьОплату");
