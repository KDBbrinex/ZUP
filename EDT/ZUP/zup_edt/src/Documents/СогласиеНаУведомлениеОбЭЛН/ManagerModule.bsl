...
Функция ПараметрыФиксацииВторичныхДанных() Экспорт
	Возврат ФиксацияВторичныхДанныхВДокументах.ПараметрыФиксацииВторичныхДанных(ФиксируемыеРеквизиты());
КонецФункции
...
Функция ФиксируемыеРеквизиты()
	...
	ФиксацияВторичныхДанныхВДокументах.ДобавитьФиксируемыйРеквизит(ФиксируемыеРеквизиты, Шаблон, "ЮридическийАдресОрганизации");
...
Процедура ПриПечатиСогласия(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода)
	...
	ШаблонИмениФайла = НСтр("ru = '[Дата], Согласие [Сотрудник] на уведомление об ЭЛН [Организация]'");
	ПараметрыИмениФайла = Новый Структура("Организация,Сотрудник,Дата");
	...
	Пока Выборка.Следующий() Цикл
		...
		ЗаполнитьЗначенияСвойств(ПараметрыИмениФайла, Выборка);
		ПараметрыИмениФайла.Дата = Формат(Выборка.Дата, "ДФ=yyyy-MM-dd");
		...
		ПараметрыОбласти.НаименованиеОрганизацииВДательномПадеже = СклонениеПредставленийОбъектов.ПросклонятьПредставление(
			ПараметрыОбласти.НаименованиеОрганизации,
			3);
...
Функция ЗапросПоСогласиям(Согласия)
	...
	|	Согласия.ЮридическийАдресОрганизации КАК ЮридическийАдресОрганизации,
