...
Функция ПечатьУченическогоДоговора(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ДокументСсылка Из МассивОбъектов Цикл
		...
		ПодписиДокументовКлиентСервер.ДополнитьТекстОснованиемПодписи(
			РеквизитыДокумента.РуководительФамилияИО, РеквизитыДокумента.ОснованиеПодписиРуководителя);
...
Функция ЗначенияПараметровДокумента(ДокументСсылка)
	...
	Запрос.Текст = 
		...
		|	УченическийДоговор.ОснованиеПодписиРуководителя КАК ОснованиеПодписиРуководителя,
		|	УченическийДоговор.Организация,
	...
	Запрос.Текст = 
		...
		|	ВТУченическийДоговор.ОснованиеПодписиРуководителя,
	...
	Запрос.Текст = 
		...
		|	ВТДоговор.Руководитель,
		|	ВТДоговор.РуководительДолжность,
		|	ВТДоговор.ОснованиеПодписиРуководителя,
	...
	ВозвращаемаяСтруктура.АдресОрганизации = УправлениеКонтактнойИнформациейЗарплатаКадры.АдресОрганизации(
		АдресаОрганизаций, ВозвращаемаяСтруктура.Организация, ОбщегоНазначения.ПредопределенныйЭлемент("Справочник.ВидыКонтактнойИнформации.ЮрАдресОрганизации")).Представление;
	...
	ФизическиеЛицаЗарплатаКадры.Просклонять(Строка(ВозвращаемаяСтруктура.РуководительФИОПолные), 2, ФИОРуководителяВПадеже, ВыборкаЗапроса.РуководительПол, ВыборкаЗапроса.Руководитель);
...
Функция ПараметрыУченическогоДоговора()
	...
	Параметры.Вставить("ОснованиеПодписиРуководителя", "");
