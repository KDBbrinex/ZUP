...
Функция ДанныеДляПроведения(РеквизитыДляПроведения, СтруктураВидовУчета = Неопределено) Экспорт 
	...
	Если СтруктураВидовУчета.ОстальныеВидыУчета Тогда
		...
		Запрос.Текст =
			"ВЫБРАТЬ
			|	ОтпускНачисления.Ссылка КАК Ссылка,
			...
			|	ЕСТЬNULL(НачисленияОтпуска.ОплаченоДней, Отпуск.КоличествоДнейОсновногоОтпуска) КАК КоличествоДнейОтпуска,
			...
			|ИЗ
			|	Документ.Отпуск КАК Отпуск
			|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияОтпуска КАК НачисленияОтпуска
			|		ПО Отпуск.Ссылка = НачисленияОтпуска.Ссылка
			|			И Отпуск.ВидРасчетаОсновногоОтпуска = НачисленияОтпуска.Начисление
			|ГДЕ
			|	Отпуск.Ссылка = &Ссылка
			...
			|	ЕСТЬNULL(НачисленияОтпуска.ОплаченоДней, ОтпускДополнительныеОтпуска.КоличествоДней),
			...
			|	Документ.Отпуск.ДополнительныеОтпуска КАК ОтпускДополнительныеОтпуска
			|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияОтпуска КАК НачисленияОтпуска
			|		ПО ОтпускДополнительныеОтпуска.Ссылка = НачисленияОтпуска.Ссылка
			|			И ОтпускДополнительныеОтпуска.ВидРасчета = НачисленияОтпуска.Начисление
			|			И (ОтпускДополнительныеОтпуска.ДатаНачала = НачисленияОтпуска.ДатаНачала
			|				ИЛИ ОтпускДополнительныеОтпуска.ДатаОкончания = НачисленияОтпуска.ДатаОкончания)
			|ГДЕ
			|	ОтпускДополнительныеОтпуска.Ссылка = &Ссылка
			...
			|	ЕСТЬNULL(НачисленияОтпуска.ОплаченоДней, Отпуск.КоличествоДнейКомпенсацииОсновногоОтпуска),
			|	ДАТАВРЕМЯ(1, 1, 1),
			|	ДАТАВРЕМЯ(1, 1, 1),
			|	Отпуск.Основание,
			...
			|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияОтпуска КАК НачисленияОтпуска
			|		ПО Отпуск.Ссылка = НачисленияОтпуска.Ссылка
			|			И Отпуск.ВидРасчетаКомпенсацииОсновногоОтпуска = НачисленияОтпуска.Начисление
			|ГДЕ
			|	Отпуск.Ссылка = &Ссылка
			...
			|	ОтпускДополнительныеОтпуска.НачалоПериодаЗаКоторыйПредоставляетсяОтпуск,
			|	ОтпускДополнительныеОтпуска.КонецПериодаЗаКоторыйПредоставляетсяОтпуск,
			|	ЕСТЬNULL(НачисленияОтпуска.ОплаченоДней, ОтпускДополнительныеОтпуска.КоличествоДнейКомпенсации),
			|	ДАТАВРЕМЯ(1, 1, 1),
			|	ДАТАВРЕМЯ(1, 1, 1),
			|	ОтпускДополнительныеОтпуска.Основание,
			|	ОтпускДополнительныеОтпуска.Ссылка.ИсправленныйДокумент,
			...
			|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияОтпуска КАК НачисленияОтпуска
			|		ПО ОтпускДополнительныеОтпуска.Ссылка = НачисленияОтпуска.Ссылка
			|			И ОтпускДополнительныеОтпуска.ВидРасчетаКомпенсации = НачисленияОтпуска.Начисление
			|ГДЕ
			|	ОтпускДополнительныеОтпуска.Ссылка = &Ссылка
			|	И ОтпускДополнительныеОтпуска.Ссылка.ПредоставитьДополнительныйОтпуск
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	ДанныеОтпусков.Период КАК Период,
			|	ДанныеОтпусков.Сотрудник КАК Сотрудник,
			|	ДанныеОтпусков.ФизическоеЛицо КАК ФизическоеЛицо,
			...
			|	ДанныеОтпусков.НачалоПериодаЗаКоторыйПредоставляетсяОтпуск КАК НачалоПериодаЗаКоторыйПредоставляетсяОтпуск,
			|	ДанныеОтпусков.КонецПериодаЗаКоторыйПредоставляетсяОтпуск КАК КонецПериодаЗаКоторыйПредоставляетсяОтпуск,
			|	СУММА(ВЫБОР
			...
			|	ДанныеОтпусков.ДатаНачалаПериодаОтсутствия КАК ДатаНачалаПериодаОтсутствия,
			|	ДанныеОтпусков.ДатаОкончанияПериодаОтсутствия КАК ДатаОкончанияПериодаОтсутствия,
