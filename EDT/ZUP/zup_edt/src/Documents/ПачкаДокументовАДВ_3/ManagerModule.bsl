...
Функция СформироватьПечатнуюФормуАДВ3(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Пока ВыборкаСотрудники.Следующий() Цикл
			...
			Макет = УправлениеПечатью.МакетПечатнойФормы(?(ИспользоватьФорму2019,
				"Документ.ПачкаДокументовАДВ_3.ПФ_MXL_ФормаАДВ_3_2019", "Документ.ПачкаДокументовАДВ_3.ПФ_MXL_ФормаАДВ_3"));
