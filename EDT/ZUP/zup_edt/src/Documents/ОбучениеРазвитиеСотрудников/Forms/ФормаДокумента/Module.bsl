...
Процедура ЗаполнитьРеквизитПродолжениеОбучения(Форма)
	Форма.ПродолжениеОбучения = ЗначениеЗаполнено(Форма.Объект.ПервичныйЭтапОбучения) И (Форма.Объект.ПервичныйЭтапОбучения <> Форма.Объект.Ссылка);
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура ЗаполнитьРеквизитЭтоСледующийЭтапОбучения(Форма)
	Форма.ЭтоСледующийЭтапОбучения = ЗначениеЗаполнено(Форма.Объект.ПервичныйЭтапОбучения) И (Форма.Объект.ПервичныйЭтапОбучения <> Форма.Объект.Ссылка);
КонецПроцедуры
