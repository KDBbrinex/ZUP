...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПерсонифицированныйУчетФормы.УстановитьКраткоеОтображениеКатегорииВТаблицах(ЭтотОбъект, "КатегорияЗастрахованныхЛиц", "КатегорияЗастрахованныхЛиц");
	...
	УстановитьПараметрыВыбораОснованияИсчисляемогоСтраховогоСтажа();
...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КорректирующиеСведенияДоначисленоСтраховая", "Видимость", ОтчетныйГод >= 2002 И ОтчетныйГод <= 2013);
...
&НаСервере
Процедура УстановитьПараметрыВыбораОснованияИсчисляемогоСтраховогоСтажа()
	
	ПерсонифицированныйУчет.УстановитьПараметрыВыбораОснованияИсчисляемогоСтраховогоСтажа(Элементы, "ПачкаСЗВ_6_4ОбъектЗаписиОСтажеОснованиеИсчисляемогоСтажа", Период); 
