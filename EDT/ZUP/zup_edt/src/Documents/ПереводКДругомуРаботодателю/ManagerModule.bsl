...
Процедура ЗарегистрироватьИзмененияПослеОбработки(ИмяПланаОбмена, ПРО, Объект, Отказ, Получатели, Выгрузка) Экспорт
	...
	Если ЗначениеЗаполнено(Объект.НовыйСотрудник) И ОбщегоНазначения.СсылкаСуществует(Объект.НовыйСотрудник) Тогда
		ПланыОбмена.ЗарегистрироватьИзменения(Получатели, Объект.НовыйСотрудник);
	КонецЕсли;
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_Т8") Тогда
		...
		Справочники.Сотрудники.Печать(МассивСотрудников, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода);
...
Функция ДанныеДляПечати(МассивОбъектов)
	...
	Для каждого ДанныеОбъектаДляПечати Из ДанныеДляПечати Цикл
		...
		ФизическиеЛицаЗарплатаКадры.Просклонять(ДанныеОбъектаДляПечати.ФамилияИОРуководителя,
			3, ДанныеОбъектаДляПечати.ФИОРуководителяДательный, ДанныеОбъектаДляПечати.ПолРуководителя, ДанныеОбъектаДляПечати.Руководитель);
		...
		ФизическиеЛицаЗарплатаКадры.Просклонять(ДанныеОбъектаДляПечати.ФамилияИОРуководителяНовойОрганизации,
			3, ДанныеОбъектаДляПечати.ФИОРуководителяНовойОрганизацииДательный, ДанныеОбъектаДляПечати.ПолРуководителяНовойОрганизации, ДанныеОбъектаДляПечати.Руководитель);
		...
		ФизическиеЛицаЗарплатаКадры.Просклонять(ДанныеОбъектаДляПечати.ФамилияИО,
			2, ДанныеОбъектаДляПечати.ФИОСотрудникаРодительный, ДанныеОбъектаДляПечати.Пол, ДанныеОбъектаДляПечати.ФизическоеЛицо);
		
		ФизическиеЛицаЗарплатаКадры.Просклонять(ДанныеОбъектаДляПечати.ФамилияИО,
			5, ДанныеОбъектаДляПечати.ФИОСотрудникаТворительный, ДанныеОбъектаДляПечати.Пол, ДанныеОбъектаДляПечати.ФизическоеЛицо);
