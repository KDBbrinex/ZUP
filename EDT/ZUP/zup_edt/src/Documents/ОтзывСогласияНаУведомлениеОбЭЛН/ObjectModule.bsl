...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	СогласиеИОтзыв = РегистрыСведений.СогласияНаУведомленияОбЭЛН.ПолучитьПаруСогласиеИОтзывНаДату(Организация, Сотрудник, Дата);
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЗначенияРеквизитовДоЗаписи = Неопределено
		...
		ФизическоеЛицо = СЭДОФСС.ФизическоеЛицоСотрудника(Сотрудник);
	КонецЕсли;
