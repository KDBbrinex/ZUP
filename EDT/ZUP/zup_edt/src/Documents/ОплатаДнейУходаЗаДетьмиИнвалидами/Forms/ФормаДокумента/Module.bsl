...
Процедура ВидРасчетаПриИзмененииНаСервере()
	...
	ОбязательныйРасчетНДФЛ = УчетНДФЛРасширенный.ДоходыВУчетеНДФЛРегистрируютсяПоДатеВыплаты(Объект.ВидРасчета);
...
Процедура ЗаполнитьВидРасчета(ПервичнаяИнициализацияФормы)
	...
	БылВидРасчета = Объект.ВидРасчета;
	...
	Если Объект.ВидРасчета <> БылВидРасчета Тогда 
