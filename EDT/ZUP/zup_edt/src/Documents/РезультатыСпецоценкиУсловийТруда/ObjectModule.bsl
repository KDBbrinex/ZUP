...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	|	РабочиеМеста.ПредставлениеРабочегоМеста КАК ПредставлениеРабочегоМеста
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	АналогичныеМеста.РабочееМесто КАК РабочееМесто,
	...
	|	РабочиеМеста.ГруппаАналогичныхМест КАК ГруппаАналогичныхМест
	|ИЗ
	|	(ВЫБРАТЬ
	|		РабочиеМеста.РабочееМесто КАК РабочееМесто,
	|		РабочиеМеста.НомерСтроки КАК НомерСтроки,
	...
	|		ВТРабочиеМеста КАК РабочиеМеста
	|	ГДЕ
	|		РабочиеМеста.РабочееМесто = ЗНАЧЕНИЕ(Справочник.ШтатноеРасписание.ПустаяСсылка)) КАК РабочиеМеста
	|
	|СГРУППИРОВАТЬ ПО
	|	РабочиеМеста.РабочееМесто,
	|	РабочиеМеста.НомерСтроки,
...
Процедура ЗаполнитьПереченьРабочихМест() Экспорт
	...
	РезультатыЗапроса = ОхранаТруда.ДанныеПоРабочимМестам(Организация, ДатаНачала, ДатаРезультатов);
