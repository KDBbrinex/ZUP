	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл 
		...
		Если Выборка.ПереносПоИнициативеСотрудника Тогда
			...
			Если ФИОРуководителяВДательномПадеже = Неопределено Тогда
				...
				ФизическиеЛицаЗарплатаКадры.Просклонять(СтруктураФИО.Фамилия, 3, СтруктураФИО.Фамилия, Выборка.ПолРуководителя, Выборка.Руководитель);
		...
		Иначе
			...
			ФизическиеЛицаЗарплатаКадры.Просклонять(СтруктураФИО.Фамилия, 3, СтруктураФИО.Фамилия, Выборка.Пол, Выборка.ФизическоеЛицо);
