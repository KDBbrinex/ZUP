...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИменаСвойств = "ДатаНачала, ДатаОкончания, НазначитьПособие, ДатаНачалаОплаты, ДатаОкончанияОплаты, ДнейОплаты,
		|ПричинаНетрудоспособности, ДатаНачалаСобытия, ВидНеоплачиваемогоВремени, Сотрудник,
		|СлучайУходаЗаБольнымРебенком, АвтозаполнениеПериодовОплаты,
		|ОстатокОплачиваемыхДнейУходаЗаРодственником1, ОстатокОплачиваемыхДнейУходаЗаРодственником2";
...
Процедура ОбновитьВидимостьДоступность(Кэш = Неопределено)
	...
	ОплачиваемыеДаты = Документы.БольничныйЛист.ОплачиваемыеДаты(ЭтотОбъект, Кэш);
...
Процедура ЗаполнитьНаСервере()
	...
	ОбновитьВидимостьДоступность(Кэш);
	ПроверитьЗаполнение();
КонецПроцедуры
