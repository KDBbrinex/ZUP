...
Процедура ОбработкаОбновленияПриПереходеС82(Параметры = Неопределено) Экспорт
	Попытка
		...
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеНевозможностьПредоставления") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеТС1") <> Неопределено)  Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеТС2") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеПредоставлениеРассрочки") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеНалоговаяЛьготаРегИнвестПроекты") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеОсвобождениеОтУплатыСтраховыхВзносов") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеВозвратНалога") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеЗачетНалога") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеПостановкаСнятиеВКачествеАгента") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеЗаявлениеНаСубсидиюДляЗарплаты") <> Неопределено) Тогда 
		...
		КонецЕсли;
		Если (Метаданные.Отчеты.Найти("РегламентированноеУведомлениеЗаявлениеНаСубсидиюПрофилактика") <> Неопределено) Тогда 
		...
		Пока Выборка.Следующий() Цикл
			Попытка
				МодульМенеджераУведомления = СоответствиеОбъектов[Выборка.ИсточникОтчета];
				Если МодульМенеджераУведомления <> Неопределено Тогда 
					ОМ = ОбщегоНазначения.ОбщийМодуль(МодульМенеджераУведомления);
					Если ОМ <> Неопределено Тогда
						ОМ.КонвертацияИзРегламентированногоОтчета(Выборка);
					КонецЕсли;
				КонецЕсли;
			Исключение
