...
Процедура ДанныеДляЗаполненияВДанныеФормы(ДанныеЗаполнения, ПозицииВставки = Неопределено)
	...
	РасчетЗарплатыРасширенныйФормы.РасчетЗарплатыНачисленияПоДоговорамВДанныеФормы(Объект.НачисленияПоДоговорам, ДанныеЗаполнения[Псевдоним], Объект.Организация, ПозицииВставки);
