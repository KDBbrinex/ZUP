...
Перем ТекущееХранилищеНастроек; // ХранилищаНастроекМенеджер 
...
Процедура Инициализировать(Контейнер, ИмяХранилищаНастроек, Обработчики, Сериализатор) Экспорт
	...
	ТекущееХранилищеНастроек = ОбщегоНазначения.ВычислитьВБезопасномРежиме(ИмяХранилищаНастроек); // ХранилищаНастроекМенеджер 
