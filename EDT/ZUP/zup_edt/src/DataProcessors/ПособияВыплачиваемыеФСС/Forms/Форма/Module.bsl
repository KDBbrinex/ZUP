...
Процедура СоздатьОтпускПоУходуЗаРебенком(Команда)
	ОткрытьФорму("Документ.ОтпускПоУходуЗаРебенком.Форма.ФормаДокумента");
КонецПроцедуры
...
Процедура СоздатьОплатуДнейУходаЗаДетьмиИнвалидами(Команда)
	ОткрытьФорму("Документ.ОплатаДнейУходаЗаДетьмиИнвалидами.Форма.ФормаДокумента");
КонецПроцедуры
...
Процедура СоздатьОплатуПособияНаПогребение(Команда)
	ОткрытьФорму("Документ.ЕдиновременноеПособиеЗаСчетФСС.Форма.ФормаДокумента");
КонецПроцедуры
