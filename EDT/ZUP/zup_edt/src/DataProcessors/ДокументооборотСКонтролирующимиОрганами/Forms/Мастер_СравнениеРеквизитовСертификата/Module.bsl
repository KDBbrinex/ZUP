...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьСуществующий   = Параметры.СпособПолученияСертификата = Перечисления.СпособПолученияСертификата.ИспользоватьСуществующий;
...
Процедура ИзменитьОформлениеФормы()
	...
	Если ИспользоватьСуществующий ИЛИ ЭтоВторичное Тогда
	...
	ИначеЕсли ЭлектронноеПодписаниеНевозможно Тогда
