...
Процедура ЗаписатьФизическоеЛицо(ДанныеОбъекта, ИмяТаблицы, Отказ)
	...
	Если ЗначениеЗаполнено(Объект.address) Тогда
		...
		ДанныеКИ.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.address, Справочники.ВидыКонтактнойИнформации.АдресМестаПроживанияФизическиеЛица);
	...
	Если ЗначениеЗаполнено(Объект.work_phone) Тогда
		...
		ДанныеКИ.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.work_phone, Справочники.ВидыКонтактнойИнформации.ТелефонРабочийФизическиеЛица);
		КонтактнаяИнформация.Добавить(ДанныеКИ);
	...
	Если ЗначениеЗаполнено(Объект.mobile_phone) Тогда
		...
		ДанныеКИ.ТипИнформации = Перечисления.ТипыКонтактнойИнформации.Телефон;
		ДанныеКИ.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.mobile_phone, Справочники.ВидыКонтактнойИнформации.ТелефонМобильныйФизическиеЛица);
		КонтактнаяИнформация.Добавить(ДанныеКИ);
	...
	Если ЗначениеЗаполнено(Объект.home_phone) Тогда
		...
		ДанныеКИ.ТипИнформации = Перечисления.ТипыКонтактнойИнформации.Телефон;
		ДанныеКИ.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.home_phone, Справочники.ВидыКонтактнойИнформации.ТелефонДомашнийФизическиеЛица);
		КонтактнаяИнформация.Добавить(ДанныеКИ);
	...
	Если ЗначениеЗаполнено(Объект.email) Тогда
		...
		ДанныеКИ.ЗначенияПолей = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.email, Справочники.ВидыКонтактнойИнформации.EMailФизическиеЛица);
		КонтактнаяИнформация.Добавить(ДанныеКИ);
	...
	Если ЗначениеЗаполнено(Объект.email2) Тогда
		...
		ДанныеКИ.ВидИнформации = Справочники.ВидыКонтактнойИнформации.EMailФизическиеЛица;
		ДанныеКИ.ТипИнформации = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
		ДанныеКИ.ЗначенияПолей =  УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Объект.email2, Справочники.ВидыКонтактнойИнформации.EMailФизическиеЛица);
		КонтактнаяИнформация.Добавить(ДанныеКИ);
