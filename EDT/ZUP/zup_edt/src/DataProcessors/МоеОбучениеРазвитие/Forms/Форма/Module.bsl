...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗакрытиеФормыЭлектронногоКурса" Тогда
		Если Источник <> Неопределено И ЗначениеЗаполнено(Источник.ИзучениеЭлектронногоКурса) Тогда
			ПриЗакрытииФормыЭлектронногоКурса(Источник.ИзучениеЭлектронногоКурса, Источник.ЭлектронныйКурс, Источник.Контекст, Источник.Учащийся);
		КонецЕсли;
...
&НаСервереБезКонтекста
Процедура ПриЗакрытииФормыЭлектронногоКурса(Знач ИзучениеЭлектронногоКурса, Знач ЭлектронныйКурс, Знач Контекст, Знач Учащийся)
	...
	ДанныеОбИзучении = ИзучениеЭлектронныхКурсов.ДанныеОбИзученииЭлектронногоКурса(ИзучениеЭлектронногоКурса);
	
	ЗарплатаКадрыРасширенный.ПриЗакрытииФормыЭлектронногоКурса(ЭлектронныйКурс, Контекст, Учащийся, ДанныеОбИзучении);
	
	Если ДанныеОбИзучении.Завершено Тогда
		ЗарплатаКадрыРасширенный.ПослеИзученияЭлектронногоКурса(ЭлектронныйКурс, Контекст, Учащийся, ДанныеОбИзучении);
	КонецЕсли;
