...
Процедура ПриОткрытии(Отказ)
	...
	Для Каждого Сайт Из МассивСайтов Цикл
		...
		ЗагрузитьКлассификаторыКлиент(Сайт);
	КонецЦикла;
...
&НаКлиенте
Процедура ЗагрузитьКлассификаторыКлиент(Сайт)
...
Функция НайтиКандидатовНаСервере()
	...
	СтруктураОтбора = ИнтеграцияРекрутинговыхСайтов.СтруктураОтбораКандидатов();
	...
	ПараметрыПроцедуры.Вставить("НомерПорцииZarplata", НомерПорцииZarplata);
	...
	ПараметрыПроцедуры.Вставить("ВсегоКандидатовZarplata", ВсегоКандидатовZarplata);
	...
	ПараметрыПроцедуры.Вставить("ЗагруженоКандидатовZarplata", ЗагруженоКандидатовZarplata);
...
Процедура СформироватьИнформационнуюНадпись(НомерСтраницы)
	...
	ВсегоКандидатов = ВсегоКандидатовHeadHunter +  ВсегоКандидатовRabota + ВсегоКандидатовSuperJob + ВсегоКандидатовZarplata;
...
Функция СоответствиеИмениПоляИПутей()
	...
	СтруктураПутей.Вставить("ПутьZarplata", "sex");
	...
	СтруктураПутей.Вставить("ПутьZarplata", "education_resume");
	...
	СтруктураПутей.Вставить("ПутьZarplata", "periods");
...
Процедура ЗагрузитьТаблицуНаСервере()
	...
	Если ТипЗнч(СтруктураРезультата) = Тип("Структура") Тогда
		...
		НомерПорцииZarplata = СтруктураРезультата.НомерПорцииZarplata;
		...
		ВсегоКандидатовZarplata = СтруктураРезультата.ВсегоКандидатовZarplata;
		...
		ЗагруженоКандидатовZarplata = ЗагруженоКандидатовZarplata + СтруктураРезультата.ЗагруженоКандидатовZarplata;
