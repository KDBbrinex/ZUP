	...
	Для Каждого Этап из Этапы Цикл
		...
		Если ЗначениеЗаполнено(Этап.ЗапущенныйБизнесПроцессID) Тогда
			ОбъектыXDTO = ИнтеграцияС1СДокументооборот.ПолучитьОбъект(Прокси,
				Этап.ЗапущенныйБизнесПроцессТип, Этап.ЗапущенныйБизнесПроцессID);
			ЭтапXDTO.businessProcess = ОбъектыXDTO.objects[0];
		КонецЕсли;
		...
		Если Этап.Важность = 0 Тогда
			ВажностьЭтапа = "Низкая важность";
			ВажностьЭтапаID = "Низкая";
		ИначеЕсли Этап.Важность = 1 Тогда
			ВажностьЭтапа = "Обычная важность";
			ВажностьЭтапаID = "Обычная";
		ИначеЕсли Этап.Важность = 2 Тогда
			ВажностьЭтапа = "Высокая важность";
			ВажностьЭтапаID = "Высокая";
		КонецЕсли;
		Если ИнтеграцияС1СДокументооборот.СвойствоСуществует(ЭтапXDTO, "importance") Тогда
			ЭтапXDTO.importance = ИнтеграцияС1СДокументооборот.СоздатьОбъект(Прокси, "DMBusinessProcessImportance");
			ЭтапXDTO.importance.name = ВажностьЭтапа;
			ЭтапXDTO.importance.objectId = ИнтеграцияС1СДокументооборот.СоздатьОбъект(Прокси, "DMObjectID");
			ЭтапXDTO.importance.objectId.id = ВажностьЭтапаID;
			ЭтапXDTO.importance.objectId.type = "DMBusinessProcessImportance";
		КонецЕсли;
...
Процедура ИзменитьВажностьЭтапов()
	...
	Если ВажностьID = "Низкая" Тогда
		НовоеЗначение = 0;
	ИначеЕсли ВажностьID = "Обычная" Тогда
		НовоеЗначение = 1;
	ИначеЕсли ВажностьID = "Высокая" Тогда
		НовоеЗначение = 2;
	КонецЕсли;
