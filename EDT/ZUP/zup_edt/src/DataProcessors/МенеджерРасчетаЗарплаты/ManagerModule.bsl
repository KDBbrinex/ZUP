...
Функция ТаблицаУдержаний() Экспорт
	...
	Удержания.Колонки.Добавить("ЗаписьРасчета");
	...
	Удержания.Колонки.Добавить("УдерживатьВЦеломЗаМесяц", Новый ОписаниеТипов("Булево"));
	
	Удержания.Колонки.Добавить("Владелец");
...
Функция ТаблицаНачисленияПоДоговорам() Экспорт
	...
	НачисленияПоДоговорам.Колонки.Добавить("СуммаВычета", ОписаниеТиповСуммаРезультат());
	НачисленияПоДоговорам.Колонки.Добавить("СкидкаПоВзносам", ОписаниеТиповСуммаРезультат());
	...
	НачисленияПоДоговорам.Колонки.Добавить("Результат", ОписаниеТиповСуммаРезультат());
	...
	НачисленияПоДоговорам.Колонки.Добавить("ИдентификаторСтроки", Новый ОписаниеТипов("Число"));
	...
	НачисленияПоДоговорам.Колонки.Добавить("ФиксЗаполнение", Новый ОписаниеТипов("Булево"));
	НачисленияПоДоговорам.Колонки.Добавить("СпособОплаты", Новый ОписаниеТипов("ПеречислениеСсылка.СпособыОплатыПоДоговоруГПХ"));
...
Процедура СоздатьВТДанныеГрафиковДляПолученияСтоимостиЧасаДня(МенеджерВременныхТаблиц, ИмяВТИсходныеДанные = "ВТДополнительныеПоказатели", МенеджерУчетаВремени = Неопределено)
	...
	Если МенеджерУчетаВремени = Неопределено Тогда
		...
		Описание.ТаблицаИсточникДанных = ИмяВТИсходныеДанные;
...
Функция ТаблицаТерриторийУсловийТруда() Экспорт
	...
	Таблица.Колонки.Добавить("ДоляРаспределения", Новый ОписаниеТипов("Число"));
	...
	Таблица.Колонки.Добавить("СкидкаПоВзносам", ОписаниеТиповСуммаРезультат());
	Таблица.Колонки.Добавить("РанееНачислено", ОписаниеТиповСуммаРезультат());
