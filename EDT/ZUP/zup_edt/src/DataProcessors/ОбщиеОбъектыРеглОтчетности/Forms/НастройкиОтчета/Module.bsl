...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.мПараметры.Свойство("ИмяОтчета")
	  ...
	  ИЛИ СтрЧислоВхождений(Параметры.мПараметры.ИмяОтчета, "РегламентированныйОтчет4ФСС") > 0) Тогда
		...
		ИначеЕсли СтрЧислоВхождений(Параметры.мПараметры.ИмяОтчета, "РегламентированныйОтчет4ФСС") > 0 Тогда
