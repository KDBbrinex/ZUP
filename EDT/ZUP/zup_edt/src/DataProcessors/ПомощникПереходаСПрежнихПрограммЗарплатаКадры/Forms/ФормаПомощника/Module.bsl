...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимВыгрузкиДанныхОПодбореПерсонала = 0;
...
&НаКлиенте
Процедура ВыгружатьСведенияОПодбореПерсоналаПриИзменении(Элемент)
	
	Элементы.РежимВыгрузкиДанныхОПодбореПерсонала.Доступность = ВыгружатьСведенияОПодбореПерсонала;
...
Функция ВыгрузкаИзИнформационнойБазыV8()
	...
	Если РежимВыгрузки = 1 Тогда
		...
		Если ВыгружатьДанныеКОРП Тогда
			ПараметрыПравил.Вставить("ВыгружатьДанныеКОРП", ВыгружатьДанныеКОРП И ВыгружатьСведенияОПодбореПерсонала);
			ПараметрыПравил.Вставить("ВыгружатьСведенияОПодбореПерсонала", ВыгружатьСведенияОПодбореПерсонала);
			ПараметрыПравил.Вставить("ВыгружатьВсеДанныеПоПодборуПерсонала", РежимВыгрузкиДанныхОПодбореПерсонала <> 0);
		КонецЕсли;
	Иначе
