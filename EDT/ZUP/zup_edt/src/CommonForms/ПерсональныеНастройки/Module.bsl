...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоВебКлиент Или ОбщегоНазначения.ЭтоLinuxКлиент() Тогда
...
&НаКлиенте
Процедура ПерсональнаяНастройкаДоступаКРекрутинговымСайтам(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов") Тогда
		МодульИнтеграцияРекрутинговыхСайтовКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияРекрутинговыхСайтовКлиент");
		МодульИнтеграцияРекрутинговыхСайтовКлиент.ОткрытьФормуРедактированияПараметровДоступаКСайтам(ЭтаФорма);
	КонецЕсли;
...
Процедура УстановитьРасширениеРаботыСКриптографиейНаКлиентеЗавершение(ПараметрыВыполнения) Экспорт
	Возврат; // Обработчик не требуется.
КонецПроцедуры
...
Процедура УстановитьВидимостьЭлементовФормы()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ИнтеграцияРекрутинговыхСайтов") Тогда
		...
		МодульИнтеграцияРекрутинговыхСайтов.УстановитьВидимостьЭлементаФормы(Элементы.ИнтеграцияРекрутинговыхСайтов);
	КонецЕсли;
