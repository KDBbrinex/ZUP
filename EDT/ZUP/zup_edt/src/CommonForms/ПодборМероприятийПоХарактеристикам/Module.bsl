...
Процедура ПриПолученииДанныхНаСервере()
	...
	ОбучениеРазвитиеФормы.ЗаполнитьКэшХарактеристикиМероприятияПоХарактеристикам(КэшХарактеристикиМероприятия, Характеристики.Выгрузить(, "Характеристика").ВыгрузитьКолонку("Характеристика"));
