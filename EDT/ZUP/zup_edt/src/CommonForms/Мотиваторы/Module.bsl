...
Процедура ДобавитьПоказатель(Команда)
	...
	ПараметрыФормы.МассивВыбранных = Новый Массив;
	Для Каждого СтрокаТЧ Из ЭтаФорма[ИмяТаблицы] Цикл
		ПараметрыФормы.МассивВыбранных.Добавить(СтрокаТЧ[ИмяКолонки]);
	КонецЦикла;
	
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ПараметрыКоманды", Массив);

	ИмяФормыВыбора = "Справочник." + ИмяТаблицы + ".ФормаВыбора";
	ОписаниеОповещения = Новый ОписаниеОповещения("ВыбранПоказатель_Завершение", ЭтаФорма, ДополнительныеПараметры);
	ОткрытьФорму(ИмяФормыВыбора, ПараметрыФормы, , , , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
