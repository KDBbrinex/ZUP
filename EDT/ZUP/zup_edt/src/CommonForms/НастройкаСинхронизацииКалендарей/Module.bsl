...
Процедура ЗаполнитьНазваниеПрограммы()
	...
	НазваниеПрограммы = "1С:Предприятие 8";
	ИДКонфигурации = КонфигурацииЗарплатаКадрыРасширенный.ИДКонфигурации();
	Если ИДКонфигурации = "ЗУП" Тогда
		НазваниеПрограммы = "1С:Зарплата и управление персоналом 8 КОРП";
	ИначеЕсли ИДКонфигурации = "ЗГУ" Тогда
		НазваниеПрограммы = "1С:Зарплата и кадры государственного учреждения 8 КОРП";
	КонецЕсли;
