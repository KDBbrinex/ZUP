...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = "ОбменЗУПБП";
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ИдентификаторНастройки = "ОбменУП2ЗУП3" Тогда
		...
		НаименованиеКонфигурацииКорреспондента = НСтр("ru = '1С:ERP Управление предприятием 2 / Комплексная автоматизация, редакция 2'");
		
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Зарплата и управление персоналом, редакция 3.1""
		|и ""1С:ERP Управление предприятием 2 / Комплексная автоматизация, редакция 2"". В синхронизации участвуют документы и нормативно-справочная информация.'");
		
		ЗаголовокКоманды   = НСтр("ru = '1С:ERP Управление предприятием 2 / Комплексная автоматизация, редакция 2'");
		ЗаголовокПомощника = НСтр("ru = 'Настройка синхронизации с программой ""1С:ERP Управление предприятием 2 / Комплексная автоматизация, редакция 2""'");
		ЗаголовокУзла      = НСтр("ru = 'Синхронизация с программой ""1С:ERP Управление предприятием 2 / Комплексная автоматизация, редакция 2""'");
		
	ИначеЕсли ИдентификаторНастройки = "ОбменЗУПБП" Тогда
		...
		ЗаголовокКоманды   = НСтр("ru='Бухгалтерия предприятия, ред. 3. Обмен с использованием универсального формат обмена ""Enterprise Data"".'");
		...
		ОписаниеВарианта.ЗначенияПоУмолчанию.Вставить("ОтправлятьВедомости", Истина);
		ОписаниеВарианта.ЗначенияПоУмолчанию.Вставить("ОтправлятьРегламентированныеОтчеты", Истина);
