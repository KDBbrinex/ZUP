...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ПодробнаяИнформацияПоОбмену = "ПланОбмена.кдОбменЗУПДОК.Форма.ПодробнаяИнформация";
	
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = НСтр("ru = 'Настройки обмена ЗУП 3 - Документооборот'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("ru='Обмен с Документооборот КОРП, ред. 2'");
	...
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = НСтр("ru='Документооборот КОРП, ред. 2'");
	
	ЗаголовокКоманды   = НСтр("ru='Документооборот КОРП, ред. 2'");
	ЗаголовокПомощника = НСтр("ru='Синхронизация с Документооборот КОРП, ред. 2 (настройка)'");
	ЗаголовокУзла      = НСтр("ru='Синхронизация с Документооборот КОРП, ред. 2'");
