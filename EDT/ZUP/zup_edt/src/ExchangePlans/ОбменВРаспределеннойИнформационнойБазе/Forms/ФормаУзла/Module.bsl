...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступностьПодразделений = Истина;
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
		МодульОрганизационнаяСтруктура = ОбщегоНазначения.ОбщийМодуль("ОрганизационнаяСтруктура");
		ДоступностьПодразделений = Не МодульОрганизационнаяСтруктура.СтруктураПредприятияСоответствуетСтруктуреЮридическихЛиц();
	КонецЕсли;
...
Процедура РежимСинхронизацииОрганизацийПриИзмененииЗначения()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Организации", "Доступность", 
		РежимСинхронизацииОрганизаций = "СинхронизироватьДанныеТолькоПоВыбраннымОрганизациям" И Объект.СинхронизироватьДанныеПоОрганизациям);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "РежимСинхронизацииОрганизаций", "Доступность", Объект.СинхронизироватьДанныеПоОрганизациям);
...
Процедура РежимСинхронизацииПодразделенийПриИзмененииЗначения()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Подразделения", "Доступность", 
		РежимСинхронизацииПодразделений = "СинхронизироватьДанныеТолькоПоВыбраннымПодразделениям" И Объект.СинхронизироватьДанныеПоПодразделениям);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "РежимСинхронизацииПодразделений", "Доступность", Объект.СинхронизироватьДанныеПоПодразделениям);
	
	Если Не Объект.СинхронизироватьДанныеПоПодразделениям Тогда
		РежимСинхронизацииПодразделений = "СинхронизироватьДанныеТолькоПоВыбраннымПодразделениям";
		УстановитьИспользованиеПодразделений(Подразделения.ПолучитьЭлементы(), Ложь);
	ИначеЕсли РежимСинхронизацииПодразделений = "СинхронизироватьДанныеПоВсемПодразделениям" Тогда
		УстановитьИспользованиеПодразделений(Подразделения.ПолучитьЭлементы(), Истина);
	КонецЕсли;
...
&НаКлиенте
Процедура УстановитьИспользованиеПодразделений(Коллекция, Использовать)
	
	Для каждого Подразделение Из Коллекция Цикл
		Если Подразделение.Использовать <> Использовать Тогда
			Подразделение.Использовать = Использовать;
		КонецЕсли;
		УстановитьИспользованиеПодразделений(Подразделение.ПолучитьЭлементы(), Использовать);
	КонецЦикла;
