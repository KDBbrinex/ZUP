...
Процедура ВосстановлениеПереданныхИдентификаторов(ПараметрыОбновления = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|			И МероприятияТрудовойДеятельности.НаименованиеВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.НаименованиеВторогоДокументаОснования
		|			И МероприятияТрудовойДеятельности.ДатаВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.ДатаВторогоДокументаОснования
		|			И МероприятияТрудовойДеятельности.СерияВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.СерияВторогоДокументаОснования
		|			И МероприятияТрудовойДеятельности.НомерВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.НомерВторогоДокументаОснования
