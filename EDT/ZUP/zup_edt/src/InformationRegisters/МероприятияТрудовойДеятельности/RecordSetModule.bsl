...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	// 7. Если идентификатор так и не удалось заполнить назначается новый.
	...
	Запрос.Текст =
		...
		|			И НовыйНабор.НаименованиеВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.НаименованиеВторогоДокументаОснования
		|			И НовыйНабор.ДатаВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.ДатаВторогоДокументаОснования
		|			И НовыйНабор.СерияВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.СерияВторогоДокументаОснования
		|			И НовыйНабор.НомерВторогоДокументаОснования = МероприятияТрудовойДеятельностиПрочие.НомерВторогоДокументаОснования
