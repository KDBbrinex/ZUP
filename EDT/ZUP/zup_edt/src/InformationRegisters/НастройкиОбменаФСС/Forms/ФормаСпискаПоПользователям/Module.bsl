...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоЭлектроннаяПодписьВМоделиСервиса =
		ЭлектроннаяПодписьВМоделиСервисаБРОВызовСервера.ЭтоЭлектроннаяПодписьВМоделиСервиса(ОрганизацияСсылка);
...
Процедура СертификатСтрахователяПредставлениеОткрытие(Элемент, СтандартнаяОбработка)
	...
	СвойстваСертификата.Вставить("ЭтоЭлектроннаяПодписьВМоделиСервиса", ЭтоЭлектроннаяПодписьВМоделиСервиса);
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле <> Неопределено И Поле.Имя = "СписокСертификатСтрахователяПредставление" Тогда
		Возврат;
	КонецЕсли;
...
Процедура СертификатСтрахователяПредставлениеНачалоВыбораПослеПроверкиУЦ(Результат, ДополнительныеПараметры) Экспорт
	...
	КриптографияЭДКОКлиент.ОтобразитьПредставлениеСертификата(
		ДополнительныеПараметры.ЭтоЭлектроннаяПодписьВМоделиСервиса,
		Элементы.СертификатСтрахователяПредставление,
...
Процедура ОбновитьНастройкиОбменаПользователей()
	...
	Для каждого ОтпечатокСертификата Из УникальныеОтпечаткиСертификатов Цикл
		...
		Если ЭтоЭлектроннаяПодписьВМоделиСервиса Тогда
			СертификатСтрахователя.Вставить("ЭтоЭлектроннаяПодписьВМоделиСервиса", ЭтоЭлектроннаяПодписьВМоделиСервиса);
		КонецЕсли;
...
Процедура СохранитьНаСервере()
	...
	Для каждого ЗаписьНастроек Из НаборЗаписейНастроек Цикл
		...
		Иначе
			...
			Если ЗначениеЗаполнено(ОтпечатокСертификата) И ОтпечатокСертификата <> СертификатСтрахователяОтпечаток Тогда
