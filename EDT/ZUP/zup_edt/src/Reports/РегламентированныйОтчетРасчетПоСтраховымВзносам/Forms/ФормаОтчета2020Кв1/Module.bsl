...
Функция ПечатьРеестраНаСервере(ВидПечати, ЗаголовокПечатнойФормы)
	...
	Для каждого Ветка Из ДеревоДанных.Строки Цикл
		...
		НовСтрТЗ_ИтогПоРазделу["Мес1_СуммаВыпл"] = ДанныеПодр1_1и1_2["П011120003002"];
		НовСтрТЗ_ИтогПоРазделу["Мес2_СуммаВыпл"] = ДанныеПодр1_1и1_2["П011120003003"];
		НовСтрТЗ_ИтогПоРазделу["Мес3_СуммаВыпл"] = ДанныеПодр1_1и1_2["П011120003004"];
...
Функция ВыполнитьДокументированиеНаСервере()
	...
	Возврат ОбъектОтчета.ВыполнитьДокументированиеОбъект();
