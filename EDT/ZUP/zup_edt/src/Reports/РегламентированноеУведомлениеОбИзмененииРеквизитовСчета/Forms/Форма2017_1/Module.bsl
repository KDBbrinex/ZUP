...
Процедура СформироватьДеревоСтраниц()
	...
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Сведения о"+символы.ПС+"счете в банке"+символы.ПС+"после изменения";
	Стр001.ИндексКартинки = 1;
	...
	Стр001 = КорневойУровень.Добавить();
	Стр001.Наименование = "Сведения о"+символы.ПС+"счете в банке"+символы.ПС+"до изменения";
	Стр001.ИндексКартинки = 1;
