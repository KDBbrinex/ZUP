...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявлениеОсвобождениеОтСтраховыхВзносов;
...
Процедура ЗаполнитьНачальныеДанные()
	...
	СтрокаСведений = "ИННФЛ,ТелДом,ФамилияИП,ИмяИП,ОтчествоИП,СНИЛС";
