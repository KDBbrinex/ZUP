...
Процедура УстановитьДанныеПоРегистрацииВИФНС()
	...
	Иначе
		Руководитель = РегламентированнаяОтчетностьВызовСервера.ПолучитьСведенияОбОрганизации(Объект.Организация, Объект.ДатаПодписи, "ФамилияРук,ИмяРук,ОтчествоРук");
		Объект.ПодписантФамилия = Руководитель.ФамилияРук;
		Объект.ПодписантИмя = Руководитель.ИмяРук;
		Объект.ПодписантОтчество = Руководитель.ОтчествоРук;
