...
Процедура ПодготовитьДанныеПоРазделуОрганизация(ТаблицаПоказателей)
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСистемыНалогообложения.СрезПоследних()", "ПлательщикЕНВД", 
	...
	Если ПолучитьФункциональнуюОпцию("РаботаВБюджетномУчреждении") Тогда	
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "ФормироватьРезервОтпусковБУ", 
			"Формировать резервы", "Настройки организации", "Резервы отпусков", "Ложь", 1, 4, 1, "Организация");
	Иначе
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "ФормироватьРезервОтпусковБУ", 
			"Формировать резервы в бухгалтерском учете", "Настройки организации", "Резервы отпусков", "Ложь", 1, 4, 1, "Организация");
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "ФормироватьРезервОтпусковНУ", 
			"Формировать резервы в налоговом учете по налогу на прибыль (нормативный метод)", "Настройки организации", "Резервы отпусков", "Ложь", 1, 4, 2, "Организация");
	КонецЕсли;
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "МетодНачисленияРезерваОтпусков", 
		"Метод расчета резерва", "Настройки организации", "Резервы отпусков", "Значение(Перечисление.МетодыНачисленияРезервовОтпусков.ПустаяСсылка)", 1, 4, 3, "Организация");
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "НормативОтчисленийВРезервОтпусков", 
		"Размер отчислений от ФОТ (%)", "Настройки организации", "Резервы отпусков", "0", 1, 4, 4, "Организация");
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаРезервовОтпусков.СрезПоследних()", "ПредельнаяВеличинаОтчисленийВРезервОтпусков", 
		"Предельная величина", "Настройки организации", "Резервы отпусков", "0", 1, 4, 5, "Организация");
...
Процедура ПодготовитьДанныеПоРазделуРасчетЗарплаты(ТаблицаПоказателей)
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаЗарплаты", "ИспользоватьНачисленияПоДоговорам", 
...
Процедура ПодготовитьДанныеПоРазделуУправлениеПерсоналом(ТаблицаПоказателей)
	...
	// Подбор персонала
	ДобавитьПоказатель(ТаблицаПоказателей, "Константы", "ИспользоватьПодборПерсонала", 
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "Константы", "ИспользоватьСамообслуживаниеСотрудников", 
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "Константы", "СоздаватьПользователейДляПринятыхНаРаботуСотрудниковАвтоматически", 
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "Константы", "ЗапрещатьВходВПрограммуУволеннымСотрудникамАвтоматически", 
