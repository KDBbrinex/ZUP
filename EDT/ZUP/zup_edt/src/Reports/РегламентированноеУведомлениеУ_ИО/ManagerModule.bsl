...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Приказ ФНС России от 24.04.2015 № ММВ-7-14/177@";
...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2015_1(Данные, УникальныйИдентификатор)
	...
	Титульный = Данные.Титульный[0];
	Если (Не ЗначениеЗаполнено(Титульный.Основание)) Тогда
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не заполнено основание подачи уведомления на титульном листе", "Титульный", "Основание", Титульный.UID));
	КонецЕсли;
	Если (Не ЗначениеЗаполнено(Титульный.ПрНпл)) Тогда
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не заполнен код налогоплательщика", "Титульный", "ПрНпл", Титульный.UID));
	КонецЕсли;
	
	Для Каждого СведИО Из Данные.СведИО Цикл 
		Если ЗначениеЗаполнено(СведИО.ИО_Номер) Тогда 
			Если Не ЗначениеЗаполнено(СведИО.ИО_ПолноеНаименование_RUS) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование на русском языке", "СведИО", "ИО_ПолноеНаименование_RUS", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.ИО_ПолноеНаименование_EN) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование на английском языке", "СведИО", "ИО_ПолноеНаименование_EN", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.КодСтранаРегистрации) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код страны регистрации", "СведИО", "КодСтранаРегистрации", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.РегНом1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан регистрационный номер", "СведИО", "РегНом1", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.ИнАдр1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан адрес", "СведИО", "ИнАдр1", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.ПрУч1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак", "СведИО", "ПрУч1", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.ДатаНач1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата", "СведИО", "ДатаНач1", СведИО.UID));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СведИО.ДоляУчастия1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля участия", "СведИО", "ДоляУчастия1", СведИО.UID));
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	
	Для Каждого СведРО Из Данные.СведРО Цикл 
		Если ЗначениеЗаполнено(СведРО.РО_Номер) Тогда 
			Если (Не ЗначениеЗаполнено(СведРО.ОГРН2)) Или СтрДлина(СокрЛП(СведРО.ОГРН2)) <> 13 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ОГРН", "СведРО", "ОГРН2", СведРО.UID));
			КонецЕсли;
			Если (Не ЗначениеЗаполнено(СведРО.ИНН2)) Или СтрДлина(СокрЛП(СведРО.ИНН2)) <> 10 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ИНН", "СведРО", "ИНН2", СведРО.UID));
			КонецЕсли;
			Если (Не ЗначениеЗаполнено(СведРО.КПП2)) Или СтрДлина(СокрЛП(СведРО.КПП2)) <> 9 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан КПП", "СведРО", "КПП2", СведРО.UID));
			КонецЕсли;
			Если (Не ЗначениеЗаполнено(СведРО.РО_ПолноеНаименование)) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование", "СведРО", "РО_ПолноеНаименование", СведРО.UID));
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого СведИС Из Данные.СведИС Цикл 
		...
		Если (Не ЗначениеЗаполнено(СведИС.ПрСтр)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак", "СведИС", "ПрСтр", СведИС.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведИС.ИС_ПолноеНаименование_RUS)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование на русском языке", "СведИС", "ИС_ПолноеНаименование_RUS", СведИС.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведИС.ИС_ПолноеНаименование_EN)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование на английском языке", "СведИС", "ИС_ПолноеНаименование_EN", СведИС.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведИС.ИС_ДокНаименование_RUS)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан документ", "СведИС", "ИС_ДокНаименование_RUS", СведИС.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведИС.ДатаРегСтр)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата регистрации", "СведИС", "ДатаРегСтр", СведИС.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведИС.КодСтраныСтр)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код страны регистрации", "СведИС", "КодСтраныСтр", СведИС.UID));
		КонецЕсли;
		
		СведИСУч = Данные.СведИСУч.НайтиСтроки(Новый Структура("UID_parent", СведИС.UID));
		Для Каждого Стр Из СведИСУч Цикл 
			Если (Не ЗначениеЗаполнено(Стр.ИС_Статус_RUS)) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан статус", "СведИСУч", "ИС_Статус_RUS", Стр.UID));
			КонецЕсли;
			Если (Не ЗначениеЗаполнено(Стр.УчИнСтр)) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак", "СведИСУч", "УчИнСтр", Стр.UID));
			КонецЕсли;
			Если (Не ЗначениеЗаполнено(Стр.ДатаНачИС)) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата", "СведИСУч", "ДатаНачИС", Стр.UID));
			КонецЕсли;
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого СведУч Из Данные.СведУч Цикл
		...
		Если (Не ЗначениеЗаполнено(СведУч.ПолноеНаименование)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование", "СведУч", "ПолноеНаименование", СведУч.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведУч.ДоляКосвУчастия)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля участия", "СведУч", "ДоляКосвУчастия", СведУч.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведУч.ДоляКосвУчастияГр)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля участия", "СведУч", "ДоляКосвУчастияГр", СведУч.UID));
		КонецЕсли;
		Если (Не ЗначениеЗаполнено(СведУч.НомерГруппы)) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан номер группы", "СведУч", "НомерГруппы", СведУч.UID));
		КонецЕсли;
		...
		Для Каждого Стр Из СтрокиМНГ Цикл
			Инд = Инд + 1;
			Если (Не ЗначениеЗаполнено(Стр.НомерУчастника)) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан номер участника", "СведУч", "НомерУчастника_" + Формат(Инд, "ЧГ="), СведУч.UID));
			КонецЕсли;
		КонецЦикла;
	КонецЦикла;
...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2019_1(Данные, УникальныйИдентификатор)
	...
	Если Не ЗначениеЗаполнено(Титульная.ОснУвед) Тогда 
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано основание подачи уведомления", "Титульная", "ОснУвед"));
	КонецЕсли;
	Если Не ЗначениеЗаполнено(Титульная.ПрНП) Тогда 
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак налогоплательщика", "Титульная", "ПрНП"));
	КонецЕсли;
	...
	КонецЕсли;
	Если Не ЗначениеЗаполнено(Титульная.ФИО_РУКОВОДИТЕЛЯ_ПРЕДСТАВИТЕЛЯ) И (Титульная.ПРИЗНАК_НП_ПОДВАЛ = "2" Или Титульная.ПРИЗНАК_НП_ПОДВАЛ = "3" Или Титульная.ПРИЗНАК_НП_ПОДВАЛ = "4") Тогда 
	...
	Если ЗначениеЗаполнено(Титульная.ИННФЛ) И Не РегламентированныеДанныеКлиентСервер.ИННСоответствуетТребованиям(Титульная.ИННФЛ, Ложь, "") Тогда 
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ИНН", "Титульная", "ИННФЛ"));
	КонецЕсли;
	...
	Иначе
		...
		Если Не ЗначениеЗаполнено(ЛистСведФЛ.Фамилия) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана фамилия", "ЛистСведФЛ", "Фамилия"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистСведФЛ.Имя) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано имя", "ЛистСведФЛ", "Имя"));
		КонецЕсли;
		...
		Если Не ЗначениеЗаполнено(ЛистСведФЛ.ПрГражд) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана признак гражданства", "ЛистСведФЛ", "ПрГражд"));
		КонецЕсли;
		
		Если Не ЗначениеЗаполнено(ЛистСведФЛ.КодВидДок) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код документа", "ЛистСведФЛ", "КодВидДок"));
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(ЛистСведФЛ.КодВидДок1)
			...
			Если Не ЗначениеЗаполнено(ЛистСведФЛ.КодВидДок1) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код документа", "ЛистСведФЛ", "КодВидДок1"));
			КонецЕсли;
	...
	Для Каждого Лист Из Данные.ДанныеМногостраничныхРазделов.ЛистА Цикл
		...
		Если Не ЗначениеЗаполнено(ЛистТек.НаимОргЛат) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование организации (лист А)", "ЛистА", "НаимОргЛат", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.СтрРег) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана страна регистрации (лист А)", "ЛистА", "СтрРег", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.РегНомер) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан регистрационный номер (лист А)", "ЛистА", "РегНомер", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.Участие) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак участия (лист А)", "ЛистА", "Участие", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДатаВознУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата (лист А)", "ЛистА", "ДатаВознУч", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДоляУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля (лист А)", "ЛистА", "ДоляУч", ЛистТек.УИД));
		КонецЕсли;
		
		Если Титульная.ОснУвед = "4" И ЛистТек.ДатаВознУч <> Дата('20150515') Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("При основании подачи уведомления ""4"" дата должна принимать значение 15.05.2015 (лист А)", "ЛистА", "ДатаВознУч", ЛистТек.УИД));
		КонецЕсли;
		Если (Титульная.ОснУвед = "2" Или Титульная.ОснУвед = "7") И Не ЗначениеЗаполнено(ЛистТек.ДатаИзмДолиУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("При основании подачи уведомления ""2"" или ""7"" должна быть указана дата изменения (лист А)", "ЛистА", "ДатаИзмДолиУч", ЛистТек.УИД));
		КонецЕсли;
		Если (Титульная.ОснУвед = "3") И Не ЗначениеЗаполнено(ЛистТек.ДатаКонУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("При основании подачи уведомления ""3"" должна быть указана дата окончания (лист А)", "ЛистА", "ДатаКонУч", ЛистТек.УИД));
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Лист Из Данные.ДанныеМногостраничныхРазделов.ЛистБ Цикл
		...
		Если Не ЗначениеЗаполнено(ЛистТек.НаимОрг) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование организации (лист Б)", "ЛистБ", "НаимОрг", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ОГРН) Или Не РегламентированныеДанныеКлиентСервер.ОГРНСоответствуетТребованиям(ЛистТек.ОГРН, Истина, "") Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан / неправильно указан ОГРН (лист Б)", "ЛистБ", "ОГРН", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ИННЮЛ) Или Не РегламентированныеДанныеКлиентСервер.ИННСоответствуетТребованиям(ЛистТек.ИННЮЛ, Истина, "") Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан / неправильно указан ИНН (лист Б)", "ЛистБ", "ИННЮЛ", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.КПП) Или Не РегламентированныеДанныеКлиентСервер.КППСоответствуетТребованиям(ЛистТек.КПП, "") Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан / неправильно указан КПП (лист Б)", "ЛистБ", "КПП", ЛистТек.УИД));
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Лист Из Данные.ДанныеМногостраничныхРазделов.ЛистВ Цикл
		...
		Если Не ЗначениеЗаполнено(ЛистТек.Учредит) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак учредителя (лист В)", "ЛистВ", "Учредит", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.КонтрЛиц) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак контролирующего лица (лист В)", "ЛистВ", "КонтрЛиц", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ОргФорм) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак организационной формы (лист В)", "ЛистВ", "ОргФорм", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.НаимОргЛат) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование структуры (лист В)", "ЛистВ", "НаимОргЛат", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДатаУчр) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата учереждения структуры (лист В)", "ЛистВ", "ДатаУчр", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДатаВознУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата возникновения участия (лист В)", "ЛистВ", "ДатаВознУч", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДоляУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля участия (лист В)", "ЛистВ", "ДоляУч", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.СтранаУчрИС) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана страна регистрации (лист В)", "ЛистВ", "СтранаУчрИС", ЛистТек.УИД));
		КонецЕсли;
		
		Если Титульная.ОснУвед = "4" И ЛистТек.ДатаВознУч <> Дата('20150515') Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("При основании подачи уведомления ""4"" дата должна принимать значение 15.05.2015 (лист В)", "ЛистВ", "ДатаВознУч", ЛистТек.УИД));
		КонецЕсли;
		Если (Титульная.ОснУвед = "3") И Не ЗначениеЗаполнено(ЛистТек.ДатаКонУч) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("При основании подачи уведомления ""3"" должна быть указана дата окончания (лист В)", "ЛистВ", "ДатаКонУч", ЛистТек.УИД));
		КонецЕсли;
	КонецЦикла;
	
	Если Не НаличиеАВ Тогда
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не заполнены сведения об иностранных организациях", "ЛистА", "НомерКонтрЛицЧисло", Данные.ДанныеМногостраничныхРазделов.ЛистА[0].Значение.УИД));
	КонецЕсли;
	...
	Для Каждого Лист Из Данные.ДанныеМногостраничныхРазделов.ЛистГ Цикл
		...
		Если Не ЗначениеЗаполнено(ЛистТек.НаимОргЛат) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование организации (лист Г)", "ЛистГ", "НаимОргЛат", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДоляУчКосвИт) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля косвенного участия (лист Г)", "ЛистГ", "ДоляУчКосвИт", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.ДоляКосвПослИт) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана доля косвенного участия в последовательности (лист Г)", "ЛистГ", "ДоляКосвПослИт", ЛистТек.УИД));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(ЛистТек.НомерПосл) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан номер последовательности (лист Г)", "ЛистГ", "НомерПосл", ЛистТек.УИД));
		КонецЕсли;
		...
		Для Каждого СтрМнг Из Данные.ДанныеДопСтрокБД.МнгСтр.НайтиСтроки(Новый Структура("УИД", ЛистТек.УИД)) Цикл 
			...
			Если Не ЗначениеЗаполнено(СтрМнг.НомерУч) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан номер участника последовательности (лист Г)", "ЛистГ", "НомерУч___" + Формат(Инд, "ЧГ="), ЛистТек.УИД));
			КонецЕсли;
		КонецЦикла;
	КонецЦикла;
