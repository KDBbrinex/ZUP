...
Функция СформироватьНовоеУведомление(РедакцияФормы, Данные) Экспорт
	...
	ИначеЕсли РедакцияФормы = "Форма2020_1" Тогда
		Возврат СформироватьНовоеУведомление_2020_1(Данные);
	КонецЕсли;
КонецФункции
...
Функция ПолучитьФормуПоУмолчанию() Экспорт
	Возврат "Отчет.РегламентированноеУведомлениеПолучениеПатента.Форма.Форма2020_1";
КонецФункции
...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "В редакции от 18.02.2020 письмо ФНС России N СД-4-3/2815@";
	Стр.ДатаНачала = Дата("20200226");
	Стр.ДатаКонца = Дата("20500101");
...
Функция НапечататьЛистА_Форма2020_1(Объект, Данные, Индекс, Листы, ПечатнаяФорма, НомСтр, ИННКПП)
	ПостФикс = "_" + Индекс;
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(ИННКПП.ИНН, "ИННШапка", ПечатнаяФорма.Области);
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(Формат(НомСтр, "ЧЦ=3; ЧН=000; ЧВН="), "НомСтр", ПечатнаяФорма.Области);
	...
	Если Индекс = 4 Тогда 
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, НомСтр, Ложь);
		НомСтр = НомСтр + 1;
		ПечатнаяФорма.Вывести(Отчеты.РегламентированноеУведомлениеПолучениеПатента.ПолучитьМакет("Печать_Форма2020_1_ЛистА"));
		Индекс = 1;
	КонецЕсли;
КонецФункции

Функция НапечататьЛистБ_Форма2020_1(Объект, Данные, Индекс, Листы, ПечатнаяФорма, НомСтр, ИННКПП)
	ПостФикс = "_" + Индекс;
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(ИННКПП.ИНН, "ИННШапка", ПечатнаяФорма.Области);
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(Формат(НомСтр, "ЧЦ=3; ЧН=000; ЧВН="), "НомСтр", ПечатнаяФорма.Области);
	...
	Если Индекс = 3 Тогда 
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, НомСтр, Ложь);
		НомСтр = НомСтр + 1;
		ПечатнаяФорма.Вывести(Отчеты.РегламентированноеУведомлениеПолучениеПатента.ПолучитьМакет("Печать_Форма2020_1_ЛистБ"));
		Индекс = 1;
	КонецЕсли;
КонецФункции

Функция НапечататьЛистВ_Форма2020_1(Объект, Данные, Листы, ПечатнаяФорма, НомСтр, ИННКПП)
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(ИННКПП.ИНН, "ИННШапка", ПечатнаяФорма.Области);
	УведомлениеОСпецрежимахНалогообложения.ВывестиСтрокуНаПечать(Формат(НомСтр, "ЧЦ=3; ЧН=000; ЧВН="), "НомСтр", ПечатнаяФорма.Области);
	...
	УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, НомСтр, Ложь);
	НомСтр = НомСтр + 1;
	ПечатнаяФорма.Вывести(Отчеты.РегламентированноеУведомлениеПолучениеПатента.ПолучитьМакет("Печать_Форма2020_1_ЛистВ"));
КонецФункции
...
Функция СформироватьСписокЛистовФорма2020_1(Объект) Экспорт
	...
	НомСтр = 1;
	ПечатнаяФорма = УведомлениеОСпецрежимахНалогообложения.НовыйПустойЛист();
	ПечатнаяФорма.Вывести(Отчеты.РегламентированноеУведомлениеПолучениеПатента.ПолучитьМакет("Печать_Форма2020_1_Титульная"));
	...
	ПечатнаяФорма = УведомлениеОСпецрежимахНалогообложения.НовыйПустойЛист();
	ПечатнаяФорма.Вывести(Отчеты.РегламентированноеУведомлениеПолучениеПатента.ПолучитьМакет("Печать_Форма2020_1_Лист2"));
	...
	Для Каждого Стр Из ЛистыАСвернутые Цикл 
		...
		Индекс = 1;
		Для Каждого Данные Из ОтборСтроки Цикл
			НапечататьЛистА_Форма2020_1(Объект, ОбщегоНазначения.СтрокаТаблицыЗначенийВСтруктуру(Данные), Индекс, Листы, ПечатнаяФорма, НомСтр, ИННКПП);
		КонецЦикла;
		Если Индекс <> 1 Тогда 
			УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, НомСтр, Ложь);
			НомСтр = НомСтр + 1;
	...
	Для Каждого Стр Из ЛистыБСвернутые Цикл 
		...
		Индекс = 1;
		Для Каждого Данные Из ОтборСтроки Цикл
			НапечататьЛистБ_Форма2020_1(Объект, ОбщегоНазначения.СтрокаТаблицыЗначенийВСтруктуру(Данные), Индекс, Листы, ПечатнаяФорма, НомСтр, ИННКПП);
		КонецЦикла;
		Если Индекс <> 1 Тогда 
			УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, НомСтр, Ложь);
			НомСтр = НомСтр + 1;
	...
	Для Каждого Стр Из ЛистыВ Цикл
		Если Не ЗначениеЗаполнено(Стр.КодРегион) Тогда 
			Продолжить;
		КонецЕсли;
		НапечататьЛистВ_Форма2020_1(Объект, ОбщегоНазначения.СтрокаТаблицыЗначенийВСтруктуру(Стр), Листы, ПечатнаяФорма, НомСтр, ИННКПП);
	КонецЦикла;
...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2020_1(Данные, УникальныйИдентификатор)
	...
	Попытка
		Титульная = Данные.ДанныеУведомления.Форма2020_1_Титульная;
		Если Не ЗначениеЗаполнено(Титульная.ПрПодп) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак подписанта", "Форма2020_1_Титульная", "ПрПодп"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Титульная.НаимДок) И Титульная.ПрПодп = "2" Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан документ (обязателен при подаче представителем)", "Форма2020_1_Титульная", "НаимДок"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Титульная.ФИО_РУКОВОДИТЕЛЯ_ПРЕДСТАВИТЕЛЯ) И Титульная.ПрПодп = "2" Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан представитель", "Форма2020_1_Титульная", "ФИО_РУКОВОДИТЕЛЯ_ПРЕДСТАВИТЕЛЯ"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Титульная.КодНО) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан налоговый орган", "Форма2020_1_Титульная", "КодНО"));
		КонецЕсли;
		Если ЗначениеЗаполнено(Титульная.ИННШапка) И СтрДлина(СокрЛП(Титульная.ИННШапка)) <> 12 Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ИНН", "Форма2020_1_Титульная", "ИННШапка"));
		КонецЕсли;
		Если ЗначениеЗаполнено(Титульная.ОГРНИП) И СтрДлина(СокрЛП(Титульная.ОГРНИП)) <> 15 Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ОГРН", "Форма2020_1_Титульная", "ОГРНИП"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Титульная.ДатаНачПат) И ЗначениеЗаполнено(Титульная.ОГРНИП) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата начала действия патента", "Форма2020_1_Титульная", "ДатаНачПат"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Титульная.ДатаКонПат) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана дата окончания действия патента", "Форма2020_1_Титульная", "ДатаКонПат"));
		КонецЕсли;
		Если ЗначениеЗаполнено(Титульная.ДатаНачПат) И Не ЗначениеЗаполнено(Титульная.ОГРНИП) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Дата начала действия патента не указывается, если не заполнен ОГРНИП", "Форма2020_1_Титульная", "ДатаНачПат"));
		КонецЕсли;
		
		Лист2 = Данные.ДанныеУведомления.Форма2020_1_Лист2;
		Если Не ЗначениеЗаполнено(Лист2.НаимВД) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано наименование вида деятельности", "Форма2020_1_Лист2", "НаимВД"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Лист2.КодВД) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано код вида деятельности", "Форма2020_1_Лист2", "КодВД"));
		ИначеЕсли СтрДлина(Лист2.КодВД) <> 6 Тогда
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код вида деятельности", "Форма2020_1_Лист2", "КодВД"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Лист2.ПрНаемРаб) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан признак использования наемных работников", "Форма2020_1_Лист2", "ПрНаемРаб"));
		КонецЕсли;
		Если Не ЗначениеЗаполнено(Лист2.ЧислНаемРаб) И Лист2.ПрНаемРаб = "1" Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано число наемных работников", "Форма2020_1_Лист2", "ЧислНаемРаб"));
		КонецЕсли;
		
		ЕстьЛистА = 0;
		ЕстьЛистБ = 0;
		ЕстьЛистВ = 0;
		Для Каждого Стр Из Данные.ДанныеМногостраничныхРазделов.Форма2020_1_ЛистА Цикл 
			СтрЗначение = Стр.Значение;
			Если Не ЗначениеЗаполнено(СтрЗначение.КодРегион) Тогда 
				Продолжить;
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(СтрЗначение.КодНОУчет) И ЗначениеЗаполнено(СтрЗначение.КодРегионАддр) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Код налогового органа заполняют ИП, не имеющие определенного адреса места осуществления предпринимательской деятельности", "Форма2020_1_ЛистА", "КодНОУчет", СтрЗначение.УИД));
			КонецЕсли;
			
			Если СтрДлина(СокрЛП(СтрЗначение.КодРегион)) <> 2 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистА", "КодРегион", СтрЗначение.УИД));
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(СтрЗначение.КодНОУчет) И Не ЗначениеЗаполнено(СтрЗначение.КодРегионАддр) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан налоговый орган или адрес осуществления деятельности", "Форма2020_1_ЛистА", "КодНОУчет", СтрЗначение.УИД));
			Иначе
				Если ЗначениеЗаполнено(СтрЗначение.КодНОУчет) И СтрДлина(СокрЛП(СтрЗначение.КодНОУчет)) <> 4 Тогда 
					ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан налоговый орган", "Форма2020_1_ЛистА", "КодНОУчет", СтрЗначение.УИД));
				КонецЕсли;
				Если ЗначениеЗаполнено(СтрЗначение.КодРегионАддр) И СтрДлина(СокрЛП(СтрЗначение.КодРегионАддр)) <> 2 Тогда 
					ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистА", "КодРегионАддр", СтрЗначение.УИД));
				КонецЕсли;
			КонецЕсли;
		КонецЦикла;
		
		Для Каждого Стр Из Данные.ДанныеМногостраничныхРазделов.Форма2020_1_ЛистБ Цикл 
			СтрЗначение = Стр.Значение;
			Если Не ЗначениеЗаполнено(СтрЗначение.КодРегион) Тогда 
				Продолжить;
			КонецЕсли;
			...
			Если СтрДлина(СокрЛП(СтрЗначение.КодРегион)) <> 2 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистБ", "КодРегион", СтрЗначение.УИД));
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(СтрЗначение.КодТС) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код транспортного средства", "Форма2020_1_ЛистБ", "КодТС", СтрЗначение.УИД));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СтрЗначение.ИдНомТС) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан вин транспортного средства", "Форма2020_1_ЛистБ", "ИдНомТС", СтрЗначение.УИД));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СтрЗначение.МаркаТС) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана марка транспортного средства", "Форма2020_1_ЛистБ", "МаркаТС", СтрЗначение.УИД));
			КонецЕсли;
			Если Не ЗначениеЗаполнено(СтрЗначение.РегЗнакТС) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан регистрационный знак транспортного средства", "Форма2020_1_ЛистБ", "РегЗнакТС", СтрЗначение.УИД));
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(СтрЗначение.ГрузТС) И (СтрЗначение.КодТС = "01" Или СтрЗначение.КодТС = "04") Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана грузоподъемность транспортного средства", "Форма2020_1_ЛистБ", "ГрузТС", СтрЗначение.УИД));
			ИначеЕсли Не ЗначениеЗаполнено(СтрЗначение.КолПосадМест) И (СтрЗначение.КодТС = "02" Или СтрЗначение.КодТС = "03") Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указано количество посадочных мест в ТС", "Форма2020_1_ЛистБ", "КолПосадМест", СтрЗначение.УИД));
			ИначеЕсли Не ЗначениеЗаполнено(СтрЗначение.ГрузТС) И Не ЗначениеЗаполнено(СтрЗначение.КолПосадМест) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указана грузоподъемность транспортного средства", "Форма2020_1_ЛистБ", "ГрузТС", СтрЗначение.УИД));
			КонецЕсли;
		КонецЦикла;
		
		Для Каждого Стр Из Данные.ДанныеМногостраничныхРазделов.Форма2020_1_ЛистВ Цикл 
			СтрЗначение = Стр.Значение;
			Если Не ЗначениеЗаполнено(СтрЗначение.КодРегион) Тогда 
				Продолжить;
			КонецЕсли;
			...
			Если СтрДлина(СокрЛП(СтрЗначение.КодРегион)) <> 2 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистВ", "КодРегион", СтрЗначение.УИД));
			КонецЕсли;
			
			Если ЗначениеЗаполнено(СтрЗначение.КодНОУчет) И СтрДлина(СокрЛП(СтрЗначение.КодНОУчет)) <> 4 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан налоговый орган", "Форма2020_1_ЛистВ", "КодНОУчет", СтрЗначение.УИД));
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(СтрЗначение.КодОбъект) Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код объекта", "Форма2020_1_ЛистВ", "КодОбъект", СтрЗначение.УИД));
			КонецЕсли;
			
			Если (Не (СтрЗначение.КодОбъект = "16" Или СтрЗначение.КодОбъект = "17" Или СтрЗначение.КодОбъект = "18" Или СтрЗначение.КодОбъект = "19"
					 Или СтрЗначение.КодОбъект = "20" Или СтрЗначение.КодОбъект = "21" Или СтрЗначение.КодОбъект = "22" Или СтрЗначение.КодОбъект = "29")) Тогда 
				Если Не ЗначениеЗаполнено(СтрЗначение.КодРегионАддр) Тогда 
					ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код региона", "Форма2020_1_ЛистВ", "КодРегионАддр", СтрЗначение.УИД));
				ИначеЕсли СтрДлина(СокрЛП(СтрЗначение.КодРегионАддр)) <> 2 Тогда 
					ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистВ", "КодРегионАддр", СтрЗначение.УИД));
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(СтрЗначение.КодРегионАддр) И СтрДлина(СокрЛП(СтрЗначение.КодРегионАддр)) <> 2 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан код региона", "Форма2020_1_ЛистВ", "КодРегионАддр", СтрЗначение.УИД));
			КонецЕсли;
		...
		Если ЕстьЛистА + ЕстьЛистБ + ЕстьЛистВ <> 1 Тогда
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Должны быть заполнены либо листы А, либо листы Б, либо листы В", "Форма2020_1_Титульная", ""));
		КонецЕсли;
		
		Для Каждого Элт Из СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок("А%Б%В", "%") Цикл 
			ЛистыСвернутые = ДанныеМногостраничногоРазделаВТЗ(Данные.ДанныеМногостраничныхРазделов["Форма2020_1_Лист" + Элт]).Скопировать(, "КодРегион,КодНОУчет");
			ЛистыСвернутые.Свернуть("КодРегион,КодНОУчет");
			Инд = ЛистыСвернутые.Количество();
			Пока Инд > 0 Цикл 
				Инд = Инд - 1;
			...
			КонецЦикла;
			Если ЛистыСвернутые.Количество() > 1 Тогда 
				ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("В листах " + Элт + " должны быть одинаково заполнены код региона и код налогового органа", "Форма2020_1_Лист" + Элт, "КодРегион", Данные.ДанныеМногостраничныхРазделов["Форма2020_1_Лист" + Элт][0].Значение.УИД));
			КонецЕсли;
		КонецЦикла;
	Исключение
		Инфо = ИнформацияОбОшибке();
...
Функция СформироватьНовоеУведомление_2017_1(Данные) Экспорт 
	Попытка
		...
		СтруктураПараметров.Вставить("ДеревоСтраниц", СформироватьДеревоСтраницПоДанным_2017_1(Данные));
		...
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"].Количество() < Данные.ЛистыА.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"].Добавить(СтруктураСтраницы);
		КонецЦикла;
		Для Инд = 0 По Данные.ЛистыА.Количество() - 1 Цикл 
			ЛистаА = Данные.ЛистыА[Инд];
			ДобавитьДополнительныеПоляАдреса(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"][Инд].Значение);
		...
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистБ"].Количество() < Данные.ЛистыБ.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначения.СкопироватьРекурсивно(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистБ"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
		...
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистВ"].Количество() < Данные.ЛистыВ.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначения.СкопироватьРекурсивно(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистВ"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
		...
		Для Инд = 0 По Данные.ЛистыВ.Количество() - 1 Цикл 
			...
			ДобавитьДополнительныеПоляАдреса(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистВ"][Инд].Значение);
...
Функция СформироватьНовоеУведомление_2020_1(Данные) Экспорт 
	...
	Попытка
		...
		ДокОбъект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявлениеНаПолучениеПатентаРекомендованнаяФорма;
		Данные.Свойство("Организация", ДокОбъект.Организация);
		ДокОбъект.ИмяФормы = "Форма2020_1";
		ДокОбъект.ИмяОтчета = "РегламентированноеУведомлениеПолучениеПатента";
		ДокОбъект.ДатаПодписи = ТекущаяДатаСеанса();
		ДокОбъект.Дата = ТекущаяДатаСеанса();
		Данные.Свойство("ПодписантИмя",      ДокОбъект.ПодписантИмя);
		...
		СтруктураПараметров.Вставить("ДеревоСтраниц", СформироватьДеревоСтраницПоДанным_2020_1(Данные));
		ПараметрыИнициализацииФормы = Новый Структура;
		ПараметрыИнициализацииФормы.Вставить("ДанныеУведомления");
		ПараметрыИнициализацииФормы.Вставить("ДанныеМногостраничныхРазделов");
		ПараметрыИнициализацииФормы.Вставить("ДанныеДопСтрок");
		ПараметрыИнициализацииФормы.Вставить("ДанныеДопСтрокСтраницы");
		ПараметрыИнициализацииФормы.Вставить("ИдентификаторыОбычныхСтраниц");
		ПараметрыИнициализацииФормы.Вставить("ИмяФормы", "Отчет.РегламентированноеУведомлениеПолучениеПатента.Форма.Форма2020_1");
		ПараметрыИнициализацииФормы.Вставить("ДеревоСтраниц", СтруктураПараметров.ДеревоСтраниц);
		СформироватьСтруктуруДанныхУведомленияНовогоОбразца(ПараметрыИнициализацииФормы);
		
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"].Количество() < Данные.ЛистыА.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"].Добавить(СтруктураСтраницы);
		КонецЦикла;
		Для Инд = 0 По Данные.ЛистыА.Количество() - 1 Цикл 
			ЛистаА = Данные.ЛистыА[Инд];
			ДобавитьДополнительныеПоляАдреса(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"][Инд].Значение);
			ЗаполнитьЗначенияСвойств(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"][Инд].Значение, ЛистаА);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистА"][Инд].Значение.УИД = СтруктураПараметров.ДеревоСтраниц.Строки[2].Строки[Инд].УИД;
		КонецЦикла;
		
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистБ"].Количество() < Данные.ЛистыБ.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначения.СкопироватьРекурсивно(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистБ"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистБ"].Добавить(СтруктураСтраницы);
		КонецЦикла;
		Для Инд = 0 По Данные.ЛистыБ.Количество() - 1 Цикл 
			ЛистаБ = Данные.ЛистыБ[Инд];
			ЗаполнитьЗначенияСвойств(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистБ"][Инд].Значение, ЛистаБ);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистБ"][Инд].Значение.УИД = СтруктураПараметров.ДеревоСтраниц.Строки[3].Строки[Инд].УИД;
		КонецЦикла;
		
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"].Количество() < Данные.ЛистыВ.Количество() Цикл 
			СтруктураСтраницы = ОбщегоНазначения.СкопироватьРекурсивно(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"][0].Значение);
			ДобавитьДополнительныеПоляАдреса(СтруктураСтраницы);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"].Добавить(СтруктураСтраницы);
		КонецЦикла;
		Для Инд = 0 По Данные.ЛистыВ.Количество() - 1 Цикл 
			ЛистаВ = Данные.ЛистыВ[Инд];
			ДобавитьДополнительныеПоляАдреса(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"][Инд].Значение);
			ЗаполнитьЗначенияСвойств(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"][Инд].Значение, ЛистаВ);
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2020_1_ЛистВ"][Инд].Значение.УИД = СтруктураПараметров.ДеревоСтраниц.Строки[4].Строки[Инд].УИД;
		КонецЦикла;
		
		ДобавитьДополнительныеПоляАдреса(ПараметрыИнициализацииФормы.ДанныеУведомления["Форма2020_1_Титульная"]);
		ЗаполнитьЗначенияСвойств(ПараметрыИнициализацииФормы.ДанныеУведомления["Форма2020_1_Титульная"], Данные.Стр01);
		ЗаполнитьЗначенияСвойств(ПараметрыИнициализацииФормы.ДанныеУведомления["Форма2020_1_Лист2"], Данные.Стр02);
...
Функция СформироватьДеревоСтраницПоДанным_2017_1(Данные)
...
Функция СформироватьДеревоСтраницПоДанным_2020_1(Данные)
	...
	Для Каждого Элт Из Данные.ЛистыА Цикл 
		...
		СтрРег0.Наименование = "Стр. " + Инд;
		СтрРег0.ИндексКартинки = 1;
		СтрРег0.ИмяМакета = "Форма2020_1_ЛистА";
		СтрРег0.Многостраничность = Истина;
		СтрРег0.Многострочность = Ложь;
		СтрРег0.УИД = Новый УникальныйИдентификатор;
		СтрРег0.ИДНаименования = "Форма2020_1_ЛистА";
	КонецЦикла;
	...
	Для Каждого Элт Из Данные.ЛистыБ Цикл 
		...
		СтрРег0.Наименование = "Стр. " + Инд;
		СтрРег0.ИндексКартинки = 1;
		СтрРег0.ИмяМакета = "Форма2020_1_ЛистБ";
		СтрРег0.Многостраничность = Истина;
		СтрРег0.Многострочность = Ложь;
		СтрРег0.УИД = Новый УникальныйИдентификатор;
		СтрРег0.ИДНаименования = "Форма2020_1_ЛистБ";
	КонецЦикла;
	...
	Для Каждого Элт Из Данные.ЛистыВ Цикл
		...
		СтрРег0.Наименование = "Стр. " + Инд;
		СтрРег0.ИндексКартинки = 1;
		СтрРег0.ИмяМакета = "Форма2020_1_ЛистВ";
		СтрРег0.Многостраничность = Истина;
		СтрРег0.Многострочность = Ложь;
		СтрРег0.УИД = Новый УникальныйИдентификатор;
		СтрРег0.ИДНаименования = "Форма2020_1_ЛистВ";
	КонецЦикла;
