...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьОтборСпискаПоТолькоБезКадровыхДокументов(ЭтотОбъект);
...
&НаКлиенте
Процедура ТолькоРешенияКадровыеДокументыПоКоторымНеВведеныПриИзменении(Элемент)
	УстановитьОтборСпискаПоТолькоБезКадровыхДокументов(ЭтотОбъект);
КонецПроцедуры
...
Процедура УстановитьОтборСпискаПоТолькоБезКадровыхДокументов(Форма)
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		Форма.Список.Отбор, 
		"КадровыйДокумент", , 
		ВидСравненияКомпоновкиДанных.НеЗаполнено, , 
		Форма.ТолькоРешенияКадровыеДокументыПоКоторымНеВведены);
КонецПроцедуры
