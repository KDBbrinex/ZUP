...
Процедура УстановитьГруппировкуСписка()
	...
	ГруппировкаДанных = Список.КомпоновщикНастроек.Настройки.Структура[0]; // ГруппировкаКомпоновкиДанных  
	ГруппировкаПолучатель  = ГруппировкаДанных.ПоляГруппировки.Элементы[0];
	ГруппировкаОтправитель = ГруппировкаДанных.ПоляГруппировки.Элементы[1];
...
Процедура УдалитьСообщениеНепосредственно(Знач Сообщения)
	...
	Для Каждого Сообщение Из Сообщения Цикл
		...
		ОбъектСообщения = Сообщение.ПолучитьОбъект(); // СправочникОбъект.СообщенияОбластейДанных
