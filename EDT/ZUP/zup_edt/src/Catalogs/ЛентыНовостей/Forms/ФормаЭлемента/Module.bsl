...
Процедура ИмяФайлаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ВРег(Объект.Протокол) = ВРег("file") Тогда
		...
		Диалог.Показать(ОписаниеОповещенияОВыборе); // АПК:1348 Форма не работает в веб-клиенте.
	КонецЕсли;
...
Процедура ОбновитьИнформационныеСтроки()
	...
	Элементы.ДекорацияВидимостьПоУмолчанию.ЦветТекста = ЦветаСтиля.ГиперссылкаЦвет;
