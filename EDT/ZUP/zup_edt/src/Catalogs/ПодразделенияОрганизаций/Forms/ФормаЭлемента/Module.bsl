...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++Татаринов Е.А.
	Если Элементы.Найти("кдСтруктураПредприятия") =  Неопределено Тогда
		кдКод =  Элементы.Добавить("кдСтруктураПредприятия",Тип("ПолеФормы"),Элементы.ВышестоящаяСтруктура);
		кдКод.Видимость = Истина;
		кдКод.ПутьКДанным = "Объект.кдСтруктураПредприятия";
		кдКод.Заголовок = "Структура предприятия";
		кдКод.Вид = ВидПоляФормы.ПолеВвода;
	КонецЕсли;
	//--Татаринов Е.А
