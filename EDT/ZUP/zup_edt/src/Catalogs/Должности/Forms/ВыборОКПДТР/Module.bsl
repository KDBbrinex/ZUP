...
#Область ОбработчикиСобытийЭлементовТаблицыКлассификаторДолжности
...
#Область ОбработчикиСобытийЭлементовТаблицыКлассификаторПрофессии
&НаКлиенте
...
Процедура Выбрать(Команда)
	...
	ИначеЕсли ЭтотОбъект.ТекущийЭлемент = Элементы.КлассификаторОКПДТРПрофессии Тогда
		ВыбратьИЗакрыть("КлассификаторОКПДТРПрофессии");
	Иначе 
		Сообщить("Не выбрана строка классификатора.");
	КонецЕсли;
КонецПроцедуры
