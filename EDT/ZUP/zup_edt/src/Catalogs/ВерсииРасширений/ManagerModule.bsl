...
Процедура ЗарегистрироватьИспользованиеВерсииРасширений() Экспорт
	...
	|	И ВерсииРасширений.ПоследняяДатаДобавленияВторойВерсии < &ДатаПоследнегоИспользования";
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Попытка
			...
			Если Объект <> Неопределено
			   И Объект.ПоследняяДатаДобавленияВторойВерсии < ОкругленнаяДатаНачалаСеанса Тогда
				
				Объект.ПоследняяДатаДобавленияВторойВерсии = ОкругленнаяДатаНачалаСеанса;
				Объект.Записать();
			КонецЕсли;
			ЗафиксироватьТранзакцию();
		Исключение
...
Процедура УдалитьУстаревшиеВерсииПараметров() Экспорт
	...
	Пока Истина Цикл
		...
		Попытка
			...
			Если Объект <> Неопределено
			   И Объект.ПоследняяДатаДобавленияВторойВерсии < НаименьшаяДатаНачалаСеанса Тогда
...
Функция ДругаяВерсияРасширений(НаименьшаяДатаНачалаСеанса = '39991231')
	...
	|	И ВерсииРасширений.ПоследняяДатаДобавленияВторойВерсии < &НаименьшаяДатаНачалаСеанса
