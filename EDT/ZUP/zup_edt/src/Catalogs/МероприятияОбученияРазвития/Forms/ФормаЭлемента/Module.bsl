...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"СтраницаПубликации", 
		"Видимость", 
		ПолучитьФункциональнуюОпцию("ИспользоватьПубликацииМероприятийОбученияРазвития"));
...
Процедура ЗаполнитьТаблицуПубликаций()
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьПубликацииМероприятийОбученияРазвития") Тогда
		Возврат;
	КонецЕсли;
