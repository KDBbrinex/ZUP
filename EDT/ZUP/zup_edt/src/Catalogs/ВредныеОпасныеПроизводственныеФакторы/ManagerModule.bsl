...
Процедура ДобавитьЭлемент(СтрокаТаблицы)
	
	СправочникОбъект = Справочники.ВредныеОпасныеПроизводственныеФакторы.СоздатьЭлемент();
...
Процедура ДобавитьГруппу(СтрокаТаблицы)
	
	СправочникОбъект = Справочники.ВредныеОпасныеПроизводственныеФакторы.СоздатьГруппу();
	СправочникОбъект.Код = СтрокаТаблицы["Code"];
	СправочникОбъект.Наименование = СтрокаТаблицы["Name"];
	СправочникОбъект.Родитель = РодительПоКодуЭлемента(СтрокаТаблицы["Code"]);
	ОбновлениеИнформационнойБазы.ЗаписатьОбъект(СправочникОбъект);
...
Функция РодительПоКодуЭлемента(КодЭлемента)
	...
	ГруппаСсылка = Справочники.ВредныеОпасныеПроизводственныеФакторы.НайтиПоКоду(КодРодителя);
