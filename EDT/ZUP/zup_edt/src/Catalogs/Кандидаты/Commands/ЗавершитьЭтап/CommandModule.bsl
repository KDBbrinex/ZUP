...
Процедура ЗавершитьЭтапПослеВыбора(РезультатВыбора, ПараметрыОповещения) Экспорт
	...
	Оповестить("ИзмененЭтапРаботыСКандидатом", ПараметрыОповещения, ПараметрыОповещения.Источник);
	
КонецПроцедуры

&НаСервере
Процедура ЗавершитьЭтапПослеВыбораНаСервере(ОписаниеЭтапа)
	ПодборПерсонала.УстановитьСостояниеЭтапаРаботыКандидатов(ОписаниеЭтапа);
КонецПроцедуры
