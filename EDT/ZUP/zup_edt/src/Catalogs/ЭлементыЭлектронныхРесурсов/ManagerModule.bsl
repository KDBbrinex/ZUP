...
Функция ДанныеЭлементаДляВыгрузки(ЭлементРесурса, ТипЭлемента = Неопределено, ИдентификаторФормы = Неопределено) Экспорт
	...
	ИначеЕсли ТипЭлемента = Перечисления.ТипыЭлементовЭлектронныхРесурсов.Video Тогда
		...
		ДополнительныеПараметрыРСФ = РаботаСФайламиКлиентСервер.ПараметрыДанныхФайла();
		ДополнительныеПараметрыРСФ.ИдентификаторФормы = ИдентификаторФормы;
		ДополнительныеПараметрыРСФ.ПолучатьСсылкуНаДвоичныеДанные = Истина;
		ХранениеФайла = РаботаСФайлами.ДанныеФайла(ВыборкаДетальныеЗаписи.ПрисоединенныйФайл, ДополнительныеПараметрыРСФ).СсылкаНаДвоичныеДанныеФайла;
		Возврат ПолучитьИзВременногоХранилища(ХранениеФайла);
...
Функция ПроизвольныеДанныеЭлемента(ЭлементРесурса, ИмяРеквизитаСДанными, КодДанных, ИдентификаторФормы = Неопределено)
	...
	ИначеЕсли ИмяРеквизитаСДанными = "ПрисоединенныйФайл" Тогда		
		...
		ДополнительныеПараметрыРСФ.ИдентификаторФормы = ИдентификаторФормы;
		ДополнительныеПараметрыРСФ.ПолучатьСсылкуНаДвоичныеДанные = Истина;
		Возврат РаботаСФайлами.ДанныеФайла(ВыборкаДетальныеЗаписи.Данные, ДополнительныеПараметрыРСФ).СсылкаНаДвоичныеДанныеФайла;			
	Иначе				
...
Функция ДополнительныеФорматыВидео(Знач ЭлементРесурсаСВидео)
