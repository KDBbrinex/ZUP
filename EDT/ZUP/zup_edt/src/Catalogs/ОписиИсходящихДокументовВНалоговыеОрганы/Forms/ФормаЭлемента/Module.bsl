...
Процедура ДобавитьДокументыИзДругойБазыПослеВыбораВидаДокумента(Результат, ВходящийКонтекст) Экспорт
	...
	Если Результат = "xml" Тогда
		ДобавитьДокументыТакскомИзФайлаОбмена();
...
Процедура ВыбратьПервичкуЗавершение(РезультатВыбора, ВходящийКонтекст) Экспорт
	...
	Иначе
		...
		ЭлектронныеДокументыЭДО = ЭлектронныеДокументыЭДО(ДокументИсточник);
		
		Если ЭлектронныеДокументыЭДО.ЕстьЭлектронныйДокумент Тогда
			...
			СтруктураСвойств.Вставить("ВыбранныйДокумент", 	ДокументИсточник);
			СтруктураСвойств.Вставить("ВидДокументаФНС", 	ЭлектронныеДокументыЭДО.ВидДокументаФНС);
...
Функция ОтработатьРезультатДобавленияСкановНаСервере(СтруктураРезультата)
	...
	Для каждого ДобавленныйСкан Из ДобавленныеСканы Цикл
		...
		СтруктураСвойств.Вставить("ВыбранныйДокумент", 	ДобавленныйСкан);
...
Процедура ДобавитьДокументыТакскомИзФайлаОбменаЗавершение(СтруктураВыбора, ДополнительныеПараметры) Экспорт
	...
	Если СтруктураВыбора <> Неопределено Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ДобавитьДокументыТакскомИзФайлаОбменаПоПунктуТребования", 
			ЭтотОбъект, 
			ДополнительныеПараметры);
...
Процедура УстановитьТолькоПросмотр(ПризнакТолькоПросмотр = Истина)
	...
	Элементы.ПредставлениеОснования.ТолькоПросмотр = ПризнакТолькоПросмотр;
...
&НаКлиенте
Процедура ДобавитьДокументыТакскомИзФайлаОбмена()
