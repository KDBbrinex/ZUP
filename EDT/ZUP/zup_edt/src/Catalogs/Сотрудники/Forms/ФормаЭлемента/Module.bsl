...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ПодборПерсонала") Тогда
		...
		МодульПодборПерсоналаФормы.ПриСозданииНаСервереФормыСотрудника(ЭтотОбъект, ФизическоеЛицоСсылка, ТекущаяДолжностьПоШтатномуРасписанию);
	КонецЕсли;
...
&НаКлиенте
Процедура Подключаемый_РедактированиеСведенийДляРеестраВыполнитьКоманду(Команда)
			
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.РеестрГосслужащих") Тогда
		Модуль = ОбщегоНазначенияКлиент.ОбщийМодуль("РеестрГосслужащихКлиент");
		Модуль.ОткрытьФормуПолисыОМС(ЭтотОбъект, ФизическоеЛицоСсылка);
	КонецЕсли;
...
Процедура Подключаемый_Smartway(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.БронированиеКомандировок.РегулярнаяОтправкаСотрудников") Тогда		
