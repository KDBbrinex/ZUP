...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЗначениеЗаполнено(НаименованиеВарианта) Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Укажите наименование сохраняемого варианта.'"), , , , Отказ);
	ИначеЕсли НаименованиеВарианта = "Вакансия" Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Укажите иное наименование сохраняемого варианта.'"), , , , Отказ);
	КонецЕсли;
