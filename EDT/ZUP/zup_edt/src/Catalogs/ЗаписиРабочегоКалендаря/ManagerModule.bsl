...
Функция СформироватьHTMLПредставление(ЗаписьКалендаря, ДатаЗаписи) Экспорт
	...
	Если РеквизитыЗаписиКалендаря.Пользователь <> Пользователи.ТекущийПользователь() Тогда
...
// Устарела. Следует использовать Справочники.ЗаписиРабочегоКалендаря.РеквизитыЗаписиКалендаря.
// Возвращает структуру реквизитов записи календаря.
