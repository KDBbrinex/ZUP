...
Процедура ПередЗаписью(Отказ)
	...
	Если Связанная И Не ДополнительныеСвойства.Свойство("ИзменениеСвязаннойЗаписи") Тогда
		Если ЗначениеЗаполнено(Предмет) Тогда
			ТекстРекомендованногоДействия = СтрШаблон(
				НСтр("ru = 'Для изменения данной записи календаря необходимо внести изменения в ""%1"" (%2).'"),
				Предмет,
				ТипЗнч(Предмет))
		ИначеЕсли ЗначениеЗаполнено(СинхронизацияКалендарей.УзлыДляВыгрузки(Пользователь)) Тогда
			ТекстРекомендованногоДействия = НСтр("ru = 'Для изменения данной записи календаря необходимо внести изменения во внешний календарь.'");
		Иначе
			ТекстРекомендованногоДействия = "";
		КонецЕсли;
		Если ЗначениеЗаполнено(ТекстРекомендованногоДействия) Тогда
			ТекстОшибки =
